window.wp=window.wp||{},tinymce.PluginManager.add("fronted_shortcode",function(e){var t=(window.tinymce,e);e.shortcode_edit={bind_shortcode_edit:function(e){var t=this;e=jQuery(e),e.find(".wa-shortcode-wrap").off("hover").hover(function(){t.show_shortcode_button(jQuery(this),e)},function(){t.hide_shortcode_button()})},show_shortcode_button:function(e,n){var o=this,a=e.children(),i=0!==a.length?jQuery(a[0]):e,r=i.offset(),s=jQuery(window).scrollTop(),d=r.top-s,u=r.top,l=jQuery("#wa-fronted-edit-shortcode");l.removeClass("arrow-over arrow-under"),42>=d?(u=r.top+i.height()+42,l.addClass("arrow-over")):l.addClass("arrow-under"),l.css({left:r.left+(i.width()/2-l.width()/2),top:u}).addClass("show").hover(function(){jQuery(this).addClass("show")},function(){o.hide_shortcode_button()});var c=l.find("#wa-fronted-edit-shortcode-button"),f=l.find("#wa-fronted-remove-shortcode-button");c.addClass("show"),c.off(),c.one("click",function(t){t.preventDefault(),o.show_shortcode_edit(e,n)}),f.addClass("show"),f.off(),f.one("click",function(n){n.preventDefault(),e.remove(),o.hide_shortcode_button(),t.fire("change")})},hide_shortcode_button:function(){jQuery("#wa-fronted-edit-shortcode").removeClass("show"),jQuery("#wa-fronted-edit-shortcode-button").addClass("show"),jQuery("#wa-fronted-remove-shortcode-button").addClass("show"),jQuery("#wa-fronted-edit-shortcode .shortcode-input-wrapper").removeClass("show")},show_shortcode_edit:function(e,t){var n=this,o=wa_fronted.shortcode_from_attr(e),a=e.attr("data-shortcode-base"),i=wa_fronted.apply_filters("shortcode_actions",["gallery"]);if(-1!==i.indexOf(a))wa_fronted.is_editing_shortcode=e,wa_fronted.do_action("shortcode_action_"+a,o,e);else{var r=e.children(),s=0!==r.length?jQuery(r[0]):e,d=s.offset(),u=jQuery("#wa-fronted-edit-shortcode");jQuery("#wa-fronted-edit-shortcode-button").removeClass("show"),jQuery("#wa-fronted-remove-shortcode-button").removeClass("show"),u.find(".shortcode-input-wrapper").addClass("show"),u.find("#submit-shortcode").off().one("click",function(o){o.preventDefault(),wa_fronted.show_loading_spinner();var a=u.find("#wa_fronted_shortcode_input").val();wa_fronted.shortcode_to_html(a,!1,function(o){""!==o?(wa_fronted.replace_html(e,o),n.bind_shortcode_edit(t)):toastr.error(wa_fronted.i18n("Render unsuccessful"),wa_fronted.i18n("Sent code is not a valid shortcode")),wa_fronted.hide_loading_spinner()})}),u.css({left:d.left+(s.width()/2-u.width()/2)}).find("input").val(o).focus()}}},e.addButton("render_shortcode",{tooltip:wa_fronted.i18n("Render as shortcode"),text:"[ ]",context:"insert",onclick:function(){wa_fronted.show_loading_spinner();var t=e.selection.getContent({format:"text"});wa_fronted.shortcode_to_html(t,!0,function(t){""!==t?e.selection.setContent(t):toastr.error(wa_fronted.i18n("Render unsuccessful"),wa_fronted.i18n("Selected text is not a valid shortcode")),e.shortcode_edit.bind_shortcode_edit(e.targetElm),wa_fronted.hide_loading_spinner()})}}),e.settings.toolbar.push("render_shortcode"),jQuery(window).load(function(){e.shortcode_edit.bind_shortcode_edit(e.targetElm)})});
window.wp=window.wp||{},tinymce.PluginManager.add("fronted_image",function(e){function t(e){return e=e.replace(/(?:<p>)?\[(?:wp_)?caption([^\]]+)\]([\s\S]+?)\[\/(?:wp_)?caption\](?:<\/p>)?/g,function(e,t,n){var o,a,i,r,s,d,u=l.trim;return o=t.match(/id=['"]([^'"]*)['"] ?/),o&&(t=t.replace(o[0],"")),a=t.match(/align=['"]([^'"]*)['"] ?/),a&&(t=t.replace(a[0],"")),i=t.match(/class=['"]([^'"]*)['"] ?/),i&&(t=t.replace(i[0],"")),d=t.match(/width=['"]([0-9]*)['"] ?/),d&&(t=t.replace(d[0],"")),n=u(n),s=n.match(/((?:<a [^>]+>)?<img [^>]+>(?:<\/a>)?)([\s\S]*)/i),s&&s[2]?(r=u(s[2]),s=u(s[1])):(r=u(t).replace(/caption=['"]/,"").replace(/['"]$/,""),s=n),o=o&&o[1]?o[1].replace(/[<>&]+/g,""):"",a=a&&a[1]?a[1]:"alignnone",i=i&&i[1]?" "+i[1].replace(/[<>&]+/g,""):"",!d&&s&&(d=s.match(/width=['"]([0-9]*)['"]/)),d&&d[1]&&(d=d[1]),d&&r?(d=parseInt(d,10),c||(d+=10),'<div class="mceTemp"><'+f+' id="'+o+'" class="wp-caption '+a+i+'" style="width: '+d+'px"><'+p+' class="wp-caption-dt">'+s+"</"+p+"><"+m+' class="wp-caption-dd wp-caption-text">'+r+"</"+m+"></"+f+"></div>"):n})}function n(e){return e.replace(/<div (?:id="attachment_|class="mceTemp)[^>]*>([\s\S]+?)<\/div>/g,function(e,t){var n="";return-1===t.indexOf("<img ")?(n=t.match(new RegExp("<"+m+" [^>]+>([\\s\\S]+?)<\\/"+m+">","i")),n&&n[1]?"<p>"+n[1]+"</p>":""):(n=t.replace(new RegExp("<"+f+" ([^>]+)>\\s*<"+p+" [^>]+>([\\s\\S]+?)<\\/"+p+">\\s*<"+m+" [^>]+>([\\s\\S]*?)<\\/"+m+">\\s*<\\/"+f+">","gi"),function(e,t,n,o){var a,i,r,s;return s=n.match(/width="([0-9]*)"/),s=s&&s[1]?s[1]:"",s&&o?(a=t.match(/id="([^"]*)"/),a=a&&a[1]?a[1]:"",i=t.match(/class="([^"]*)"/),i=i&&i[1]?i[1]:"",r=i.match(/align[a-z]+/i)||"alignnone",i=i.replace(/wp-caption ?|align[a-z]+ ?/gi,""),i&&(i=' class="'+i+'"'),o=o.replace(/\r\n|\r/g,"\n").replace(/<[a-zA-Z0-9]+( [^<>]+)?>/g,function(e){return e.replace(/[\r\n\t]+/," ")}),o=o.replace(/\s*\n\s*/g,"<br />"),'[caption id="'+a+'" align="'+r+'" width="'+s+'"'+i+"]"+n+" "+o+"[/caption]"):n}),n=l.trim(n),0!==n.indexOf("[caption")&&(n=t.replace(/[\s\S]*?((?:<a [^>]+>)?<img [^>]+>(?:<\/a>)?)(<p>[\s\S]*<\/p>)?[\s\S]*/gi,"<p>$1</p>$2")),n)})}function o(t){var n,o,a,i,r,s,d,u,c=[],f=e.dom,p=/^\d+$/;return a={attachment_id:!1,size:"custom",caption:"",align:"none",extraClasses:"",link:!1,linkUrl:"",linkClassName:"",linkTargetBlank:!1,linkRel:"",title:""},a.url=f.getAttrib(t,"src"),a.alt=f.getAttrib(t,"alt"),a.title=f.getAttrib(t,"title"),d=f.getAttrib(t,"width"),u=f.getAttrib(t,"height"),(!p.test(d)||parseInt(d,10)<1)&&(d=t.naturalWidth||t.width),(!p.test(u)||parseInt(u,10)<1)&&(u=t.naturalHeight||t.height),a.customWidth=a.width=d,a.customHeight=a.height=u,n=l.explode(t.className," "),o=[],l.each(n,function(e){/^wp-image/.test(e)?a.attachment_id=parseInt(e.replace("wp-image-",""),10):/^align/.test(e)?a.align=e.replace("align",""):/^size/.test(e)?a.size=e.replace("size-",""):o.push(e)}),a.extraClasses=o.join(" "),i=f.getParents(t,".wp-caption"),i.length&&(i=i[0],n=i.className.split(" "),l.each(n,function(e){/^align/.test(e)?a.align=e.replace("align",""):e&&"wp-caption"!==e&&c.push(e)}),a.captionClassName=c.join(" "),r=f.select(".wp-caption-dd",i),r.length&&(r=r[0],a.caption=e.serializer.serialize(r).replace(/<br[^>]*>/g,"$&\n").replace(/^<p>/,"").replace(/<\/p>$/,""))),t.parentNode&&"A"===t.parentNode.nodeName&&(s=t.parentNode,a.linkUrl=f.getAttrib(s,"href"),a.linkTargetBlank="_blank"===f.getAttrib(s,"target")?!0:!1,a.linkRel=f.getAttrib(s,"rel"),a.linkClassName=s.className),a}function a(e){return e&&!(!e.textContent&&!e.innerText)}function i(t,n){var o,i,r,s,d,u,h,g,_,w,v,D,F,b,y,C,E=e.dom;o=l.explode(n.extraClasses," "),o||(o=[]),n.caption||o.push("align"+n.align),n.attachment_id&&(o.push("wp-image-"+n.attachment_id),n.size&&"custom"!==n.size&&o.push("size-"+n.size)),b=n.width,y=n.height,"custom"===n.size&&(b=n.customWidth,y=n.customHeight),D={src:n.url,width:b||null,height:y||null,alt:n.alt,title:n.title||null,"class":o.join(" ")||null},E.setAttribs(t,D),F={href:n.linkUrl,rel:n.linkRel||null,target:n.linkTargetBlank?"_blank":null,"class":n.linkClassName||null},t.parentNode&&"A"===t.parentNode.nodeName&&!a(t.parentNode)?n.linkUrl?E.setAttribs(t.parentNode,F):E.remove(t.parentNode,!0):n.linkUrl&&((h=E.getParent(t,"a"))&&E.insertAfter(t,h),h=E.create("a",F),t.parentNode.insertBefore(h,t),h.appendChild(t)),g=e.dom.getParent(t,".mceTemp"),r=t.parentNode&&"A"===t.parentNode.nodeName&&!a(t.parentNode)?t.parentNode:t,n.caption?(v=n.attachment_id?"attachment_"+n.attachment_id:null,C="align"+(n.align||"none"),i="wp-caption "+C,n.captionClassName&&(i+=" "+n.captionClassName.replace(/[<>&]+/g,"")),c||(b=parseInt(b,10),b+=10),g?(w=E.select(".wp-caption",g),w.length&&E.setAttribs(w,{id:v,"class":i,style:"width: "+b+"px"}),_=E.select(".wp-caption-dd",g),_.length&&E.setHTML(_[0],n.caption)):(v=v?'id="'+v+'" ':"",s="<"+f+" "+v+'class="'+i+'" style="width: '+b+'px"><'+p+' class="wp-caption-dt">'+E.getOuterHTML(r)+"</"+p+"><"+m+' class="wp-caption-dd wp-caption-text">'+n.caption+"</"+m+"></"+f+">",(d=E.getParent(r,"p"))?(u=E.create("div",{"class":"mceTemp"},s),d.parentNode.insertBefore(u,d),E.remove(r),E.isEmpty(d)&&E.remove(d)):E.setOuterHTML(r,'<div class="mceTemp">'+s+"</div>"))):g&&(d=E.create("p"),g.parentNode.insertBefore(d,g),d.appendChild(r),E.remove(g)),wp.media.events&&wp.media.events.trigger("editor:image-update",{editor:e,metadata:n,image:t}),e.nodeChanged()}function r(t){var n,a,r;return"undefined"!=typeof wp&&wp.media?(r=o(t),wp.media.events.trigger("editor:image-edit",{editor:e,metadata:r,image:t}),n=wp.media({frame:"image",state:"image-details",metadata:r}),wp.media.events.trigger("editor:frame-create",{frame:n}),a=function(o){e.focus(),e.undoManager.transact(function(){i(t,o)}),n.detach()},n.state("image-details").on("update",a),n.state("replace-image").on("replace",a),n.on("close",function(){e.focus(),n.detach()}),void n.open()):void e.execCommand("mceImage")}function s(t){var n;"DIV"===t.nodeName&&e.dom.hasClass(t,"mceTemp")?n=t:("IMG"===t.nodeName||"DT"===t.nodeName||"A"===t.nodeName)&&(n=e.dom.getParent(t,"div.mceTemp")),null===n&&null!==e.dom.getParent(t,"a")&&(n=e.dom.getParent(t,"a")),n?(e.selection.select(n.nextSibling?n.nextSibling:n.previousSibling?n.previousSibling:n.parentNode),e.selection.collapse(!0),e.nodeChanged(),e.dom.remove(n)):e.dom.remove(t),jQuery(e.targetElm).find("p:empty").remove(),e.theme.panel.hide(),e.focus()}function d(t,n){n=n||!1;var o=t.states.get("gallery-edit");if(library=o.get("library"),0!==library.length){var a=wp.media.gallery.shortcode(library).string();wa_fronted.shortcode_to_html(a,n===!1?!0:!1,function(t){n!==!1?wa_fronted.replace_html(n,t):e.selection.setContent(t),e.hasOwnProperty("shortcode_edit")&&e.shortcode_edit.bind_shortcode_edit(e.targetElm)})}}function u(e){var t,n,o=wp.shortcode.next("gallery",e),a=wp.media.gallery.defaults.id;return o?(o=o.shortcode,_.isUndefined(o.get("id"))&&!_.isUndefined(a)&&o.set("id",a),t=wp.media.gallery.attachments(o),n=new wp.media.model.Selection(t.models,{props:t.props.toJSON(),multiple:!0}),n.gallery=t.gallery,n.more().done(function(){n.props.set({query:!1}),n.unmirror(),n.props.unset("orderby")}),n):!1}var l=window.tinymce,c=e.getParam("wpeditimage_html5_captions"),f=c?"figure":"dl",p=c?"section":"dt",m=c?"figcaption":"dd",h=!1,g={aspect_ratio:function(e,t){return e/t},round:function(e,t){return Number(Math.round(e+"e"+t)+"e-"+t)},get_closest_image_size:function(e,t,n,o){var a=this,t=Math.round(t),n=Math.round(n),i={diff:null,size_name:null,height:null,width:null,crop:null},r=a.round(a.aspect_ratio(n,t),2);for(size in global_vars.image_sizes){var s=global_vars.image_sizes[size],d=parseInt(s.height),u=parseInt(s.width),l=a.round(a.aspect_ratio(u,d),2);if(r===l||s.crop!==!0&&1!==s.crop){var c=Math.abs(t-d);(c<i.diff||null===i.diff)&&(i.diff=c,i.size_name=size,i.height=d,i.width=u,i.crop=s.crop)}}null!==i.size_name&&jQuery.post(global_vars.ajax_url,{action:"wa_get_image_src",attachment_id:e,size:i.size_name},function(e){o(e)})}};return e.on("init",function(){var t=e.dom;e.on("wpLoadImageForm",function(t){if(!e.getParam("wpeditimage_disable_captions")){var n={type:"textbox",flex:1,name:"caption",minHeight:60,multiline:!0,scroll:!0,label:"Image caption"};t.data.splice(t.data.length-1,0,n)}}),e.on("wpNewImageRefresh",function(e){var n,o;(n=t.getParent(e.node,".wp-caption"))&&(n.style.width||(o=parseInt(e.node.clientWidth,10)+10,o=o?o+"px":"50%",t.setStyle(n,"width",o)))}),e.on("wpImageFormSubmit",function(n){var o,a,i,r,s,d=n.imgData.data,u=n.imgData.node,l=n.imgData.caption,h="",g="",_="";return d.id="__wp-temp-img-id",n.imgData.cancel=!0,d.style||(d.style=null),d.src?(l&&(l=l.replace(/\r\n|\r/g,"\n").replace(/<\/?[a-zA-Z0-9]+( [^<>]+)?>/g,function(e){return e.replace(/[\r\n\t]+/," ")}),l=l.replace(/(<br[^>]*>)\s*\n\s*/g,"$1").replace(/\s*\n\s*/g,"<br />")),u?(s=u.id||null,t.setAttribs(u,d),o=t.getParent(u,".wp-caption"),l?o?(a=t.select(".wp-caption-dd",o)[0])&&(a.innerHTML=l):(u.className&&(h=u.className.match(/wp-image-([0-9]+)/),g=u.className.match(/align(left|right|center|none)/)),g?(g=g[0],u.className=u.className.replace(/align(left|right|center|none)/g,"")):g="alignnone",g=' class="wp-caption '+g+'"',h&&(h=' id="attachment_'+h[1]+'"'),_=d.width||u.clientWidth,_&&(_=parseInt(_,10),c||(_+=10),_=' style="width: '+_+'px"'),u.parentNode&&"A"===u.parentNode.nodeName?(r=t.getOuterHTML(u.parentNode),i=u.parentNode):(r=t.getOuterHTML(u),i=u),r="<"+f+" "+h+g+_+"><"+p+' class="wp-caption-dt">'+r+"</"+p+"><"+m+' class="wp-caption-dd wp-caption-text">'+l+"</"+m+"></"+f+">",(a=t.getParent(u,"p"))?(o=t.create("div",{"class":"mceTemp"},r),t.insertAfter(o,a),e.selection.select(o),e.nodeChanged(),t.remove(i),t.isEmpty(a)&&t.remove(a)):e.selection.setContent('<div class="mceTemp">'+r+"</div>")):o&&(r=t.getOuterHTML("A"===u.parentNode.nodeName?u.parentNode:u),a=t.create("p",{},r),t.insertAfter(a,o.parentNode),e.selection.select(a),e.nodeChanged(),t.remove(o.parentNode))):(r=t.createHTML("img",d),l?(i=e.selection.getNode(),d.width&&(_=parseInt(d.width,10),c||(_+=10),_=' style="width: '+_+'px"'),r="<"+f+' class="wp-caption alignnone"'+_+"><"+p+' class="wp-caption-dt">'+r+"</"+p+"><"+m+' class="wp-caption-dd wp-caption-text">'+l+"</"+m+"></"+f+">",a="P"===i.nodeName?i:t.getParent(i,"p"),a&&"P"===a.nodeName?(o=t.create("div",{"class":"mceTemp"},r),a.parentNode.insertBefore(o,a),e.selection.select(o),e.nodeChanged(),t.isEmpty(a)&&t.remove(a)):e.selection.setContent('<div class="mceTemp">'+r+"</div>")):e.selection.setContent(r)),u=t.get("__wp-temp-img-id"),t.setAttrib(u,"id",s),void(n.imgData.node=u)):void(u&&(t.remove((o=t.getParent(u,"div.mceTemp"))?o:"A"===u.parentNode.nodeName?u.parentNode:u),e.nodeChanged()))}),e.on("wpLoadImageData",function(n){var o,a=n.imgData.data,i=n.imgData.node;(o=t.getParent(i,".wp-caption"))&&(o=t.select(".wp-caption-dd",o)[0],o&&(a.caption=e.serializer.serialize(o).replace(/<br[^>]*>/g,"$&\n").replace(/^<p>/,"").replace(/<\/p>$/,"")))});var n=["image/jpeg","image/png","image/gif"];e.on("drop",function(t){if(!h&&Modernizr.filereader&&e.settings.fronted_options.media_upload===!0&&(t.preventDefault(),t.stopPropagation(),0!==t.dataTransfer.files.length)){wa_fronted.show_loading_spinner();var o=t.dataTransfer.files[0];if(-1!==jQuery.inArray(o.type,n)){var a=new FileReader;a.onload=function(t){jQuery.post(global_vars.ajax_url,{action:"wa_create_image",post_id:e.settings.fronted_options.post_id,file_data:encodeURIComponent(t.target.result),file_name:o.name,file_type:o.type,wa_fronted_save_nonce:global_vars.nonce},function(t){var n=t.attachment_obj,o=n.sizes.medium,a='<img src="'+o.url+'" width="'+o.width+'" height="'+o.height+'" alt="'+n.title+'" class="wp-image-'+n.id+' alignleft size-medium" style="height:'+o.height+"; width:"+o.width+';">';e.insertContent(a),wa_fronted.hide_loading_spinner()})},a.readAsDataURL(o)}else wa_fronted.show_loading_spinner()}}),t.bind(e.getDoc(),"dragend",function(e){h=!1}),t.bind(e.getDoc(),"dragstart",function(n){var o=e.selection.getNode();h=!0,"IMG"===o.nodeName&&(t.getParent(o,".wp-caption")||t.getParent(o,".gallery-icon"))&&n.preventDefault()}),l.Env.ie&&l.Env.ie>10&&(t.bind(e.getBody(),"mscontrolselect",function(n){"IMG"===n.target.nodeName&&t.getParent(n.target,".wp-caption")?e.getBody().focus():"DL"===n.target.nodeName&&t.hasClass(n.target,"wp-caption")&&n.target.focus()}),e.on("click",function(n){"IMG"===n.target.nodeName&&t.getAttrib(n.target,"data-wp-imgselect")&&t.getParent(n.target,".wp-caption")&&e.getBody().focus()}))}),e.on("ObjectResized",function(t){var n=t.target;if("IMG"===n.nodeName){var o=n.className.match(/wp-image-\d+/);if(null!==o){var a=o[0].match(/\d+/)[0];g.get_closest_image_size(a,n.height,n.width,function(e){e[3]===!0&&(n.className=n.className.replace(/size-\S+/,"size-"+e[4]),n.src=e[0])})}e.undoManager.transact(function(){var o,a,i=e.dom;n.className=n.className.replace(/\bsize-[^ ]+/,""),(o=i.getParent(n,".wp-caption"))&&(a=t.width||i.getAttrib(n,"width"),a&&(a=parseInt(a,10),c||(a+=10),i.setStyle(o,"width",a+"px")))})}}),e.on("BeforeExecCommand",function(t){var n,o,a,i,r=t.command,s=e.dom;if("mceInsertContent"===r)(n=s.getParent(e.selection.getNode(),"div.mceTemp"))?(o=s.create("p"),s.insertAfter(o,n),e.selection.setCursorLocation(o,0),e.nodeChanged()):-1!==t.value.indexOf("[gallery ")&&(t.preventDefault(),wa_fronted.show_loading_spinner(),wa_fronted.shortcode_to_html(t.value,!0,function(t){e.insertContent(t),e.hasOwnProperty("shortcode_edit")&&e.shortcode_edit.bind_shortcode_edit(e.targetElm),wa_fronted.hide_loading_spinner()}));else if("JustifyLeft"===r||"JustifyRight"===r||"JustifyCenter"===r||"alignnone"===r){if(n=e.selection.getNode(),i="align"+r.slice(7).toLowerCase(),a=e.dom.getParent(n,".wp-caption"),"IMG"!==n.nodeName&&!a)return;n=a||n,"alignleft"!==i&&e.dom.removeClass(n,"alignleft"),"aligncenter"!==i&&e.dom.removeClass(n,"aligncenter"),"alignright"!==i&&e.dom.removeClass(n,"alignright"),"alignnone"!==i&&e.dom.toggleClass(n,i),e.nodeChanged(),t.preventDefault()}}),e.on("keydown",function(t){var n,o,a,i,r=e.selection,d=t.keyCode,u=e.dom;if(d===l.util.VK.ENTER)n=r.getNode(),o=u.getParent(n,"div.mceTemp"),o&&(u.events.cancel(t),l.each(u.select(".wp-caption-dt, .wp-caption-dd",o),function(e){u.isEmpty(e)&&u.remove(e)}),i=l.Env.ie&&l.Env.ie<11?"":'<br data-mce-bogus="1" />',a=u.create("p",null,i),"DD"===n.nodeName?u.insertAfter(a,o):o.parentNode.insertBefore(a,o),e.nodeChanged(),r.setCursorLocation(a,0));else if((d===l.util.VK.DELETE||d===l.util.VK.BACKSPACE)&&(n=r.getNode(),"DIV"===n.nodeName&&u.hasClass(n,"mceTemp")?o=n:("IMG"===n.nodeName||"DT"===n.nodeName||"A"===n.nodeName)&&(o=u.getParent(n,"div.mceTemp")),o))return u.events.cancel(t),s(n),!1}),e.wpSetImgCaption=function(e){return t(e)},e.wpGetImgCaption=function(e){return n(e)},e.on("BeforeSetContent",function(t){"raw"!==t.format&&(t.content=e.wpSetImgCaption(t.content))}),e.on("PostProcess",function(t){t.get&&(t.content=e.wpGetImgCaption(t.content),t.content=t.content.replace(/ data-wp-imgselect="1"/g,""))}),e.addButton("remove",{tooltip:"Remove",icon:"dashicons-no",onclick:function(){s(e.selection.getNode())}}),e.addButton("edit",{tooltip:"Edit",icon:"dashicons-edit",onclick:function(){r(e.selection.getNode())}}),l.each({alignleft:"Align Left",aligncenter:"Align Center",alignright:"Align Right",alignnone:"Don’t Align"},function(t,n){var o=n.slice(5);e.addButton("img"+n,{tooltip:t,icon:"dashicons-align-"+o,cmd:"alignnone"===n?n:"Justify"+o.slice(0,1).toUpperCase()+o.slice(1),onPostRender:function(){var t=this;e.on("NodeChange",function(o){var a=e.dom.getParent(o.element,".wp-caption")||o.element;t.active("alignnone"===n?!e.dom.hasClass(a,"alignleft")&&!e.dom.hasClass(a,"aligncenter")&&!e.dom.hasClass(a,"alignright"):e.dom.hasClass(a,n))})}})}),e.addButton("wp_media",{tooltip:"Media",icon:"dashicons-admin-media",onclick:function(){wp.media.editor.open(e.id)}}),wa_fronted.add_action("shortcode_action_gallery",function(t,n){if(0!==n.parents("#"+e.id).length){var o=wp.media({frame:"post",state:"gallery-edit",title:wp.media.view.l10n.editGalleryTitle,editing:!0,multiple:!0,selection:u(t)});o.state("gallery-edit").on("update",function(){d(o,n)}),o.on("close",function(){e.focus(),o.detach()}),o.open()}}),{_do_shcode:t,_get_shcode:n}});
window.wp=window.wp||{},window.send_to_editor=window.send_to_editor||function(e){if(-1!==e.indexOf("[")){wa_fronted.show_loading_spinner();var t="undefined"!=typeof wa_fronted.is_editing_shortcode&&wa_fronted.is_editing_shortcode!==!1;wa_fronted.shortcode_to_html(e,t!==!0,function(n){""!==n?t?wa_fronted.replace_html(wa_fronted.is_editing_shortcode,n):tinymce.activeEditor.selection.setContent(n):tinymce.activeEditor.selection.setContent(e),tinymce.activeEditor.hasOwnProperty("shortcode_edit")&&tinymce.activeEditor.shortcode_edit.bind_shortcode_edit(tinymce.activeEditor.targetElm),wa_fronted.is_editing_shortcode=!1,wa_fronted.hide_loading_spinner()})}else tinymce.activeEditor.selection.setContent(e)},tinymce.ThemeManager.add("fronted",function(e){function t(e,t){for(;e;){if(e.nodeName===t)return e;e=e.parentNode}return!1}function n(n,o){var a,i=[];if(n)return u(n,function(n){function r(){var t=e.selection;"bullist"===u&&t.selectorChanged("ul > li",function(e,t){for(var o,a=t.parents.length;a--&&(o=t.parents[a].nodeName,"OL"!==o&&"UL"!==o););n.active(e&&"UL"===o)}),"numlist"===u&&t.selectorChanged("ol > li",function(e,t){for(var o,a=t.parents.length;a--&&(o=t.parents[a].nodeName,"OL"!==o&&"UL"!==o););n.active(e&&"OL"===o)}),n.settings.stateSelector&&t.selectorChanged(n.settings.stateSelector,function(e){n.active(e)},!0),n.settings.disabledStateSelector&&t.selectorChanged(n.settings.disabledStateSelector,function(e){n.disabled(e)})}var u;"|"===n?a=null:d.has(n)?(n={type:n},s.toolbar_items_size&&(n.size=s.toolbar_items_size),i.push(n),a=null):((!a||o)&&(a={type:"buttongroup",items:[]},i.push(a)),e.buttons[n]&&(u=n,n=e.buttons[u],"function"==typeof n&&(n=n()),n.icon&&-1!==n.icon.indexOf("dashicons")&&(n.icon="dashicon "+n.icon),o&&(n.text=n.tooltip,n.tooltip=!1),n.type=n.type||"button",s.toolbar_items_size&&(n.size=s.toolbar_items_size),"link"===u?n.onPostRender=function(){var n=this;e.on("NodeChange",function(e){n.active(t(e.element,"A"))})}:"unlink"===u&&(n.onPostRender=function(){var t=this;e.on("NodeChange",function(n){var o="A"!==n.element.nodeName&&-1===e.selection.getContent().indexOf("<a");t.disabled(o),l.setAttrib(t.getEl(),"tabindex",o?"0":"-1")})},n.onclick=function(){-1===e.selection.getContent().indexOf("<a")&&e.selection.select(e.selection.getNode()),e.execCommand("unlink")}),n=d.create(n),a.items.push(n),e.initialized?r():e.on("init",r)))}),i}function o(e){return d.create({type:"panel",layout:"stack",classes:"toolbar-grp",ariaRoot:!0,ariaRemember:!0,items:[{type:"toolbar",layout:"flow",items:n(e)}]})}var a,i=window.tinymce,r=this,s=e.settings,d=i.ui.Factory,u=i.each,l=i.DOM,c=32;u({H1:"Heading 1",H2:"Heading 2",H3:"Heading 3",H4:"Heading 4",H5:"Heading 5",H6:"Heading 6",Pre:"Preformatted"},function(t,n){var o=n.toLowerCase();e.addButton(o,{tooltip:t,text:n,onclick:function(){e.formatter.toggle(o)},onPostRender:function(){var t=this;e.on("nodeChange",function(n){u(n.parents,function(n){t.active(!!e.formatter.matchNode(n,o))})})}})}),e.toolbarItems=n,r.renderUI=function(){function t(){return""===e.getContent({format:"raw"}).replace(/(?:<p[^>]*>)?(?:<br[^>]*>)?(?:<\/p>)?/,"")}var n,i,f={},p=0;return s.content_editable=!0,e.on("activate focus",function(){a=!0,l.addClass(e.getBody(),"mce-edit-focus")}),e.on("deactivate blur hide",function(){a=!1,l.removeClass(e.getBody(),"mce-edit-focus")}),e.on("remove",function(){n&&n.remove(),n=null}),s.placeholder&&(e.on("blur LoadContent deactivate",function(){t()&&(e.setContent(s.placeholder),i=!0,l.addClass(e.getBody(),"mce-placeholder"))}),e.on("focus activate",function(){i&&e.setContent("")}),e.on("SetContent",function(t){i&&!t.load&&(i=!1,l.removeClass(e.getBody(),"mce-placeholder"))}),e.on("PostProcess",function(e){i&&e.content&&(e.content="")}),e.on("BeforeAddUndo",function(e){i&&e.preventDefault()})),s.toolbar&&s.toolbar.length&&!n?("relative"===l.getStyle(document.body,"position",!0)&&(p=parseInt(l.getStyle(document.body,"margin-top",!0),10)+parseInt(l.getStyle(document.documentElement,"padding-top",!0),10)+parseInt(l.getStyle(document.documentElement,"margin-top",!0),10)),f.normal=o(s.toolbar),f.img=o(wa_fronted.apply_filters("image_edit_toolbar",["imgalignleft","imgaligncenter","imgalignright","imgalignnone","edit","remove"],s.fronted_options)),f.view=o(["editview","removeview"]),f.media=o(wa_fronted.apply_filters("image_upload_toolbar",["wp_media"],s.fronted_options)),n=r.panel=d.create({type:"floatpanel",role:"application",classes:"tinymce tinymce-inline",layout:"stack",autohide:!0,items:[f.normal,f.img,f.view,f.media]}),n.reposition=function(t,n){var o,a,i,r,s,d=this.getEl(),m=n||e.selection.getRng(),h=m.getBoundingClientRect(),g=(h.left+h.right)/2,_=window.innerWidth,w=parseInt(l.getStyle(d,"margin-bottom",!0),10)+p;if(m.collapsed||0===g){var v=wa_fronted.getCaretPositionPx();h={top:v.y,bottom:v.y+d.offsetHeight/2,left:v.x,right:v.x},g=v.x}return d.className=(" "+d.className+" ").replace(/\smce-arrow-\S+\s/g," ").slice(1,-1),t=t||"normal",f[t]._visible||(u(f,function(e){e.hide()}),f[t].show()),o=d.offsetWidth,a=o/2,h.top<d.offsetHeight+c?(s=" mce-arrow-up",i=h.bottom+w):(s=" mce-arrow-down",i=h.top-d.offsetHeight-w),r=g-a,o>=_?(s+=" mce-arrow-full",r=0):0>r&&h.left+o>_||r+o>_&&h.right-o<0?r=(_-o)/2:0>r?(s+=" mce-arrow-left",r=h.left):r+o>_&&(s+=" mce-arrow-right",r=h.right-o),d.className+=s,l.setStyles(d,{left:r,top:i+window.pageYOffset}),this},n.on("show",function(){var e=this;setTimeout(function(){e._visible&&l.addClass(e.getEl(),"mce-inline-toolbar-active")},100)}),n.on("hide",function(){l.removeClass(this.getEl(),"mce-inline-toolbar-active")}),n.on("cancel",function(){e.focus()}),l.bind(window,"resize",function(){n.hide()}),e.on("selectionchange nodechange",function(t){var o=t.element||e.selection.getNode(),i=e.plugins.wpview.getView(),r=jQuery(o),d=r.hasClass("wa-shortcode-wrap")?r:r.parents(".wa-shortcode-wrap");0!==d.length&&(t.preventDefault(),e.selection.select(d[0]),e.selection.collapse(),n.hide()),e.selection.isCollapsed()&&!i&&n.hide(),setTimeout(function(){var t,r;a&&(!e.selection.isCollapsed()&&(t=e.selection.getContent())&&(t.replace(/<[^>]+>/g,"").trim()||0===t.indexOf("<"))&&"HR"!==o.nodeName||i?(r=i?"view":"IMG"===o.nodeName?"img":"normal",n.show().reposition(r,i)):e.selection.isCollapsed()&&"IMG"!==o.nodeName&&!i&&s.fronted_options.media_upload?n.show().reposition("media",i):n.hide())},100)}),e.shortcuts.add("Alt+F10","",function(){var e=n.find("toolbar")[0];e&&e.focus(!0)}),n.renderTo(document.body).reflow().hide(),u(f,function(e){e.hide()}),{}):{}}});
window.Modernizr=function(e,t,n){function o(e){v.cssText=e}function a(e,t){return o(D.join(e+";")+(t||""))}function i(e,t){return typeof e===t}function r(e,t){return!!~(""+e).indexOf(t)}function s(e,t){for(var o in e){var a=e[o];if(!r(a,"-")&&v[a]!==n)return"pfx"==t?a:!0}return!1}function d(e,t,o){for(var a in e){var r=t[e[a]];if(r!==n)return o===!1?e[a]:i(r,"function")?r.bind(o||t):r}return!1}function u(e,t,n){var o=e.charAt(0).toUpperCase()+e.slice(1),a=(e+" "+b.join(o+" ")+o).split(" ");return i(t,"string")||i(t,"undefined")?s(a,t):(a=(e+" "+y.join(o+" ")+o).split(" "),d(a,t,n))}var l,c,f,p="2.8.3",m={},h=!0,g=t.documentElement,_="modernizr",w=t.createElement(_),v=w.style,D=({}.toString," -webkit- -moz- -o- -ms- ".split(" ")),F="Webkit Moz O ms",b=F.split(" "),y=F.toLowerCase().split(" "),C={},E=[],A=E.slice,B=function(e,n,o,a){var i,r,s,d,u=t.createElement("div"),l=t.body,c=l||t.createElement("body");if(parseInt(o,10))for(;o--;)s=t.createElement("div"),s.id=a?a[o]:_+(o+1),u.appendChild(s);return i=["&#173;",'<style id="s',_,'">',e,"</style>"].join(""),u.id=_,(l?u:c).innerHTML+=i,c.appendChild(u),l||(c.style.background="",c.style.overflow="hidden",d=g.style.overflow,g.style.overflow="hidden",g.appendChild(c)),r=n(u,e),l?u.parentNode.removeChild(u):(c.parentNode.removeChild(c),g.style.overflow=d),!!r},x=function(){function e(e,a){a=a||t.createElement(o[e]||"div"),e="on"+e;var r=e in a;return r||(a.setAttribute||(a=t.createElement("div")),a.setAttribute&&a.removeAttribute&&(a.setAttribute(e,""),r=i(a[e],"function"),i(a[e],"undefined")||(a[e]=n),a.removeAttribute(e))),a=null,r}var o={select:"input",change:"input",submit:"form",reset:"form",error:"img",load:"img",abort:"img"};return e}(),N={}.hasOwnProperty;f=i(N,"undefined")||i(N.call,"undefined")?function(e,t){return t in e&&i(e.constructor.prototype[t],"undefined")}:function(e,t){return N.call(e,t)},Function.prototype.bind||(Function.prototype.bind=function(e){var t=this;if("function"!=typeof t)throw new TypeError;var n=A.call(arguments,1),o=function(){if(this instanceof o){var a=function(){};a.prototype=t.prototype;var i=new a,r=t.apply(i,n.concat(A.call(arguments)));return Object(r)===r?r:i}return t.apply(e,n.concat(A.call(arguments)))};return o}),C.draganddrop=function(){var e=t.createElement("div");return"draggable"in e||"ondragstart"in e&&"ondrop"in e},C.opacity=function(){return a("opacity:.55"),/^0.55$/.test(v.opacity)},C.cssanimations=function(){return u("animationName")},C.csstransforms=function(){return!!u("transform")},C.csstransforms3d=function(){var e=!!u("perspective");return e&&"webkitPerspective"in g.style&&B("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}",function(t,n){e=9===t.offsetLeft&&3===t.offsetHeight}),e},C.csstransitions=function(){return u("transition")};for(var k in C)f(C,k)&&(c=k.toLowerCase(),m[c]=C[k](),E.push((m[c]?"":"no-")+c));return m.addTest=function(e,t){if("object"==typeof e)for(var o in e)f(e,o)&&m.addTest(o,e[o]);else{if(e=e.toLowerCase(),m[e]!==n)return m;t="function"==typeof t?t():t,"undefined"!=typeof h&&h&&(g.className+=" "+(t?"":"no-")+e),m[e]=t}return m},o(""),w=l=null,function(e,t){function n(e,t){var n=e.createElement("p"),o=e.getElementsByTagName("head")[0]||e.documentElement;return n.innerHTML="x<style>"+t+"</style>",o.insertBefore(n.lastChild,o.firstChild)}function o(){var e=w.elements;return"string"==typeof e?e.split(" "):e}function a(e){var t=_[e[h]];return t||(t={},g++,e[h]=g,_[g]=t),t}function i(e,n,o){if(n||(n=t),l)return n.createElement(e);o||(o=a(n));var i;return i=o.cache[e]?o.cache[e].cloneNode():m.test(e)?(o.cache[e]=o.createElem(e)).cloneNode():o.createElem(e),!i.canHaveChildren||p.test(e)||i.tagUrn?i:o.frag.appendChild(i)}function r(e,n){if(e||(e=t),l)return e.createDocumentFragment();n=n||a(e);for(var i=n.frag.cloneNode(),r=0,s=o(),d=s.length;d>r;r++)i.createElement(s[r]);return i}function s(e,t){t.cache||(t.cache={},t.createElem=e.createElement,t.createFrag=e.createDocumentFragment,t.frag=t.createFrag()),e.createElement=function(n){return w.shivMethods?i(n,e,t):t.createElem(n)},e.createDocumentFragment=Function("h,f","return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&("+o().join().replace(/[\w\-]+/g,function(e){return t.createElem(e),t.frag.createElement(e),'c("'+e+'")'})+");return n}")(w,t.frag)}function d(e){e||(e=t);var o=a(e);return w.shivCSS&&!u&&!o.hasCSS&&(o.hasCSS=!!n(e,"article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")),l||s(e,o),e}var u,l,c="3.7.0",f=e.html5||{},p=/^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i,m=/^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i,h="_html5shiv",g=0,_={};!function(){try{var e=t.createElement("a");e.innerHTML="<xyz></xyz>",u="hidden"in e,l=1==e.childNodes.length||function(){t.createElement("a");var e=t.createDocumentFragment();return"undefined"==typeof e.cloneNode||"undefined"==typeof e.createDocumentFragment||"undefined"==typeof e.createElement}()}catch(n){u=!0,l=!0}}();var w={elements:f.elements||"abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output progress section summary template time video",version:c,shivCSS:f.shivCSS!==!1,supportsUnknownElements:l,shivMethods:f.shivMethods!==!1,type:"default",shivDocument:d,createElement:i,createDocumentFragment:r};e.html5=w,d(t)}(this,t),m._version=p,m._prefixes=D,m._domPrefixes=y,m._cssomPrefixes=b,m.hasEvent=x,m.testProp=function(e){return s([e])},m.testAllProps=u,m.testStyles=B,g.className=g.className.replace(/(^|\s)no-js(\s|$)/,"$1$2")+(h?" js "+E.join(" "):""),m}(this,this.document),function(e,t,n){function o(e){return"[object Function]"==g.call(e)}function a(e){return"string"==typeof e}function i(){}function r(e){return!e||"loaded"==e||"complete"==e||"uninitialized"==e}function s(){var e=_.shift();w=1,e?e.t?m(function(){("c"==e.t?f.injectCss:f.injectJs)(e.s,0,e.a,e.x,e.e,1)},0):(e(),s()):w=0}function d(e,n,o,a,i,d,u){function l(t){if(!p&&r(c.readyState)&&(v.r=p=1,!w&&s(),c.onload=c.onreadystatechange=null,t)){"img"!=e&&m(function(){F.removeChild(c)},50);for(var o in A[n])A[n].hasOwnProperty(o)&&A[n][o].onload()}}var u=u||f.errorTimeout,c=t.createElement(e),p=0,g=0,v={t:o,s:n,e:i,a:d,x:u};1===A[n]&&(g=1,A[n]=[]),"object"==e?c.data=n:(c.src=n,c.type=e),c.width=c.height="0",c.onerror=c.onload=c.onreadystatechange=function(){l.call(this,g)},_.splice(a,0,v),"img"!=e&&(g||2===A[n]?(F.insertBefore(c,D?null:h),m(l,u)):A[n].push(c))}function u(e,t,n,o,i){return w=0,t=t||"j",a(e)?d("c"==t?y:b,e,t,this.i++,n,o,i):(_.splice(this.i++,0,e),1==_.length&&s()),this}function l(){var e=f;return e.loader={load:u,i:0},e}var c,f,p=t.documentElement,m=e.setTimeout,h=t.getElementsByTagName("script")[0],g={}.toString,_=[],w=0,v="MozAppearance"in p.style,D=v&&!!t.createRange().compareNode,F=D?p:h.parentNode,p=e.opera&&"[object Opera]"==g.call(e.opera),p=!!t.attachEvent&&!p,b=v?"object":p?"script":"img",y=p?"script":b,C=Array.isArray||function(e){return"[object Array]"==g.call(e)},E=[],A={},B={timeout:function(e,t){return t.length&&(e.timeout=t[0]),e}};f=function(e){function t(e){var t,n,o,e=e.split("!"),a=E.length,i=e.pop(),r=e.length,i={url:i,origUrl:i,prefixes:e};for(n=0;r>n;n++)o=e[n].split("="),(t=B[o.shift()])&&(i=t(i,o));for(n=0;a>n;n++)i=E[n](i);return i}function r(e,a,i,r,s){var d=t(e),u=d.autoCallback;d.url.split(".").pop().split("?").shift(),d.bypass||(a&&(a=o(a)?a:a[e]||a[r]||a[e.split("/").pop().split("?")[0]]),d.instead?d.instead(e,a,i,r,s):(A[d.url]?d.noexec=!0:A[d.url]=1,i.load(d.url,d.forceCSS||!d.forceJS&&"css"==d.url.split(".").pop().split("?").shift()?"c":n,d.noexec,d.attrs,d.timeout),(o(a)||o(u))&&i.load(function(){l(),a&&a(d.origUrl,s,r),u&&u(d.origUrl,s,r),A[d.url]=2})))}function s(e,t){function n(e,n){if(e){if(a(e))n||(c=function(){var e=[].slice.call(arguments);f.apply(this,e),p()}),r(e,c,t,0,u);else if(Object(e)===e)for(d in s=function(){var t,n=0;for(t in e)e.hasOwnProperty(t)&&n++;return n}(),e)e.hasOwnProperty(d)&&(!n&&!--s&&(o(c)?c=function(){var e=[].slice.call(arguments);f.apply(this,e),p()}:c[d]=function(e){return function(){var t=[].slice.call(arguments);e&&e.apply(this,t),p()}}(f[d])),r(e[d],c,t,d,u))}else!n&&p()}var s,d,u=!!e.test,l=e.load||e.both,c=e.callback||i,f=c,p=e.complete||i;n(u?e.yep:e.nope,!!l),l&&n(l)}var d,u,c=this.yepnope.loader;if(a(e))r(e,0,c,0);else if(C(e))for(d=0;d<e.length;d++)u=e[d],a(u)?r(u,0,c,0):C(u)?f(u):Object(u)===u&&s(u,c);else Object(e)===e&&s(e,c)},f.addPrefix=function(e,t){B[e]=t},f.addFilter=function(e){E.push(e)},f.errorTimeout=1e4,null==t.readyState&&t.addEventListener&&(t.readyState="loading",t.addEventListener("DOMContentLoaded",c=function(){t.removeEventListener("DOMContentLoaded",c,0),t.readyState="complete"},0)),e.yepnope=l(),e.yepnope.executeStack=s,e.yepnope.injectJs=function(e,n,o,a,d,u){var l,c,p=t.createElement("script"),a=a||f.errorTimeout;p.src=e;for(c in o)p.setAttribute(c,o[c]);n=u?s:n||i,p.onreadystatechange=p.onload=function(){!l&&r(p.readyState)&&(l=1,n(),p.onload=p.onreadystatechange=null)},m(function(){l||(l=1,n(1))},a),d?p.onload():h.parentNode.insertBefore(p,h)},e.yepnope.injectCss=function(e,n,o,a,r,d){var u,a=t.createElement("link"),n=d?s:n||i;a.href=e,a.rel="stylesheet",a.type="text/css";for(u in o)a.setAttribute(u,o[u]);r||(h.parentNode.insertBefore(a,h),m(n,0))}}(this,document),Modernizr.load=function(){yepnope.apply(window,[].slice.call(arguments,0))},Modernizr.addTest("contenteditable","contentEditable"in document.documentElement),Modernizr.addTest("filereader",function(){return!!(window.File&&window.FileList&&window.FileReader)});
...
!function(e){e(["jquery"],function(e){return function(){function t(e,t,n){return m({type:F.error,iconClass:h().iconClasses.error,message:e,optionsOverride:n,title:t})}function n(t,n){return t||(t=h()),_=e("#"+t.containerId),_.length?_:(n&&(_=c(t)),_)}function o(e,t,n){return m({type:F.info,iconClass:h().iconClasses.info,message:e,optionsOverride:n,title:t})}function a(e){w=e}function i(e,t,n){return m({type:F.success,iconClass:h().iconClasses.success,message:e,optionsOverride:n,title:t})}function r(e,t,n){return m({type:F.warning,iconClass:h().iconClasses.warning,message:e,optionsOverride:n,title:t})}function s(e,t){var o=h();_||n(o),l(e,o,t)||u(o)}function d(t){var o=h();return _||n(o),t&&0===e(":focus",t).length?void g(t):void(_.children().length&&_.remove())}function u(t){for(var n=_.children(),o=n.length-1;o>=0;o--)l(e(n[o]),t)}function l(t,n,o){var a=o&&o.force?o.force:!1;return t&&(a||0===e(":focus",t).length)?(t[n.hideMethod]({duration:n.hideDuration,easing:n.hideEasing,complete:function(){g(t)}}),!0):!1}function c(t){return _=e("<div/>").attr("id",t.containerId).addClass(t.positionClass).attr("aria-live","polite").attr("role","alert"),_.appendTo(e(t.target)),_}function f(){return{tapToDismiss:!0,toastClass:"toast",containerId:"toast-container",debug:!1,showMethod:"fadeIn",showDuration:300,showEasing:"swing",onShown:void 0,hideMethod:"fadeOut",hideDuration:1e3,hideEasing:"swing",onHidden:void 0,closeMethod:!1,closeDuration:!1,closeEasing:!1,extendedTimeOut:1e3,iconClasses:{error:"toast-error",info:"toast-info",success:"toast-success",warning:"toast-warning"},iconClass:"toast-info",positionClass:"toast-top-right",timeOut:5e3,titleClass:"toast-title",messageClass:"toast-message",escapeHtml:!1,target:"body",closeHtml:'<button type="button">&times;</button>',newestOnTop:!0,preventDuplicates:!1,progressBar:!1}}function p(e){w&&w(e)}function m(t){function o(e){return null==e&&(e=""),new String(e).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function a(){s(),u(),l(),c(),f(),d()}function i(){B.hover(b,F),!C.onclick&&C.tapToDismiss&&B.click(w),C.closeButton&&T&&T.click(function(e){e.stopPropagation?e.stopPropagation():void 0!==e.cancelBubble&&e.cancelBubble!==!0&&(e.cancelBubble=!0),w(!0)}),C.onclick&&B.click(function(e){C.onclick(e),w()})}function r(){B.hide(),B[C.showMethod]({duration:C.showDuration,easing:C.showEasing,complete:C.onShown}),C.timeOut>0&&(A=setTimeout(w,C.timeOut),S.maxHideTime=parseFloat(C.timeOut),S.hideEta=(new Date).getTime()+S.maxHideTime,C.progressBar&&(S.intervalId=setInterval(y,10)))}function s(){t.iconClass&&B.addClass(C.toastClass).addClass(E)}function d(){C.newestOnTop?_.prepend(B):_.append(B)}function u(){t.title&&(x.append(C.escapeHtml?o(t.title):t.title).addClass(C.titleClass),B.append(x))}function l(){t.message&&(N.append(C.escapeHtml?o(t.message):t.message).addClass(C.messageClass),B.append(N))}function c(){C.closeButton&&(T.addClass("toast-close-button").attr("role","button"),B.prepend(T))}function f(){C.progressBar&&(k.addClass("toast-progress"),B.prepend(k))}function m(e,t){if(e.preventDuplicates){if(t.message===v)return!0;v=t.message}return!1}function w(t){var n=t&&C.closeMethod!==!1?C.closeMethod:C.hideMethod,o=t&&C.closeDuration!==!1?C.closeDuration:C.hideDuration,a=t&&C.closeEasing!==!1?C.closeEasing:C.hideEasing;return!e(":focus",B).length||t?(clearTimeout(S.intervalId),B[n]({duration:o,easing:a,complete:function(){g(B),C.onHidden&&"hidden"!==O.state&&C.onHidden(),O.state="hidden",O.endTime=new Date,p(O)}})):void 0}function F(){(C.timeOut>0||C.extendedTimeOut>0)&&(A=setTimeout(w,C.extendedTimeOut),S.maxHideTime=parseFloat(C.extendedTimeOut),S.hideEta=(new Date).getTime()+S.maxHideTime)}function b(){clearTimeout(A),S.hideEta=0,B.stop(!0,!0)[C.showMethod]({duration:C.showDuration,easing:C.showEasing})}function y(){var e=(S.hideEta-(new Date).getTime())/S.maxHideTime*100;k.width(e+"%")}var C=h(),E=t.iconClass||C.iconClass;if("undefined"!=typeof t.optionsOverride&&(C=e.extend(C,t.optionsOverride),E=t.optionsOverride.iconClass||E),!m(C,t)){D++,_=n(C,!0);var A=null,B=e("<div/>"),x=e("<div/>"),N=e("<div/>"),k=e("<div/>"),T=e(C.closeHtml),S={intervalId:null,hideEta:null,maxHideTime:null},O={toastId:D,state:"visible",startTime:new Date,options:C,map:t};return a(),r(),i(),p(O),C.debug&&console&&console.log(O),B}}function h(){return e.extend({},f(),b.options)}function g(e){_||(_=n()),e.is(":visible")||(e.remove(),e=null,0===_.children().length&&(_.remove(),v=void 0))}var _,w,v,D=0,F={error:"error",info:"info",success:"success",warning:"warning"},b={clear:s,remove:d,error:t,getContainer:n,info:o,options:{},subscribe:a,success:i,version:"2.1.2",warning:r};return b}()})}("function"==typeof define&&define.amd?define:function(e,t){"undefined"!=typeof module&&module.exports?module.exports=t(require("jquery")):window.toastr=t(window.jQuery)});
