window.wp=window.wp||{},tinymce.PluginManager.add("fronted_shortcode",function(e){window.tinymce;e.shortcode_edit={bind_shortcode_edit:function(e){var t=this;e=jQuery(e),e.find(".wa-shortcode-wrap").off("hover").hover(function(){t.show_shortcode_button(jQuery(this),e)},function(){t.hide_shortcode_button()})},show_shortcode_button:function(e,t){e=jQuery(e);var n=this,a=e.children(),o=0!==a.length?jQuery(a[0]):e,i=o.offset(),r=jQuery(window).scrollTop(),s=i.top-r,u=i.top,d=jQuery("#wa-fronted-edit-shortcode");d.removeClass("arrow-over arrow-under"),42>=s?(u=i.top+o.height()+42,d.addClass("arrow-over")):d.addClass("arrow-under"),d.css({left:i.left+(o.width()/2-d.width()/2),top:u}).addClass("show").hover(function(){jQuery(this).addClass("show")},function(){n.hide_shortcode_button()});var l=d.find("#wa-fronted-edit-shortcode-button");l.addClass("show"),l.off(),l.one("click",function(a){a.preventDefault(),n.show_shortcode_edit(e,t)})},hide_shortcode_button:function(){jQuery("#wa-fronted-edit-shortcode").removeClass("show"),jQuery("#wa-fronted-edit-shortcode-button").addClass("show"),jQuery("#wa-fronted-edit-shortcode .shortcode-input-wrapper").removeClass("show")},show_shortcode_edit:function(e,t){var n=this,a=wa_fronted.shortcode_from_attr(e),o=e.attr("data-shortcode-base"),i=wa_fronted.apply_filters("shortcode_actions",["gallery"]);if(-1!==i.indexOf(o))wa_fronted.do_action("shortcode_action_"+o,a,e);else{var r=e.children(),s=0!==r.length?jQuery(r[0]):e,u=s.offset(),d=jQuery("#wa-fronted-edit-shortcode");jQuery("#wa-fronted-edit-shortcode-button").removeClass("show"),d.find(".shortcode-input-wrapper").addClass("show"),d.find("#submit-shortcode").off().one("click",function(a){a.preventDefault(),wa_fronted.show_loading_spinner();var o=d.find("#wa_fronted_shortcode_input").val();wa_fronted.shortcode_to_html(o,!1,function(a){""!==a?(wa_fronted.replace_html(e,a),n.bind_shortcode_edit(t.targetElm)):toastr.error(wa_fronted.i18n("Render unsuccessful"),wa_fronted.i18n("Sent code is not a valid shortcode")),wa_fronted.hide_loading_spinner()})}),d.css({left:u.left+(s.width()/2-d.width()/2)}).find("input").val(a).focus()}}},e.addButton("render_shortcode",{tooltip:wa_fronted.i18n("Render as shortcode"),text:"[ ]",context:"insert",onclick:function(){wa_fronted.show_loading_spinner();var t=e.selection.getContent({format:"text"});wa_fronted.shortcode_to_html(t,!0,function(t){""!==t?e.selection.setContent(t):toastr.error(wa_fronted.i18n("Render unsuccessful"),wa_fronted.i18n("Selected text is not a valid shortcode")),e.shortcode_edit.bind_shortcode_edit(e.targetElm),wa_fronted.hide_loading_spinner()})}}),e.settings.toolbar.push("render_shortcode"),jQuery(window).load(function(){e.shortcode_edit.bind_shortcode_edit(e.targetElm)})});
window.wp=window.wp||{},tinymce.PluginManager.add("fronted_image",function(e){function t(e){return e=e.replace(/(?:<p>)?\[(?:wp_)?caption([^\]]+)\]([\s\S]+?)\[\/(?:wp_)?caption\](?:<\/p>)?/g,function(e,t,n){var a,o,i,r,s,u,d=l.trim;return a=t.match(/id=['"]([^'"]*)['"] ?/),a&&(t=t.replace(a[0],"")),o=t.match(/align=['"]([^'"]*)['"] ?/),o&&(t=t.replace(o[0],"")),i=t.match(/class=['"]([^'"]*)['"] ?/),i&&(t=t.replace(i[0],"")),u=t.match(/width=['"]([0-9]*)['"] ?/),u&&(t=t.replace(u[0],"")),n=d(n),s=n.match(/((?:<a [^>]+>)?<img [^>]+>(?:<\/a>)?)([\s\S]*)/i),s&&s[2]?(r=d(s[2]),s=d(s[1])):(r=d(t).replace(/caption=['"]/,"").replace(/['"]$/,""),s=n),a=a&&a[1]?a[1].replace(/[<>&]+/g,""):"",o=o&&o[1]?o[1]:"alignnone",i=i&&i[1]?" "+i[1].replace(/[<>&]+/g,""):"",!u&&s&&(u=s.match(/width=['"]([0-9]*)['"]/)),u&&u[1]&&(u=u[1]),u&&r?(u=parseInt(u,10),c||(u+=10),'<div class="mceTemp"><'+p+' id="'+a+'" class="wp-caption '+o+i+'" style="width: '+u+'px"><'+f+' class="wp-caption-dt">'+s+"</"+f+"><"+m+' class="wp-caption-dd wp-caption-text">'+r+"</"+m+"></"+p+"></div>"):n})}function n(e){return e.replace(/<div (?:id="attachment_|class="mceTemp)[^>]*>([\s\S]+?)<\/div>/g,function(e,t){var n="";return-1===t.indexOf("<img ")?(n=t.match(new RegExp("<"+m+" [^>]+>([\\s\\S]+?)<\\/"+m+">","i")),n&&n[1]?"<p>"+n[1]+"</p>":""):(n=t.replace(new RegExp("<"+p+" ([^>]+)>\\s*<"+f+" [^>]+>([\\s\\S]+?)<\\/"+f+">\\s*<"+m+" [^>]+>([\\s\\S]*?)<\\/"+m+">\\s*<\\/"+p+">","gi"),function(e,t,n,a){var o,i,r,s;return s=n.match(/width="([0-9]*)"/),s=s&&s[1]?s[1]:"",s&&a?(o=t.match(/id="([^"]*)"/),o=o&&o[1]?o[1]:"",i=t.match(/class="([^"]*)"/),i=i&&i[1]?i[1]:"",r=i.match(/align[a-z]+/i)||"alignnone",i=i.replace(/wp-caption ?|align[a-z]+ ?/gi,""),i&&(i=' class="'+i+'"'),a=a.replace(/\r\n|\r/g,"\n").replace(/<[a-zA-Z0-9]+( [^<>]+)?>/g,function(e){return e.replace(/[\r\n\t]+/," ")}),a=a.replace(/\s*\n\s*/g,"<br />"),'[caption id="'+o+'" align="'+r+'" width="'+s+'"'+i+"]"+n+" "+a+"[/caption]"):n}),n=l.trim(n),0!==n.indexOf("[caption")&&(n=t.replace(/[\s\S]*?((?:<a [^>]+>)?<img [^>]+>(?:<\/a>)?)(<p>[\s\S]*<\/p>)?[\s\S]*/gi,"<p>$1</p>$2")),n)})}function a(t){var n,a,o,i,r,s,u,d,c=[],p=e.dom,f=/^\d+$/;return o={attachment_id:!1,size:"custom",caption:"",align:"none",extraClasses:"",link:!1,linkUrl:"",linkClassName:"",linkTargetBlank:!1,linkRel:"",title:""},o.url=p.getAttrib(t,"src"),o.alt=p.getAttrib(t,"alt"),o.title=p.getAttrib(t,"title"),u=p.getAttrib(t,"width"),d=p.getAttrib(t,"height"),(!f.test(u)||parseInt(u,10)<1)&&(u=t.naturalWidth||t.width),(!f.test(d)||parseInt(d,10)<1)&&(d=t.naturalHeight||t.height),o.customWidth=o.width=u,o.customHeight=o.height=d,n=l.explode(t.className," "),a=[],l.each(n,function(e){/^wp-image/.test(e)?o.attachment_id=parseInt(e.replace("wp-image-",""),10):/^align/.test(e)?o.align=e.replace("align",""):/^size/.test(e)?o.size=e.replace("size-",""):a.push(e)}),o.extraClasses=a.join(" "),i=p.getParents(t,".wp-caption"),i.length&&(i=i[0],n=i.className.split(" "),l.each(n,function(e){/^align/.test(e)?o.align=e.replace("align",""):e&&"wp-caption"!==e&&c.push(e)}),o.captionClassName=c.join(" "),r=p.select(".wp-caption-dd",i),r.length&&(r=r[0],o.caption=e.serializer.serialize(r).replace(/<br[^>]*>/g,"$&\n").replace(/^<p>/,"").replace(/<\/p>$/,""))),t.parentNode&&"A"===t.parentNode.nodeName&&(s=t.parentNode,o.linkUrl=p.getAttrib(s,"href"),o.linkTargetBlank="_blank"===p.getAttrib(s,"target")?!0:!1,o.linkRel=p.getAttrib(s,"rel"),o.linkClassName=s.className),o}function o(e){return e&&!(!e.textContent&&!e.innerText)}function i(t,n){var a,i,r,s,u,d,h,g,_,w,v,D,F,b,y,C,E=e.dom;a=l.explode(n.extraClasses," "),a||(a=[]),n.caption||a.push("align"+n.align),n.attachment_id&&(a.push("wp-image-"+n.attachment_id),n.size&&"custom"!==n.size&&a.push("size-"+n.size)),b=n.width,y=n.height,"custom"===n.size&&(b=n.customWidth,y=n.customHeight),D={src:n.url,width:b||null,height:y||null,alt:n.alt,title:n.title||null,"class":a.join(" ")||null},E.setAttribs(t,D),F={href:n.linkUrl,rel:n.linkRel||null,target:n.linkTargetBlank?"_blank":null,"class":n.linkClassName||null},t.parentNode&&"A"===t.parentNode.nodeName&&!o(t.parentNode)?n.linkUrl?E.setAttribs(t.parentNode,F):E.remove(t.parentNode,!0):n.linkUrl&&((h=E.getParent(t,"a"))&&E.insertAfter(t,h),h=E.create("a",F),t.parentNode.insertBefore(h,t),h.appendChild(t)),g=e.dom.getParent(t,".mceTemp"),r=t.parentNode&&"A"===t.parentNode.nodeName&&!o(t.parentNode)?t.parentNode:t,n.caption?(v=n.attachment_id?"attachment_"+n.attachment_id:null,C="align"+(n.align||"none"),i="wp-caption "+C,n.captionClassName&&(i+=" "+n.captionClassName.replace(/[<>&]+/g,"")),c||(b=parseInt(b,10),b+=10),g?(w=E.select(".wp-caption",g),w.length&&E.setAttribs(w,{id:v,"class":i,style:"width: "+b+"px"}),_=E.select(".wp-caption-dd",g),_.length&&E.setHTML(_[0],n.caption)):(v=v?'id="'+v+'" ':"",s="<"+p+" "+v+'class="'+i+'" style="width: '+b+'px"><'+f+' class="wp-caption-dt">'+E.getOuterHTML(r)+"</"+f+"><"+m+' class="wp-caption-dd wp-caption-text">'+n.caption+"</"+m+"></"+p+">",(u=E.getParent(r,"p"))?(d=E.create("div",{"class":"mceTemp"},s),u.parentNode.insertBefore(d,u),E.remove(r),E.isEmpty(u)&&E.remove(u)):E.setOuterHTML(r,'<div class="mceTemp">'+s+"</div>"))):g&&(u=E.create("p"),g.parentNode.insertBefore(u,g),u.appendChild(r),E.remove(g)),wp.media.events&&wp.media.events.trigger("editor:image-update",{editor:e,metadata:n,image:t}),e.nodeChanged()}function r(t){var n,o,r;return"undefined"!=typeof wp&&wp.media?(r=a(t),wp.media.events.trigger("editor:image-edit",{editor:e,metadata:r,image:t}),n=wp.media({frame:"image",state:"image-details",metadata:r}),wp.media.events.trigger("editor:frame-create",{frame:n}),o=function(a){e.focus(),e.undoManager.transact(function(){i(t,a)}),n.detach()},n.state("image-details").on("update",o),n.state("replace-image").on("replace",o),n.on("close",function(){e.focus(),n.detach()}),void n.open()):void e.execCommand("mceImage")}function s(t){var n;"DIV"===t.nodeName&&e.dom.hasClass(t,"mceTemp")?n=t:("IMG"===t.nodeName||"DT"===t.nodeName||"A"===t.nodeName)&&(n=e.dom.getParent(t,"div.mceTemp")),null===n&&null!==e.dom.getParent(t,"a")&&(n=e.dom.getParent(t,"a")),n?(e.selection.select(n.nextSibling?n.nextSibling:n.previousSibling?n.previousSibling:n.parentNode),e.selection.collapse(!0),e.nodeChanged(),e.dom.remove(n)):e.dom.remove(t),jQuery(e.targetElm).find("p:empty").remove(),e.theme.panel.hide(),e.focus()}function u(t,n){n=n||!1;var a=t.states.get("gallery-edit");if(library=a.get("library"),0!==library.length){var o=wp.media.gallery.shortcode(library).string();wa_fronted.shortcode_to_html(o,n===!1?!0:!1,function(t){n!==!1?wa_fronted.replace_html(n,t):e.selection.setContent(t),e.hasOwnProperty("shortcode_edit")&&e.shortcode_edit.bind_shortcode_edit(e.targetElm)})}}function d(e){var t,n,a=wp.shortcode.next("gallery",e),o=wp.media.gallery.defaults.id;return a?(a=a.shortcode,_.isUndefined(a.get("id"))&&!_.isUndefined(o)&&a.set("id",o),t=wp.media.gallery.attachments(a),n=new wp.media.model.Selection(t.models,{props:t.props.toJSON(),multiple:!0}),n.gallery=t.gallery,n.more().done(function(){n.props.set({query:!1}),n.unmirror(),n.props.unset("orderby")}),n):!1}var l=window.tinymce,c=e.getParam("wpeditimage_html5_captions"),p=c?"figure":"dl",f=c?"section":"dt",m=c?"figcaption":"dd",h=!1,g={aspect_ratio:function(e,t){return e/t},round:function(e,t){return Number(Math.round(e+"e"+t)+"e-"+t)},get_closest_image_size:function(e,t,n,a){var o=this,t=Math.round(t),n=Math.round(n),i={diff:null,size_name:null,height:null,width:null,crop:null},r=o.round(o.aspect_ratio(n,t),2);for(size in global_vars.image_sizes){var s=global_vars.image_sizes[size],u=parseInt(s.height),d=parseInt(s.width),l=o.round(o.aspect_ratio(d,u),2);if(r===l||s.crop!==!0&&1!==s.crop){var c=Math.abs(t-u);(c<i.diff||null===i.diff)&&(i.diff=c,i.size_name=size,i.height=u,i.width=d,i.crop=s.crop)}}null!==i.size_name&&jQuery.post(global_vars.ajax_url,{action:"wa_get_image_src",attachment_id:e,size:i.size_name},function(e){a(e)})}};return e.on("init",function(){var t=e.dom;e.on("wpLoadImageForm",function(t){if(!e.getParam("wpeditimage_disable_captions")){var n={type:"textbox",flex:1,name:"caption",minHeight:60,multiline:!0,scroll:!0,label:"Image caption"};t.data.splice(t.data.length-1,0,n)}}),e.on("wpNewImageRefresh",function(e){var n,a;(n=t.getParent(e.node,".wp-caption"))&&(n.style.width||(a=parseInt(e.node.clientWidth,10)+10,a=a?a+"px":"50%",t.setStyle(n,"width",a)))}),e.on("wpImageFormSubmit",function(n){var a,o,i,r,s,u=n.imgData.data,d=n.imgData.node,l=n.imgData.caption,h="",g="",_="";return u.id="__wp-temp-img-id",n.imgData.cancel=!0,u.style||(u.style=null),u.src?(l&&(l=l.replace(/\r\n|\r/g,"\n").replace(/<\/?[a-zA-Z0-9]+( [^<>]+)?>/g,function(e){return e.replace(/[\r\n\t]+/," ")}),l=l.replace(/(<br[^>]*>)\s*\n\s*/g,"$1").replace(/\s*\n\s*/g,"<br />")),d?(s=d.id||null,t.setAttribs(d,u),a=t.getParent(d,".wp-caption"),l?a?(o=t.select(".wp-caption-dd",a)[0])&&(o.innerHTML=l):(d.className&&(h=d.className.match(/wp-image-([0-9]+)/),g=d.className.match(/align(left|right|center|none)/)),g?(g=g[0],d.className=d.className.replace(/align(left|right|center|none)/g,"")):g="alignnone",g=' class="wp-caption '+g+'"',h&&(h=' id="attachment_'+h[1]+'"'),_=u.width||d.clientWidth,_&&(_=parseInt(_,10),c||(_+=10),_=' style="width: '+_+'px"'),d.parentNode&&"A"===d.parentNode.nodeName?(r=t.getOuterHTML(d.parentNode),i=d.parentNode):(r=t.getOuterHTML(d),i=d),r="<"+p+" "+h+g+_+"><"+f+' class="wp-caption-dt">'+r+"</"+f+"><"+m+' class="wp-caption-dd wp-caption-text">'+l+"</"+m+"></"+p+">",(o=t.getParent(d,"p"))?(a=t.create("div",{"class":"mceTemp"},r),t.insertAfter(a,o),e.selection.select(a),e.nodeChanged(),t.remove(i),t.isEmpty(o)&&t.remove(o)):e.selection.setContent('<div class="mceTemp">'+r+"</div>")):a&&(r=t.getOuterHTML("A"===d.parentNode.nodeName?d.parentNode:d),o=t.create("p",{},r),t.insertAfter(o,a.parentNode),e.selection.select(o),e.nodeChanged(),t.remove(a.parentNode))):(r=t.createHTML("img",u),l?(i=e.selection.getNode(),u.width&&(_=parseInt(u.width,10),c||(_+=10),_=' style="width: '+_+'px"'),r="<"+p+' class="wp-caption alignnone"'+_+"><"+f+' class="wp-caption-dt">'+r+"</"+f+"><"+m+' class="wp-caption-dd wp-caption-text">'+l+"</"+m+"></"+p+">",o="P"===i.nodeName?i:t.getParent(i,"p"),o&&"P"===o.nodeName?(a=t.create("div",{"class":"mceTemp"},r),o.parentNode.insertBefore(a,o),e.selection.select(a),e.nodeChanged(),t.isEmpty(o)&&t.remove(o)):e.selection.setContent('<div class="mceTemp">'+r+"</div>")):e.selection.setContent(r)),d=t.get("__wp-temp-img-id"),t.setAttrib(d,"id",s),void(n.imgData.node=d)):void(d&&(t.remove((a=t.getParent(d,"div.mceTemp"))?a:"A"===d.parentNode.nodeName?d.parentNode:d),e.nodeChanged()))}),e.on("wpLoadImageData",function(n){var a,o=n.imgData.data,i=n.imgData.node;(a=t.getParent(i,".wp-caption"))&&(a=t.select(".wp-caption-dd",a)[0],a&&(o.caption=e.serializer.serialize(a).replace(/<br[^>]*>/g,"$&\n").replace(/^<p>/,"").replace(/<\/p>$/,"")))});var n=["image/jpeg","image/png","image/gif"];e.on("drop",function(t){if(!h&&Modernizr.filereader&&e.settings.fronted_options.media_upload===!0&&(t.preventDefault(),t.stopPropagation(),0!==t.dataTransfer.files.length)){wa_fronted.show_loading_spinner();var a=t.dataTransfer.files[0];if(-1!==jQuery.inArray(a.type,n)){var o=new FileReader;o.onload=function(t){jQuery.post(global_vars.ajax_url,{action:"wa_create_image",post_id:e.settings.fronted_options.post_id,file_data:encodeURIComponent(t.target.result),file_name:a.name,file_type:a.type,wa_fronted_save_nonce:global_vars.nonce},function(t){var n=t.attachment_obj,a=n.sizes.medium,o='<img src="'+a.url+'" width="'+a.width+'" height="'+a.height+'" alt="'+n.title+'" class="wp-image-'+n.id+' alignleft size-medium" style="height:'+a.height+"; width:"+a.width+';">';e.insertContent(o),wa_fronted.hide_loading_spinner()})},o.readAsDataURL(a)}else wa_fronted.show_loading_spinner()}}),t.bind(e.getDoc(),"dragend",function(e){h=!1}),t.bind(e.getDoc(),"dragstart",function(n){var a=e.selection.getNode();h=!0,"IMG"===a.nodeName&&(t.getParent(a,".wp-caption")||t.getParent(a,".gallery-icon"))&&n.preventDefault()}),l.Env.ie&&l.Env.ie>10&&(t.bind(e.getBody(),"mscontrolselect",function(n){"IMG"===n.target.nodeName&&t.getParent(n.target,".wp-caption")?e.getBody().focus():"DL"===n.target.nodeName&&t.hasClass(n.target,"wp-caption")&&n.target.focus()}),e.on("click",function(n){"IMG"===n.target.nodeName&&t.getAttrib(n.target,"data-wp-imgselect")&&t.getParent(n.target,".wp-caption")&&e.getBody().focus()}))}),e.on("ObjectResized",function(t){var n=t.target;if("IMG"===n.nodeName){var a=n.className.match(/wp-image-\d+/);if(null!==a){var o=a[0].match(/\d+/)[0];g.get_closest_image_size(o,n.height,n.width,function(e){e[3]===!0&&(n.className=n.className.replace(/size-\S+/,"size-"+e[4]),n.src=e[0])})}e.undoManager.transact(function(){var a,o,i=e.dom;n.className=n.className.replace(/\bsize-[^ ]+/,""),(a=i.getParent(n,".wp-caption"))&&(o=t.width||i.getAttrib(n,"width"),o&&(o=parseInt(o,10),c||(o+=10),i.setStyle(a,"width",o+"px")))})}}),e.on("BeforeExecCommand",function(t){var n,a,o,i,r=t.command,s=e.dom;if("mceInsertContent"===r)(n=s.getParent(e.selection.getNode(),"div.mceTemp"))?(a=s.create("p"),s.insertAfter(a,n),e.selection.setCursorLocation(a,0),e.nodeChanged()):-1!==t.value.indexOf("[gallery ")&&(t.preventDefault(),wa_fronted.show_loading_spinner(),wa_fronted.shortcode_to_html(t.value,!0,function(t){e.insertContent(t),e.hasOwnProperty("shortcode_edit")&&e.shortcode_edit.bind_shortcode_edit(e.targetElm),wa_fronted.hide_loading_spinner()}));else if("JustifyLeft"===r||"JustifyRight"===r||"JustifyCenter"===r||"alignnone"===r){if(n=e.selection.getNode(),i="align"+r.slice(7).toLowerCase(),o=e.dom.getParent(n,".wp-caption"),"IMG"!==n.nodeName&&!o)return;n=o||n,"alignleft"!==i&&e.dom.removeClass(n,"alignleft"),"aligncenter"!==i&&e.dom.removeClass(n,"aligncenter"),"alignright"!==i&&e.dom.removeClass(n,"alignright"),"alignnone"!==i&&e.dom.toggleClass(n,i),e.nodeChanged(),t.preventDefault()}}),e.on("keydown",function(t){var n,a,o,i,r=e.selection,u=t.keyCode,d=e.dom;if(u===l.util.VK.ENTER)n=r.getNode(),a=d.getParent(n,"div.mceTemp"),a&&(d.events.cancel(t),l.each(d.select(".wp-caption-dt, .wp-caption-dd",a),function(e){d.isEmpty(e)&&d.remove(e)}),i=l.Env.ie&&l.Env.ie<11?"":'<br data-mce-bogus="1" />',o=d.create("p",null,i),"DD"===n.nodeName?d.insertAfter(o,a):a.parentNode.insertBefore(o,a),e.nodeChanged(),r.setCursorLocation(o,0));else if((u===l.util.VK.DELETE||u===l.util.VK.BACKSPACE)&&(n=r.getNode(),"DIV"===n.nodeName&&d.hasClass(n,"mceTemp")?a=n:("IMG"===n.nodeName||"DT"===n.nodeName||"A"===n.nodeName)&&(a=d.getParent(n,"div.mceTemp")),a))return d.events.cancel(t),s(n),!1}),e.wpSetImgCaption=function(e){return t(e)},e.wpGetImgCaption=function(e){return n(e)},e.on("BeforeSetContent",function(t){"raw"!==t.format&&(t.content=e.wpSetImgCaption(t.content))}),e.on("PostProcess",function(t){t.get&&(t.content=e.wpGetImgCaption(t.content),t.content=t.content.replace(/ data-wp-imgselect="1"/g,""))}),e.addButton("remove",{tooltip:"Remove",icon:"dashicons-no",onclick:function(){s(e.selection.getNode())}}),e.addButton("edit",{tooltip:"Edit",icon:"dashicons-edit",onclick:function(){r(e.selection.getNode())}}),l.each({alignleft:"Align Left",aligncenter:"Align Center",alignright:"Align Right",alignnone:"Don’t Align"},function(t,n){var a=n.slice(5);e.addButton("img"+n,{tooltip:t,icon:"dashicons-align-"+a,cmd:"alignnone"===n?n:"Justify"+a.slice(0,1).toUpperCase()+a.slice(1),onPostRender:function(){var t=this;e.on("NodeChange",function(a){var o=e.dom.getParent(a.element,".wp-caption")||a.element;t.active("alignnone"===n?!e.dom.hasClass(o,"alignleft")&&!e.dom.hasClass(o,"aligncenter")&&!e.dom.hasClass(o,"alignright"):e.dom.hasClass(o,n))})}})}),e.addButton("wp_media",{tooltip:"Media",icon:"dashicons-admin-media",onclick:function(){wp.media.editor.open(e.id)}}),wa_fronted.add_action("shortcode_action_gallery",function(t,n){if(0!==n.parents("#"+e.id).length){var a=wp.media({frame:"post",state:"gallery-edit",title:wp.media.view.l10n.editGalleryTitle,editing:!0,multiple:!0,selection:d(t)});a.state("gallery-edit").on("update",function(){u(a,n)}),a.on("close",function(){e.focus(),a.detach()}),a.open()}}),{_do_shcode:t,_get_shcode:n}});
window.wp=window.wp||{},tinymce.ThemeManager.add("fronted",function(e){function t(e,t){for(;e;){if(e.nodeName===t)return e;e=e.parentNode}return!1}function n(n,a){var o,i=[];if(n)return d(n,function(n){function r(){var t=e.selection;"bullist"===d&&t.selectorChanged("ul > li",function(e,t){for(var a,o=t.parents.length;o--&&(a=t.parents[o].nodeName,"OL"!==a&&"UL"!==a););n.active(e&&"UL"===a)}),"numlist"===d&&t.selectorChanged("ol > li",function(e,t){for(var a,o=t.parents.length;o--&&(a=t.parents[o].nodeName,"OL"!==a&&"UL"!==a););n.active(e&&"OL"===a)}),n.settings.stateSelector&&t.selectorChanged(n.settings.stateSelector,function(e){n.active(e)},!0),n.settings.disabledStateSelector&&t.selectorChanged(n.settings.disabledStateSelector,function(e){n.disabled(e)})}var d;"|"===n?o=null:u.has(n)?(n={type:n},s.toolbar_items_size&&(n.size=s.toolbar_items_size),i.push(n),o=null):((!o||a)&&(o={type:"buttongroup",items:[]},i.push(o)),e.buttons[n]&&(d=n,n=e.buttons[d],"function"==typeof n&&(n=n()),n.icon&&-1!==n.icon.indexOf("dashicons")&&(n.icon="dashicon "+n.icon),a&&(n.text=n.tooltip,n.tooltip=!1),n.type=n.type||"button",s.toolbar_items_size&&(n.size=s.toolbar_items_size),"link"===d?n.onPostRender=function(){var n=this;e.on("NodeChange",function(e){n.active(t(e.element,"A"))})}:"unlink"===d&&(n.onPostRender=function(){var t=this;e.on("NodeChange",function(n){var a="A"!==n.element.nodeName&&-1===e.selection.getContent().indexOf("<a");t.disabled(a),l.setAttrib(t.getEl(),"tabindex",a?"0":"-1")})},n.onclick=function(){-1===e.selection.getContent().indexOf("<a")&&e.selection.select(e.selection.getNode()),e.execCommand("unlink")}),n=u.create(n),o.items.push(n),e.initialized?r():e.on("init",r)))}),i}function a(e){return u.create({type:"panel",layout:"stack",classes:"toolbar-grp",ariaRoot:!0,ariaRemember:!0,items:[{type:"toolbar",layout:"flow",items:n(e)}]})}var o,i=window.tinymce,r=this,s=e.settings,u=i.ui.Factory,d=i.each,l=i.DOM,c=32;d({H1:"Heading 1",H2:"Heading 2",H3:"Heading 3",H4:"Heading 4",H5:"Heading 5",H6:"Heading 6",Pre:"Preformatted"},function(t,n){var a=n.toLowerCase();e.addButton(a,{tooltip:t,text:n,onclick:function(){e.formatter.toggle(a)},onPostRender:function(){var t=this;e.on("nodeChange",function(n){d(n.parents,function(n){t.active(!!e.formatter.matchNode(n,a))})})}})}),e.toolbarItems=n,r.renderUI=function(){function t(){return""===e.getContent({format:"raw"}).replace(/(?:<p[^>]*>)?(?:<br[^>]*>)?(?:<\/p>)?/,"")}var n,i,p={},f=0;return s.content_editable=!0,e.on("activate focus",function(){o=!0,l.addClass(e.getBody(),"mce-edit-focus")}),e.on("deactivate blur hide",function(){o=!1,l.removeClass(e.getBody(),"mce-edit-focus")}),e.on("remove",function(){n&&n.remove(),n=null}),s.placeholder&&(e.on("blur LoadContent deactivate",function(){t()&&(e.setContent(s.placeholder),i=!0,l.addClass(e.getBody(),"mce-placeholder"))}),e.on("focus activate",function(){i&&e.setContent("")}),e.on("SetContent",function(t){i&&!t.load&&(i=!1,l.removeClass(e.getBody(),"mce-placeholder"))}),e.on("PostProcess",function(e){i&&e.content&&(e.content="")}),e.on("BeforeAddUndo",function(e){i&&e.preventDefault()})),s.toolbar&&s.toolbar.length&&!n?("relative"===l.getStyle(document.body,"position",!0)&&(f=parseInt(l.getStyle(document.body,"margin-top",!0),10)+parseInt(l.getStyle(document.documentElement,"padding-top",!0),10)+parseInt(l.getStyle(document.documentElement,"margin-top",!0),10)),p.normal=a(s.toolbar),p.img=a(wa_fronted.apply_filters("image_edit_toolbar",["imgalignleft","imgaligncenter","imgalignright","imgalignnone","edit","remove"],s.fronted_options)),p.view=a(["editview","removeview"]),p.media=a(wa_fronted.apply_filters("image_upload_toolbar",["wp_media"],s.fronted_options)),n=r.panel=u.create({type:"floatpanel",role:"application",classes:"tinymce tinymce-inline",layout:"stack",autohide:!0,items:[p.normal,p.img,p.view,p.media]}),n.reposition=function(t,n){var a,o,i,r,s,u=this.getEl(),m=n||e.selection.getRng(),h=m.getBoundingClientRect(),g=(h.left+h.right)/2,_=window.innerWidth,w=parseInt(l.getStyle(u,"margin-bottom",!0),10)+f;if(m.collapsed||0===g){var v=wa_fronted.getCaretPositionPx();h={top:v.y,bottom:v.y+u.offsetHeight/2,left:v.x,right:v.x},g=v.x}return u.className=(" "+u.className+" ").replace(/\smce-arrow-\S+\s/g," ").slice(1,-1),t=t||"normal",p[t]._visible||(d(p,function(e){e.hide()}),p[t].show()),a=u.offsetWidth,o=a/2,h.top<u.offsetHeight+c?(s=" mce-arrow-up",i=h.bottom+w):(s=" mce-arrow-down",i=h.top-u.offsetHeight-w),r=g-o,a>=_?(s+=" mce-arrow-full",r=0):0>r&&h.left+a>_||r+a>_&&h.right-a<0?r=(_-a)/2:0>r?(s+=" mce-arrow-left",r=h.left):r+a>_&&(s+=" mce-arrow-right",r=h.right-a),u.className+=s,l.setStyles(u,{left:r,top:i+window.pageYOffset}),this},n.on("show",function(){var e=this;setTimeout(function(){e._visible&&l.addClass(e.getEl(),"mce-inline-toolbar-active")},100)}),n.on("hide",function(){l.removeClass(this.getEl(),"mce-inline-toolbar-active")}),n.on("cancel",function(){e.focus()}),l.bind(window,"resize",function(){n.hide()}),e.on("selectionchange nodechange",function(t){var a=t.element||e.selection.getNode(),i=e.plugins.wpview.getView(),r=jQuery(a).parents('.wa-shortcode-wrap[data-shortcode-base="gallery"]');0!==r.length&&(t.preventDefault(),e.selection.select(r[0]),e.selection.collapse(),n.hide()),e.selection.isCollapsed()&&!i&&n.hide(),setTimeout(function(){var t,r;o&&(!e.selection.isCollapsed()&&(t=e.selection.getContent())&&(t.replace(/<[^>]+>/g,"").trim()||0===t.indexOf("<"))&&"HR"!==a.nodeName||i?(r=i?"view":"IMG"===a.nodeName?"img":"normal",n.show().reposition(r,i)):e.selection.isCollapsed()&&"IMG"!==a.nodeName&&!i&&s.fronted_options.media_upload?n.show().reposition("media",i):n.hide())},100)}),e.shortcuts.add("Alt+F10","",function(){var e=n.find("toolbar")[0];e&&e.focus(!0)}),n.renderTo(document.body).reflow().hide(),d(p,function(e){e.hide()}),{}):{}}});
window.Modernizr=function(e,t,n){function a(e){v.cssText=e}function o(e,t){return a(D.join(e+";")+(t||""))}function i(e,t){return typeof e===t}function r(e,t){return!!~(""+e).indexOf(t)}function s(e,t){for(var a in e){var o=e[a];if(!r(o,"-")&&v[o]!==n)return"pfx"==t?o:!0}return!1}function u(e,t,a){for(var o in e){var r=t[e[o]];if(r!==n)return a===!1?e[o]:i(r,"function")?r.bind(a||t):r}return!1}function d(e,t,n){var a=e.charAt(0).toUpperCase()+e.slice(1),o=(e+" "+b.join(a+" ")+a).split(" ");return i(t,"string")||i(t,"undefined")?s(o,t):(o=(e+" "+y.join(a+" ")+a).split(" "),u(o,t,n))}var l,c,p,f="2.8.3",m={},h=!0,g=t.documentElement,_="modernizr",w=t.createElement(_),v=w.style,D=({}.toString," -webkit- -moz- -o- -ms- ".split(" ")),F="Webkit Moz O ms",b=F.split(" "),y=F.toLowerCase().split(" "),C={},E=[],A=E.slice,B=function(e,n,a,o){var i,r,s,u,d=t.createElement("div"),l=t.body,c=l||t.createElement("body");if(parseInt(a,10))for(;a--;)s=t.createElement("div"),s.id=o?o[a]:_+(a+1),d.appendChild(s);return i=["&#173;",'<style id="s',_,'">',e,"</style>"].join(""),d.id=_,(l?d:c).innerHTML+=i,c.appendChild(d),l||(c.style.background="",c.style.overflow="hidden",u=g.style.overflow,g.style.overflow="hidden",g.appendChild(c)),r=n(d,e),l?d.parentNode.removeChild(d):(c.parentNode.removeChild(c),g.style.overflow=u),!!r},x=function(){function e(e,o){o=o||t.createElement(a[e]||"div"),e="on"+e;var r=e in o;return r||(o.setAttribute||(o=t.createElement("div")),o.setAttribute&&o.removeAttribute&&(o.setAttribute(e,""),r=i(o[e],"function"),i(o[e],"undefined")||(o[e]=n),o.removeAttribute(e))),o=null,r}var a={select:"input",change:"input",submit:"form",reset:"form",error:"img",load:"img",abort:"img"};return e}(),N={}.hasOwnProperty;p=i(N,"undefined")||i(N.call,"undefined")?function(e,t){return t in e&&i(e.constructor.prototype[t],"undefined")}:function(e,t){return N.call(e,t)},Function.prototype.bind||(Function.prototype.bind=function(e){var t=this;if("function"!=typeof t)throw new TypeError;var n=A.call(arguments,1),a=function(){if(this instanceof a){var o=function(){};o.prototype=t.prototype;var i=new o,r=t.apply(i,n.concat(A.call(arguments)));return Object(r)===r?r:i}return t.apply(e,n.concat(A.call(arguments)))};return a}),C.draganddrop=function(){var e=t.createElement("div");return"draggable"in e||"ondragstart"in e&&"ondrop"in e},C.opacity=function(){return o("opacity:.55"),/^0.55$/.test(v.opacity)},C.cssanimations=function(){return d("animationName")},C.csstransforms=function(){return!!d("transform")},C.csstransforms3d=function(){var e=!!d("perspective");return e&&"webkitPerspective"in g.style&&B("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}",function(t,n){e=9===t.offsetLeft&&3===t.offsetHeight}),e},C.csstransitions=function(){return d("transition")};for(var k in C)p(C,k)&&(c=k.toLowerCase(),m[c]=C[k](),E.push((m[c]?"":"no-")+c));return m.addTest=function(e,t){if("object"==typeof e)for(var a in e)p(e,a)&&m.addTest(a,e[a]);else{if(e=e.toLowerCase(),m[e]!==n)return m;t="function"==typeof t?t():t,"undefined"!=typeof h&&h&&(g.className+=" "+(t?"":"no-")+e),m[e]=t}return m},a(""),w=l=null,function(e,t){function n(e,t){var n=e.createElement("p"),a=e.getElementsByTagName("head")[0]||e.documentElement;return n.innerHTML="x<style>"+t+"</style>",a.insertBefore(n.lastChild,a.firstChild)}function a(){var e=w.elements;return"string"==typeof e?e.split(" "):e}function o(e){var t=_[e[h]];return t||(t={},g++,e[h]=g,_[g]=t),t}function i(e,n,a){if(n||(n=t),l)return n.createElement(e);a||(a=o(n));var i;return i=a.cache[e]?a.cache[e].cloneNode():m.test(e)?(a.cache[e]=a.createElem(e)).cloneNode():a.createElem(e),!i.canHaveChildren||f.test(e)||i.tagUrn?i:a.frag.appendChild(i)}function r(e,n){if(e||(e=t),l)return e.createDocumentFragment();n=n||o(e);for(var i=n.frag.cloneNode(),r=0,s=a(),u=s.length;u>r;r++)i.createElement(s[r]);return i}function s(e,t){t.cache||(t.cache={},t.createElem=e.createElement,t.createFrag=e.createDocumentFragment,t.frag=t.createFrag()),e.createElement=function(n){return w.shivMethods?i(n,e,t):t.createElem(n)},e.createDocumentFragment=Function("h,f","return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&("+a().join().replace(/[\w\-]+/g,function(e){return t.createElem(e),t.frag.createElement(e),'c("'+e+'")'})+");return n}")(w,t.frag)}function u(e){e||(e=t);var a=o(e);return w.shivCSS&&!d&&!a.hasCSS&&(a.hasCSS=!!n(e,"article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")),l||s(e,a),e}var d,l,c="3.7.0",p=e.html5||{},f=/^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i,m=/^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i,h="_html5shiv",g=0,_={};!function(){try{var e=t.createElement("a");e.innerHTML="<xyz></xyz>",d="hidden"in e,l=1==e.childNodes.length||function(){t.createElement("a");var e=t.createDocumentFragment();return"undefined"==typeof e.cloneNode||"undefined"==typeof e.createDocumentFragment||"undefined"==typeof e.createElement}()}catch(n){d=!0,l=!0}}();var w={elements:p.elements||"abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output progress section summary template time video",version:c,shivCSS:p.shivCSS!==!1,supportsUnknownElements:l,shivMethods:p.shivMethods!==!1,type:"default",shivDocument:u,createElement:i,createDocumentFragment:r};e.html5=w,u(t)}(this,t),m._version=f,m._prefixes=D,m._domPrefixes=y,m._cssomPrefixes=b,m.hasEvent=x,m.testProp=function(e){return s([e])},m.testAllProps=d,m.testStyles=B,g.className=g.className.replace(/(^|\s)no-js(\s|$)/,"$1$2")+(h?" js "+E.join(" "):""),m}(this,this.document),function(e,t,n){function a(e){return"[object Function]"==g.call(e)}function o(e){return"string"==typeof e}function i(){}function r(e){return!e||"loaded"==e||"complete"==e||"uninitialized"==e}function s(){var e=_.shift();w=1,e?e.t?m(function(){("c"==e.t?p.injectCss:p.injectJs)(e.s,0,e.a,e.x,e.e,1)},0):(e(),s()):w=0}function u(e,n,a,o,i,u,d){function l(t){if(!f&&r(c.readyState)&&(v.r=f=1,!w&&s(),c.onload=c.onreadystatechange=null,t)){"img"!=e&&m(function(){F.removeChild(c)},50);for(var a in A[n])A[n].hasOwnProperty(a)&&A[n][a].onload()}}var d=d||p.errorTimeout,c=t.createElement(e),f=0,g=0,v={t:a,s:n,e:i,a:u,x:d};1===A[n]&&(g=1,A[n]=[]),"object"==e?c.data=n:(c.src=n,c.type=e),c.width=c.height="0",c.onerror=c.onload=c.onreadystatechange=function(){l.call(this,g)},_.splice(o,0,v),"img"!=e&&(g||2===A[n]?(F.insertBefore(c,D?null:h),m(l,d)):A[n].push(c))}function d(e,t,n,a,i){return w=0,t=t||"j",o(e)?u("c"==t?y:b,e,t,this.i++,n,a,i):(_.splice(this.i++,0,e),1==_.length&&s()),this}function l(){var e=p;return e.loader={load:d,i:0},e}var c,p,f=t.documentElement,m=e.setTimeout,h=t.getElementsByTagName("script")[0],g={}.toString,_=[],w=0,v="MozAppearance"in f.style,D=v&&!!t.createRange().compareNode,F=D?f:h.parentNode,f=e.opera&&"[object Opera]"==g.call(e.opera),f=!!t.attachEvent&&!f,b=v?"object":f?"script":"img",y=f?"script":b,C=Array.isArray||function(e){return"[object Array]"==g.call(e)},E=[],A={},B={timeout:function(e,t){return t.length&&(e.timeout=t[0]),e}};p=function(e){function t(e){var t,n,a,e=e.split("!"),o=E.length,i=e.pop(),r=e.length,i={url:i,origUrl:i,prefixes:e};for(n=0;r>n;n++)a=e[n].split("="),(t=B[a.shift()])&&(i=t(i,a));for(n=0;o>n;n++)i=E[n](i);return i}function r(e,o,i,r,s){var u=t(e),d=u.autoCallback;u.url.split(".").pop().split("?").shift(),u.bypass||(o&&(o=a(o)?o:o[e]||o[r]||o[e.split("/").pop().split("?")[0]]),u.instead?u.instead(e,o,i,r,s):(A[u.url]?u.noexec=!0:A[u.url]=1,i.load(u.url,u.forceCSS||!u.forceJS&&"css"==u.url.split(".").pop().split("?").shift()?"c":n,u.noexec,u.attrs,u.timeout),(a(o)||a(d))&&i.load(function(){l(),o&&o(u.origUrl,s,r),d&&d(u.origUrl,s,r),A[u.url]=2})))}function s(e,t){function n(e,n){if(e){if(o(e))n||(c=function(){var e=[].slice.call(arguments);p.apply(this,e),f()}),r(e,c,t,0,d);else if(Object(e)===e)for(u in s=function(){var t,n=0;for(t in e)e.hasOwnProperty(t)&&n++;return n}(),e)e.hasOwnProperty(u)&&(!n&&!--s&&(a(c)?c=function(){var e=[].slice.call(arguments);p.apply(this,e),f()}:c[u]=function(e){return function(){var t=[].slice.call(arguments);e&&e.apply(this,t),f()}}(p[u])),r(e[u],c,t,u,d))}else!n&&f()}var s,u,d=!!e.test,l=e.load||e.both,c=e.callback||i,p=c,f=e.complete||i;n(d?e.yep:e.nope,!!l),l&&n(l)}var u,d,c=this.yepnope.loader;if(o(e))r(e,0,c,0);else if(C(e))for(u=0;u<e.length;u++)d=e[u],o(d)?r(d,0,c,0):C(d)?p(d):Object(d)===d&&s(d,c);else Object(e)===e&&s(e,c)},p.addPrefix=function(e,t){B[e]=t},p.addFilter=function(e){E.push(e)},p.errorTimeout=1e4,null==t.readyState&&t.addEventListener&&(t.readyState="loading",t.addEventListener("DOMContentLoaded",c=function(){t.removeEventListener("DOMContentLoaded",c,0),t.readyState="complete"},0)),e.yepnope=l(),e.yepnope.executeStack=s,e.yepnope.injectJs=function(e,n,a,o,u,d){var l,c,f=t.createElement("script"),o=o||p.errorTimeout;f.src=e;for(c in a)f.setAttribute(c,a[c]);n=d?s:n||i,f.onreadystatechange=f.onload=function(){!l&&r(f.readyState)&&(l=1,n(),f.onload=f.onreadystatechange=null)},m(function(){l||(l=1,n(1))},o),u?f.onload():h.parentNode.insertBefore(f,h)},e.yepnope.injectCss=function(e,n,a,o,r,u){var d,o=t.createElement("link"),n=u?s:n||i;o.href=e,o.rel="stylesheet",o.type="text/css";for(d in a)o.setAttribute(d,a[d]);r||(h.parentNode.insertBefore(o,h),m(n,0))}}(this,document),Modernizr.load=function(){yepnope.apply(window,[].slice.call(arguments,0))},Modernizr.addTest("contenteditable","contentEditable"in document.documentElement),Modernizr.addTest("filereader",function(){return!!(window.File&&window.FileList&&window.FileReader)});
...
!function(e){e(["jquery"],function(e){return function(){function t(e,t,n){return m({type:F.error,iconClass:h().iconClasses.error,message:e,optionsOverride:n,title:t})}function n(t,n){return t||(t=h()),_=e("#"+t.containerId),_.length?_:(n&&(_=c(t)),_)}function a(e,t,n){return m({type:F.info,iconClass:h().iconClasses.info,message:e,optionsOverride:n,title:t})}function o(e){w=e}function i(e,t,n){return m({type:F.success,iconClass:h().iconClasses.success,message:e,optionsOverride:n,title:t})}function r(e,t,n){return m({type:F.warning,iconClass:h().iconClasses.warning,message:e,optionsOverride:n,title:t})}function s(e,t){var a=h();_||n(a),l(e,a,t)||d(a)}function u(t){var a=h();return _||n(a),t&&0===e(":focus",t).length?void g(t):void(_.children().length&&_.remove())}function d(t){for(var n=_.children(),a=n.length-1;a>=0;a--)l(e(n[a]),t)}function l(t,n,a){var o=a&&a.force?a.force:!1;return t&&(o||0===e(":focus",t).length)?(t[n.hideMethod]({duration:n.hideDuration,easing:n.hideEasing,complete:function(){g(t)}}),!0):!1}function c(t){return _=e("<div/>").attr("id",t.containerId).addClass(t.positionClass).attr("aria-live","polite").attr("role","alert"),_.appendTo(e(t.target)),_}function p(){return{tapToDismiss:!0,toastClass:"toast",containerId:"toast-container",debug:!1,showMethod:"fadeIn",showDuration:300,showEasing:"swing",onShown:void 0,hideMethod:"fadeOut",hideDuration:1e3,hideEasing:"swing",onHidden:void 0,closeMethod:!1,closeDuration:!1,closeEasing:!1,extendedTimeOut:1e3,iconClasses:{error:"toast-error",info:"toast-info",success:"toast-success",warning:"toast-warning"},iconClass:"toast-info",positionClass:"toast-top-right",timeOut:5e3,titleClass:"toast-title",messageClass:"toast-message",escapeHtml:!1,target:"body",closeHtml:'<button type="button">&times;</button>',newestOnTop:!0,preventDuplicates:!1,progressBar:!1}}function f(e){w&&w(e)}function m(t){function a(e){return null==e&&(e=""),new String(e).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function o(){s(),d(),l(),c(),p(),u()}function i(){B.hover(b,F),!C.onclick&&C.tapToDismiss&&B.click(w),C.closeButton&&T&&T.click(function(e){e.stopPropagation?e.stopPropagation():void 0!==e.cancelBubble&&e.cancelBubble!==!0&&(e.cancelBubble=!0),w(!0)}),C.onclick&&B.click(function(e){C.onclick(e),w()})}function r(){B.hide(),B[C.showMethod]({duration:C.showDuration,easing:C.showEasing,complete:C.onShown}),C.timeOut>0&&(A=setTimeout(w,C.timeOut),z.maxHideTime=parseFloat(C.timeOut),z.hideEta=(new Date).getTime()+z.maxHideTime,C.progressBar&&(z.intervalId=setInterval(y,10)))}function s(){t.iconClass&&B.addClass(C.toastClass).addClass(E)}function u(){C.newestOnTop?_.prepend(B):_.append(B)}function d(){t.title&&(x.append(C.escapeHtml?a(t.title):t.title).addClass(C.titleClass),B.append(x))}function l(){t.message&&(N.append(C.escapeHtml?a(t.message):t.message).addClass(C.messageClass),B.append(N))}function c(){C.closeButton&&(T.addClass("toast-close-button").attr("role","button"),B.prepend(T))}function p(){C.progressBar&&(k.addClass("toast-progress"),B.prepend(k))}function m(e,t){if(e.preventDuplicates){if(t.message===v)return!0;v=t.message}return!1}function w(t){var n=t&&C.closeMethod!==!1?C.closeMethod:C.hideMethod,a=t&&C.closeDuration!==!1?C.closeDuration:C.hideDuration,o=t&&C.closeEasing!==!1?C.closeEasing:C.hideEasing;return!e(":focus",B).length||t?(clearTimeout(z.intervalId),B[n]({duration:a,easing:o,complete:function(){g(B),C.onHidden&&"hidden"!==S.state&&C.onHidden(),S.state="hidden",S.endTime=new Date,f(S)}})):void 0}function F(){(C.timeOut>0||C.extendedTimeOut>0)&&(A=setTimeout(w,C.extendedTimeOut),z.maxHideTime=parseFloat(C.extendedTimeOut),z.hideEta=(new Date).getTime()+z.maxHideTime)}function b(){clearTimeout(A),z.hideEta=0,B.stop(!0,!0)[C.showMethod]({duration:C.showDuration,easing:C.showEasing})}function y(){var e=(z.hideEta-(new Date).getTime())/z.maxHideTime*100;k.width(e+"%")}var C=h(),E=t.iconClass||C.iconClass;if("undefined"!=typeof t.optionsOverride&&(C=e.extend(C,t.optionsOverride),E=t.optionsOverride.iconClass||E),!m(C,t)){D++,_=n(C,!0);var A=null,B=e("<div/>"),x=e("<div/>"),N=e("<div/>"),k=e("<div/>"),T=e(C.closeHtml),z={intervalId:null,hideEta:null,maxHideTime:null},S={toastId:D,state:"visible",startTime:new Date,options:C,map:t};return o(),r(),i(),f(S),C.debug&&console&&console.log(S),B}}function h(){return e.extend({},p(),b.options)}function g(e){_||(_=n()),e.is(":visible")||(e.remove(),e=null,0===_.children().length&&(_.remove(),v=void 0))}var _,w,v,D=0,F={error:"error",info:"info",success:"success",warning:"warning"},b={clear:s,remove:u,error:t,getContainer:n,info:a,options:{},subscribe:o,success:i,version:"2.1.2",warning:r};return b}()})}("function"==typeof define&&define.amd?define:function(e,t){"undefined"!=typeof module&&module.exports?module.exports=t(require("jquery")):window.toastr=t(window.jQuery)});
...
var fronted_featured_img=function(e,t){this.options=t,this.editor=e,this.has_thumbnail=!1,this.frame=!1,this.replace_this=!1,this.init()};!function(e){window.wp=window.wp||{},fronted_featured_img.prototype.init=function(){var e=this;0!==e.editor.find("img.attachment-post-thumbnail").length?(e.has_thumbnail=!0,e.replace_this=e.editor.find("img.attachment-post-thumbnail")):e.show_placeholder(),e.frame=window.wp.media({frame:"post",state:"featured-image",states:[new window.wp.media.controller.FeaturedImage,new window.wp.media.controller.EditImage]}),e.frame.state("featured-image").on("select",function(){e.frame.state().get("selection").single();"undefined"!=typeof e.replace_this&&e.replace_this!==!1?e.insert_image(e.frame,e.replace_this):e.insert_image(e.frame)}),e.create_toolbar()},fronted_featured_img.prototype.create_toolbar=function(){var e=this;featured_image_toolbar=document.createElement("div"),featured_image_toolbar.className="fronted-featured-image-toolbar",featured_image_toolbar.buttons=[{id:"add-image",icon:"dashicons dashicons-format-image",title:wa_fronted.i18n("Add image"),on_empty:!0,func:function(t){e.edit()}},{id:"edit-image",icon:"dashicons dashicons-edit",title:wa_fronted.i18n("Edit image"),on_empty:!1,func:function(t){wa_fronted.show_loading_spinner(),jQuery.post(global_vars.ajax_url,{action:"wa_get_thumbnail_id",post_id:e.options.post_id},function(t){""!==t.attachment_id&&t.attachment_id!==!1&&(window.wp.media.view.settings.post.featuredImageId=parseInt(t.attachment_id),e.edit(parseInt(t.attachment_id))),wa_fronted.hide_loading_spinner()})}},{id:"remove-image",icon:"dashicons dashicons-no",title:wa_fronted.i18n("Remove image"),on_empty:!1,func:function(t){wa_fronted.show_loading_spinner(),jQuery.post(global_vars.ajax_url,{action:"wa_delete_post_thumbnail",post_id:e.options.post_id},function(t){e.editor.find("img.attachment-post-thumbnail").remove(),e.has_thumbnail=!1,e.show_placeholder(),wa_fronted.hide_loading_spinner()})}}],featured_image_toolbar.buttons=wa_fronted.apply_filters("featured_image_toolbar",featured_image_toolbar.buttons,e.options);for(var t=0;t<featured_image_toolbar.buttons.length;t++){var n=featured_image_toolbar.buttons[t],a=document.createElement("button"),o=document.createElement("i");a.className="fronted-featured-image-"+n.id,o.className=n.icon,o.title=n.title,a.appendChild(o),featured_image_toolbar.appendChild(a),a.addEventListener("click",n.func)}document.body.appendChild(featured_image_toolbar),e.featured_image_toolbar=jQuery(featured_image_toolbar),e.editor.on("mouseenter click",function(t){e.show_toolbar(t,e)}),e.editor.on("mouseleave",function(t){e.hide_toolbar(t,e)}),e.featured_image_toolbar.on("mouseleave",function(t){e.hide_toolbar(t,e)})},fronted_featured_img.prototype.show_toolbar=function(e,t){e.preventDefault();var t=this;if(0!==t.featured_image_toolbar[0].buttons.length)for(var n=0;n<t.featured_image_toolbar[0].buttons.length;n++){var a=t.featured_image_toolbar[0].buttons[n],o=t.featured_image_toolbar.find(".fronted-featured-image-"+a.id);t.has_thumbnail?a.on_empty?o.removeClass("show"):o.addClass("show"):a.on_empty?o.addClass("show"):o.removeClass("show")}var i=t.editor.find("img.attachment-post-thumbnail");i=0===i.length?t.editor.find(".featured-post-placeholder"):i;var r=i.offset();t.featured_image_toolbar.css({width:i.width(),height:i.height(),top:r.top,left:r.left}).addClass("show")},fronted_featured_img.prototype.hide_toolbar=function(e,t){e.preventDefault();var t=this;null!==e.toElement&&-1===e.toElement.className.indexOf("fronted-featured-image-")&&t.featured_image_toolbar.removeClass("show")},fronted_featured_img.prototype.show_placeholder=function(){var e=this;0===e.editor.find(".featured-post-placeholder").length?e.editor.append('<div class="featured-post-placeholder"><i class="dashicons dashicons-format-image"></i></div>'):e.editor.find(".featured-post-placeholder").show(),e.replace_this=e.editor.find(".featured-post-placeholder")},fronted_featured_img.prototype.edit=function(e){var t=this.frame;e=e||!1,t.once("open",function(){var n=t.state().get("selection");e!==!1?(attachment=window.wp.media.attachment(e),attachment.fetch(),n.add(attachment)):n.reset()}),t.open()},fronted_featured_img.prototype.insert_image=function(e,t){var n=this,a=e.state(),o=a.get("selection"),t=t||!1;o&&o.each(function(e){var o,i,r=a.display(e).toJSON(),s=e.toJSON(),u=s.caption;window.wp.media.view.settings.captions||delete s.caption,r=window.wp.media.string.props(r,s),o={id:s.id,post_content:s.description,post_excerpt:u},"featured-image"!==a.id?(r.linkUrl&&(o.url=r.linkUrl),"image"===s.type?(r.url=r.src,i=window.wp.media.string.image(r),_.each({align:"align",size:"image-size",alt:"image_alt"},function(e,t){r[t]&&(o[e]=r[t])})):"video"===s.type?i=window.wp.media.string.video(r,s):"audio"===s.type?i=window.wp.media.string.audio(r,s):(i=window.wp.media.string.link(r),o.post_title=r.title),e.attributes.nonce=window.wp.media.view.settings.nonce.sendToEditor,e.attributes.attachment=o,e.attributes.html=i,e.attributes.post_id=window.wp.media.view.settings.post.id,t!==!1?window.wp.media.view.settings.captions&&u?wa_fronted.shortcode_to_html(e.attributes.html,!0,function(e){wa_fronted.replace_html(t,e),n.replace_this=!1,n.enable_resizing(n.instance,jQuery(n.instance.elements))}):(wa_fronted.replace_html(t,e.attributes.html),n.replace_this=!1):window.wp.media.view.settings.captions&&u?wa_fronted.shortcode_to_html(e.attributes.html,!0,function(e){wa_fronted.insertHtmlAtCaret(e),n.enable_resizing(n.instance,jQuery(n.instance.elements))}):wa_fronted.insertHtmlAtCaret(e.attributes.html)):(wa_fronted.show_loading_spinner(),jQuery.post(global_vars.ajax_url,{action:"wa_set_thumbnail",attachment_id:o.id,image_size:n.options.image_size,post_id:n.options.post_id},function(e){e.hasOwnProperty("html")&&t!==!1&&(wa_fronted.replace_html(t,e.html),n.replace_this=n.editor.find("img.attachment-post-thumbnail"),n.has_thumbnail=!0),wa_fronted.hide_loading_spinner()}))})}}(jQuery);
var EventManager=function(){function e(e,t,n,a){return"string"==typeof e&&"function"==typeof t&&(n=parseInt(n||10,10),s("actions",e,t,n,a)),l}function t(){var e=Array.prototype.slice.call(arguments),t=e.shift();return"string"==typeof t&&d("actions",t,e),l}function n(e,t){return"string"==typeof e&&r("actions",e,t),l}function a(e,t,n,a){return"string"==typeof e&&"function"==typeof t&&(n=parseInt(n||10,10),s("filters",e,t,n,a)),l}function o(){var e=Array.prototype.slice.call(arguments),t=e.shift();return"string"==typeof t?d("filters",t,e):l}function i(e,t){return"string"==typeof e&&r("filters",e,t),l}function r(e,t,n,a){if(c[e][t])if(n){var o,i=c[e][t];if(a)for(o=i.length;o--;){var r=i[o];r.callback===n&&r.context===a&&i.splice(o,1)}else for(o=i.length;o--;)i[o].callback===n&&i.splice(o,1)}else c[e][t]=[]}function s(e,t,n,a,o){var i={callback:n,priority:a,context:o},r=c[e][t];r?(r.push(i),r=u(r)):r=[i],c[e][t]=r}function u(e){for(var t,n,a,o=1,i=e.length;i>o;o++){for(t=e[o],n=o;(a=e[n-1])&&a.priority>t.priority;)e[n]=e[n-1],--n;e[n]=t}return e}function d(e,t,n){var a=c[e][t];if(!a)return"filters"===e?n[0]:!1;var o=0,i=a.length;if("filters"===e)for(;i>o;o++)n[0]=a[o].callback.apply(a[o].context,n);else for(;i>o;o++)a[o].callback.apply(a[o].context,n);return"filters"===e?n[0]:!0}var l={removeFilter:i,applyFilters:o,addFilter:a,removeAction:n,doAction:t,addAction:e},c={actions:{},filters:{}};return l};
function escape_regexp(e){return e.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")}var wa_fronted;!function(e){window.wp=window.wp||{};var t=window.tinymce;e.fn.getCursorPosition=function(){var t=e(this).get(0),n=0;if("selectionStart"in t)n=t.selectionStart;else if("selection"in document){t.focus();var a=document.selection.createRange(),o=document.selection.createRange().text.length;a.moveStart("character",-t.value.length),n=a.text.length-o}return n},wa_fronted={options:e.parseJSON(global_vars.options),data:{editable_areas:[],timers:{},current_selection:!1,current_range:!1,current_editor_options:!1,has_changes:!1,has_errors:!1,is_saving:!1},add_action:function(){var e=arguments[0].split(" ");for(k in e)arguments[0]="wa_fronted."+e[k],wp.hooks.addAction.apply(this,arguments);return this},remove_action:function(){return arguments[0]="wa_fronted."+arguments[0],wp.hooks.removeAction.apply(this,arguments),this},do_action:function(){return arguments[0]="wa_fronted."+arguments[0],wp.hooks.doAction.apply(this,arguments),this},add_filter:function(){return arguments[0]="wa_fronted."+arguments[0],wp.hooks.addFilter.apply(this,arguments),this},remove_filter:function(){return arguments[0]="wa_fronted."+arguments[0],wp.hooks.removeFilter.apply(this,arguments),this},apply_filters:function(){return arguments[0]="wa_fronted."+arguments[0],wp.hooks.applyFilters.apply(this,arguments)},initialize:function(){var t=this;if("undefined"!=typeof t.options.editable_areas&&0!==t.options.editable_areas.length){rangy.init();for(var n=function(n,o){o=e(o),o.addClass("wa-fronted-editor"),t.setup_editor(o,t.options.editable_areas[a],t.options),t.data.editable_areas.push({editor:o,options:t.options.editable_areas[a]})},a=0;a<t.options.editable_areas.length;a++){var o=e(t.options.editable_areas[a].container);0!==o.length&&e.each(o,n)}toastr.options.timeOut="7000",toastr.options.positionClass="toast-bottom-right",toastr.options.closeButton=!0;var i=e("#wa-fronted-revisions").attr("data-post-id");i&&t.check_autosave(i),t.do_action("on_init"),t.bind()}},bind:function(){var t=this;e("#wa-fronted-save").click(function(){t.save()}),e("#wa-fronted-settings").click(function(){e("#wa-fronted-revisions-modal").fadeOut("fast"),e("#wa-fronted-settings-modal").fadeIn("fast"),e("html, body").addClass("wa-modal-open")}),e("#wa-fronted-revisions").click(function(){e("#wa-fronted-settings-modal").fadeOut("fast"),e("html, body").removeClass("wa-modal-open");var n=e(this).attr("data-post-id");t.show_revision_modal(n)}),e(".close-wa-fronted-modal").click(function(){e("#wa-fronted-settings-modal, #wa-fronted-revisions-modal").fadeOut("fast"),e("html, body").removeClass("wa-modal-open")});var n=e(".wa_fronted_datepicker");n.each(function(t,n){var a=e(n),o={dateFormat:"yy-mm-dd"};"false"!==a.attr("data-time")?o.timeFormat="HH:mm:ss":o.showTimepicker=!1,a.datetimepicker(o),a.datetimepicker("setDate",a.val())}),e("#wa-fronted-settings-modal select").select2({minimumResultsForSearch:10,formatNoMatches:function(n){var a=t.i18n("No results found.");if(""!==n){var o=e(this);taxonomy=o.attr("data-tax"),is_hierarchical=o.attr("data-hierarchical"),a+=' <a class="wa-add-tax-btn" href="javascript:void(0)" onclick="wa_fronted.add_tax_term(\''+n+"', '"+taxonomy+"', "+is_hierarchical+')"><i class="dashicons dashicons-plus"></i> '+t.i18n("Add")+"</a>"}return a}}),t.do_action("on_bind"),window.onbeforeunload=function(){return t.data.has_changes&&!t.data.is_saving?t.i18n("The changes you have made will be lost if you navigate away from this page."):void 0}},setup_editor:function(n,a,o){var i=this,r={selector:a.container,theme:"fronted",toolbar:["bold","italic","strikethrough","bullist","numlist","blockquote","alignleft","aligncenter","alignright","link","unlink","h2","h3"],plugins:["wplink","wpview","paste","hr","lists"],inline:!0,relative_urls:!1,convert_urls:!1,paste_as_text:!0,browser_spellcheck:!0,directionality:a.direction,wpeditimage_html5_captions:!0,fronted_options:a,setup:function(t){window.wpActiveEditor=t.id,a.paragraphs!==!0&&(t.on("keydown",function(e){return 13===e.which?(e.preventDefault(),e.stopPropagation(),!1):!0}),t.on("blur",function(e){t.setContent(t.getContent({format:"text"}))})),t.on("paste",function(n){var a=n.clipboardData.getData("text/plain");!a||-1===a.indexOf("http://")&&-1===a.indexOf("https://")||(n.preventDefault(),i.show_loading_spinner(),e.post(global_vars.ajax_url,{action:"wa_get_oembed",link:a},function(e){t.insertContent(e.oembed!==!1?e.oembed:'<a href="'+a+'">'+a+"</a>"),i.hide_loading_spinner()}))}),t.on("change",function(e){clearTimeout(i.data.timers[t.id]),i.data.timers[t.id]=setTimeout(function(){i.data.has_changes=!0,i.validate(n,a),i.autosave(n,a),i.show_save_button()},1e3)}),t.on("click",function(e){if("A"===e.target.nodeName&&e.ctrlKey){var t=window.open(e.target.href,"_blank");t.focus()}}),i.do_action("on_tinymce_setup",t,a,o)}};if(void 0===a.toolbar&&(a.toolbar="full"),"false"===a.toolbar||a.toolbar===!1?r.toolbar=!1:"full"!==a.toolbar&&(r.toolbar=a.toolbar.replace(/\s+/g,"").split(",")),"false"!==a.toolbar&&a.toolbar!==!1&&(r.toolbar=i.apply_filters("toolbar_buttons",r.toolbar,a)),n.click(function(){var t=window.getSelection();t&&(i.data.current_selection=e.extend({},t),t.rangeCount&&(i.data.current_range=t.getRangeAt(0)))}),"only"!==a.media_upload&&a["native"]){if("meta_select"!==a.field_type)a.media_upload===!0&&r.plugins.push("fronted_image"),a.shortcodes===!0&&r.plugins.push("fronted_shortcode"),r.plugins=i.apply_filters("editor_plugins",r.plugins,a),t.init(r);else if(a.hasOwnProperty("values")&&a.values.length>1&&a.hasOwnProperty("meta_key")&&a["native"]){var s=document.createElement("select");s.id="select_"+a.meta_key,s.name="select_"+a.meta_key,s.className="wa_fronted_select";for(var u=0;u<a.values.length;u++){var d=a.values[u],l=document.createElement("option");l.value=d.value,l.innerHTML=d.label,d.hasOwnProperty("selected")&&d.selected&&(l.selected=!0,n.attr("data-db-value",d.value)),s.appendChild(l)}document.body.appendChild(s);var s=e(s);s.select2({minimumResultsForSearch:10}),s.on("change",function(e){var t=s.val();i.specific_output_to(n,a,t,t)||(n.html(t),n.attr("data-db-value",t))});var c=n.width(),p=n.position(),f=s.data("select2").container,m=s.data("select2").dropdown;f.css({left:p.left+(c/2-f.width()/2)+"px"}).addClass("wa-fronted-selectmenu");var h,g=function(){h=setTimeout(function(){f.removeClass("show"),s.select2("close")},500)};n.hover(function(){clearTimeout(h);var e=n.position();f.css({top:e.top+"px"}).addClass("show")},g),f.hover(function(){clearTimeout(h)},g),m.hover(function(){clearTimeout(h)},g)}}else"only"===a.media_upload&&a["native"]?new fronted_featured_img(n,a):i.do_action("on_setup_editor",n,a,o)},autosave:function(n,a){var o=this;clearTimeout(o.data.timers.autosave),o.data.timers.autosave=setTimeout(function(){if(!o.is_saving){for(var n=o.data.editable_areas,a=[],i=0;i<n.length;i++)if("post_thumbnail"!==n[i].options.field_type){var r=n[i].editor.attr("data-db-value"),s="";s="undefined"!=typeof r&&r!==!1?r:t.editors[n[i].editor[0].id].getContent(),a.push({content:s,options:n[i].options})}e.post(global_vars.ajax_url,{action:"wa_fronted_autosave",data:a,wa_fronted_save_nonce:global_vars.nonce},function(e){e.success&&toastr.info(o.i18n("A draft of this post has been saved automatically"),o.i18n("Draft autosaved"))})}},1e4)},save:function(){var n=this,a=n.data.editable_areas,o=[];if(n.show_loading_spinner(),n.data.has_errors){for(var i=0;i<a.length;i++)a[i].options.hasOwnProperty("has_errors")&&a[i].options.has_errors&&(a[i].editor.tipso("destroy"),a[i].editor.tipso({content:n.validation_msg(a[i].options.validation.type,a[i].options.validation.compare),useTitle:!1,background:"#bd362f"}),a[i].editor.tipso("show"));n.hide_loading_spinner(),toastr.error(n.i18n("There were validation errors!"),n.i18n("Save unsuccessful"))}else{n.data.is_saving=!0;for(var i=0;i<a.length;i++)if("post_thumbnail"!==a[i].options.field_type){var r=a[i].editor.attr("data-db-value"),s="";s="undefined"!=typeof r&&r!==!1?r:t.editors[a[i].editor[0].id].getContent(),o.push({content:s,options:a[i].options})}e.post(global_vars.ajax_url,{action:"wa_fronted_save",data:o,wa_fronted_save_nonce:global_vars.nonce},function(e){e.success?location.reload():"undefined"!=typeof e.error&&toastr.error(e.error,n.i18n("Save unsuccessful")),n.hide_loading_spinner()})}},show_save_button:function(){e("#wa-fronted-save").fadeIn("fast")},show_loading_spinner:function(){e("#wa-fronted-spinner").fadeIn("fast")},hide_loading_spinner:function(){e("#wa-fronted-spinner").fadeOut("fast")},shortcode_from_attr:function(e){return decodeURIComponent(e.attr("data-shortcode"))},shortcode_to_html:function(t,n,a){e.post(global_vars.ajax_url,{action:"wa_render_shortcode",shortcode:t,comments:n},function(e){a(e)})},getCaretPositionPx:function(){var e=0,t=0,n=window.getSelection();if(n.rangeCount){var a=n.getRangeAt(0);if(a.getClientRects){var o=a.getClientRects();o.length>0&&(e=o[0].left,t=o[0].top)}if(0==e&&0==t){var i=window.document.createElement("span");if(i.getClientRects){i.appendChild(window.document.createTextNode("​")),a.insertNode(i),rect=i.getClientRects()[0],e=rect.left,t=rect.top;var r=i.parentNode;r.removeChild(i),r.normalize()}}}return{x:e,y:t}},getSelectionText:function(){var e="";return window.getSelection?e=window.getSelection().toString():document.selection&&"Control"!=document.selection.type&&(e=document.selection.createRange().text),e},specific_output_to:function(e,t,n,a){if(!t.hasOwnProperty("output_to"))return!1;if(t.output_to.hasOwnProperty("selector")){var o=e.find(t.output_to.selector);if(0===o.length)return!1;t.output_to.hasOwnProperty("attr")?o.attr(t.output_to.attr,a):o.html(a)}else if(Array.isArray(t.output_to))for(var i=0;i<t.output_to.length;i++){var r=t.output_to[i];if(r.hasOwnProperty("selector")){var o=e.find(r.selector);if(0===o.length)return!1;r.hasOwnProperty("attr")?o.attr(r.attr,a):o.html(a)}}else{var o=e;t.output_to.hasOwnProperty("attr")?o.attr(t.output_to.attr,a):o.html(a)}return e.attr("data-db-value",n),!0},insertHtmlAtCaret:function(e,t,n){var a=this;if(t=t||!1,n=n||!1,window.getSelection){t===!1&&n===!1&&("undefined"==typeof a.data.current_selection||a.data.current_selection===!1?(t=window.getSelection(),n=t.getRangeAt(0)):(t=a.data.current_selection,n=a.data.current_range)),"undefined"!=typeof n&&n!==!1&&n.deleteContents();var o=document.createElement("div");o.innerHTML=e;for(var i,r,s=document.createDocumentFragment();i=o.firstChild;)r=s.appendChild(i);n.insertNode(s),a.current_selection=!1}else document.selection&&"Control"!=document.selection.type&&document.selection.createRange().pasteHTML(e)},replace_html:function(t,n){el=e(t),el.replaceWith(n)},validate:function(e,t){var n=this;t.validation!==!1&&(n.validator(e.text(),t.validation.type,t.validation.compare)?(e.tipso("hide"),e.tipso("destroy")):(n.data.has_errors=!0,t.has_errors=!0,e.tipso({content:n.validation_msg(t.validation.type,t.validation.compare),useTitle:!1,background:"#23282d"}),e.tipso("show")))},add_tax_term:function(t,n,a){var o=this,i={action:"wa_add_tax_term",term:t,taxonomy:n};o.show_loading_spinner(),e.post(global_vars.ajax_url,i,function(a){e('<option value="'+a.term_id+'" selected>'+t+"</option>").appendTo("#wa_fronted_tax_"+n),e("#wa_fronted_tax_"+n).trigger("change"),o.hide_loading_spinner()})},get_revisions:function(t,n){var a=this;a.show_loading_spinner(),e.post(global_vars.ajax_url,{action:"wa_get_revisions",post_id:t},function(e){a.hide_loading_spinner(),n(e)})},switch_to_revision:function(e){for(var t=this,n=t.data.editable_areas,a=0;a<n.length;a++){var o=!1,i=!1;e.hasOwnProperty(n[a].options.field_type)&&(o=e[n[a].options.field_type]);var r=t.apply_filters("revision_db_value",o,n[a],e);i=t.apply_filters("revision_content",o,n[a],e),i!==!1&&(t.specific_output_to(n[a].editor,n[a].options,r,i)||n[a].editor.html(i),t.validate(n[a].editor,n[a].options))}t.data.has_changes=!0,t.show_save_button()},show_revision_modal:function(t,n){var a=this;n=n||!1,a.get_revisions(t,function(t){if(0!==t.length){var o=t.length-1;revision_input=e("#wa_fronted_switch_revision"),-1!==t[o].post_name.indexOf("-autosave-v1")&&(o-=1),n&&(o=t.length-1,a.switch_to_revision(t[o])),revision_input.val(t[o].post_date),o===t.length-1?(e("#wa-previous-revision").removeClass("disabled"),e("#wa-next-revision").addClass("disabled")):0===o?(e("#wa-next-revision").removeClass("disabled"),e("#wa-previous-revision").addClass("disabled")):(e("#wa-next-revision").removeClass("disabled"),e("#wa-previous-revision").removeClass("disabled")),e("#wa-previous-revision, #wa-next-revision").off(),e("#wa-previous-revision").on("click",function(n){n.preventDefault(),o-1>=0&&(e("#wa-next-revision").removeClass("disabled"),o-=1,revision_input.val(t[o].post_date),a.switch_to_revision(t[o]),0===o&&e(this).addClass("disabled"))}),e("#wa-next-revision").on("click",function(n){n.preventDefault(),o+1<=t.length-1&&(e("#wa-previous-revision").removeClass("disabled"),o+=1,revision_input.val(t[o].post_date),a.switch_to_revision(t[o]),o===t.length-1&&e(this).addClass("disabled"))}),e("#wa-fronted-revisions-modal").fadeIn("fast")}})},check_autosave:function(t){var n=this;e.post(global_vars.ajax_url,{action:"wa_fronted_get_autosave",post_id:t},function(e){e.success&&e.data!==!1&&confirm(n.i18n("There is an autosave of this post that is more recent than the version below. View the autosave?"))&&n.show_revision_modal(t,!0)})},i18n:function(){var e=Array.prototype.slice.call(arguments),t=e.shift();if(global_vars.i18n.hasOwnProperty(t)&&(t=global_vars.i18n[t]),-1!==t.indexOf("%s")&&Array.isArray(e)&&0!==e.length)for(var n=0;n<e.length;n++)t=t.replace("%s",e[n]);return t}},e(document).ready(function(){"undefined"!=typeof global_vars.options&&Modernizr.contenteditable&&(window.wp=window.wp||{},"undefined"==typeof window.wp.hooks&&(window.wp.hooks=new EventManager),wa_fronted.initialize())})}(jQuery);
