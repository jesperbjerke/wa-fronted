...
function Wa_image_upload(e){this.editor_options=e,this.button=document.createElement("button"),this.button.className="medium-wa-image-upload-action",this.button.icon=document.createElement("i"),this.button.icon.className="fa fa-picture-o",this.button.appendChild(this.button.icon),this.button.onclick=this.onClick.bind(this),this.get_image_src_timeout=!1,document.body.appendChild(this.button)}Wa_image_upload.prototype.setup_wp_media=function(e,t,n){t=t||!1,n=n||!1;var a=this;if(this.frame){if(this.frame.options.state===e)return;this.frame.dispose()}if("insert"===e)this.frame=wp.media({frame:"post",editing:!0,multiple:!1});else if("gallery-edit"===e&&t!==!1){var i=this.select(t);i!==!1?this.frame=wp.media({frame:"post",state:"gallery-edit",title:wp.media.view.l10n.editGalleryTitle,editing:!0,multiple:!0,selection:i}):this.frame=wp.media({frame:"post",state:"gallery-edit",title:wp.media.view.l10n.editGalleryTitle,editing:!0,multiple:!0})}else"featured-image"===e&&(this.frame=wp.media({frame:"post",state:"featured-image",states:[new wp.media.controller.FeaturedImage,new wp.media.controller.EditImage]}));this.frame.on("insert",function(){var e=a.frame.state().get("selection");0===e.length?a.insertGallery(a.frame):"undefined"!=typeof a.replace_this&&a.replace_this!==!1?a.insertImage(a.frame,a.replace_this):a.insertImage(a.frame)}),this.frame.on("update",function(){a.insertGallery(a.frame,n)}),this.frame.state("featured-image").on("select",function(){a.frame.state().get("selection").single();"undefined"!=typeof a.replace_this&&a.replace_this!==!1?a.insertImage(a.frame,a.replace_this):a.insertImage(a.frame)})},Wa_image_upload.prototype.init=function(){this.setup_wp_media("insert"),this.instance=this.base,this.bindings(this.instance,jQuery(this.instance.elements))},Wa_image_upload.prototype.aspect_ratio=function(e,t){return e/t},Wa_image_upload.prototype.round=function(e,t){return Number(Math.round(e+"e"+t)+"e-"+t)},Wa_image_upload.prototype.get_closest_image_size=function(e,t,n,a){clearTimeout(this.get_image_src_timeout);var i=this,t=Math.round(t),n=Math.round(n),o=!1,r={diff:null,size_name:null,height:null,width:null,crop:null},s=this.round(this.aspect_ratio(n,t),2);o=t===n?"square":"original";for(size in global_vars.image_sizes){var l=global_vars.image_sizes[size],c=parseInt(l.height),d=parseInt(l.width),u=i.round(i.aspect_ratio(d,c),2),f=!1;if(f=c===d&&l.crop===!0?"square":"original",Math.abs(s-u)<3&&o===f){var p=Math.abs(t-c);(null===r.diff||p<r.diff)&&(r.diff=p,r.size_name=size,r.height=c,r.width=d,r.crop=l.crop)}}clearTimeout(this.get_image_src_timeout),this.get_image_src_timeout=setTimeout(function(){null!==r.size_name&&jQuery.post(global_vars.ajax_url,{action:"wa_get_image_src",attachment_id:e,size:r.size_name},function(e){a(e)})},1e3)},Wa_image_upload.prototype.bindings=function(e,t){var n=this;jQuery("body").click(function(e){jQuery(n.button).removeClass("show")}),t.on("resizecreate",function(e,t){var n=e.target.firstChild.className,a=n.match(/([align]\S+)/)[1];jQuery(e.target).css({overflow:"visible",margin:""}).addClass(a)}),n.enable_resizing(e,t),t.click(function(a){if(0!==jQuery(a.target).parents(".wa-shortcode-wrap").length){a.preventDefault();var i=jQuery(a.target).parents(".wa-shortcode-wrap");"gallery"===i.attr("data-shortcode-base")&&(n.setup_wp_media("gallery-edit",wa_fronted.shortcode_from_attr(i),i),n.frame.open())}else if(""===wa_fronted.getSelectionText()&&"IMG"!==a.target.tagName){a.preventDefault(),n.setup_wp_media("insert"),clearTimeout(o);var o=setTimeout(function(){n.showToolbar(a,t)},e.options.delay)}else if("IMG"===a.target.tagName){a.preventDefault();var r=jQuery(a.target),s=r.parents("a"),l=r;0!==s.length&&(l=s),n.replace_this=l;var c=a.target.className.match(/wp-image-\d+/);null!==c?(n.setup_wp_media("insert"),n.WPMedia(parseInt(c[0].match(/\d+/)[0]))):(n.setup_wp_media("featured-image"),wa_fronted.show_loading_spinner(),jQuery.post(global_vars.ajax_url,{action:"wa_get_thumbnail_id",post_id:n.editor_options.post_id},function(e){""!==e.attachment_id&&e.attachment_id!==!1&&(wp.media.view.settings.post.featuredImageId=parseInt(e.attachment_id),n.WPMedia(parseInt(e.attachment_id))),wa_fronted.hide_loading_spinner()}))}}),e.subscribe("editableDrag",function(e,t){console.log(t)}),e.subscribe("editableDrop",function(e,t){console.log(t)})},Wa_image_upload.prototype.enable_resizing=function(e,t){var n=this;t.find('img[class*="wp-image-"]').resizable({autoHide:!0,aspectRatio:!0,ghost:!0,handles:"nw, ne, sw, se",resize:function(t,a){var i=a.element.context.className.match(/wp-image-\d+/);if(null!==i){var o=i[0].match(/\d+/)[0];n.get_closest_image_size(o,a.size.height,a.size.width,function(e){if(e[3]===!0){var t=a.element.context.className.match(/size-\S+/),n=jQuery(a.element.context);null!==t&&n.removeClass(t[0]).addClass("size-"+e[4]),n.attr("src",e[0])}})}wa_fronted.trigger(e,"editableInput")}})},Wa_image_upload.prototype.select=function(e){var t,n,a=wp.shortcode.next("gallery",e),i=wp.media.gallery.defaults.id;return a?(a=a.shortcode,_.isUndefined(a.get("id"))&&!_.isUndefined(i)&&a.set("id",i),t=wp.media.gallery.attachments(a),n=new wp.media.model.Selection(t.models,{props:t.props.toJSON(),multiple:!0}),n.gallery=t.gallery,n.more().done(function(){n.props.set({query:!1}),n.unmirror(),n.props.unset("orderby")}),n):!1},Wa_image_upload.prototype.showToolbar=function(e,t){var n=this;n.positionImageToolbar(e),jQuery(n.button).addClass("show"),jQuery(window).scroll(function(){n.positionImageToolbar(e)})},Wa_image_upload.prototype.onClick=function(){this.WPMedia()},Wa_image_upload.prototype.insertGallery=function(e,t){t=t||!1;var n=e.states.get("gallery-edit");if(library=n.get("library"),self=this,0!==library.length){var a=wp.media.gallery.shortcode(library).string();wa_fronted.shortcode_to_html(a,t===!1?!0:!1,function(e){t!==!1?wa_fronted.replace_html(t,e):wa_fronted.insertHtmlAtCaret(e),wa_fronted.trigger(self.instance,"editableInput")})}},Wa_image_upload.prototype.insertImage=function(e,t){var n=this,a=e.state(),i=a.get("selection"),t=t||!1;i&&i.each(function(e){var i,o,r=a.display(e).toJSON(),s=e.toJSON(),l=s.caption;wp.media.view.settings.captions||delete s.caption,r=wp.media.string.props(r,s),i={id:s.id,post_content:s.description,post_excerpt:l},"featured-image"!==a.id?(r.linkUrl&&(i.url=r.linkUrl),"image"===s.type?(r.url=r.src,o=wp.media.string.image(r),_.each({align:"align",size:"image-size",alt:"image_alt"},function(e,t){r[t]&&(i[e]=r[t])})):"video"===s.type?o=wp.media.string.video(r,s):"audio"===s.type?o=wp.media.string.audio(r,s):(o=wp.media.string.link(r),i.post_title=r.title),e.attributes.nonce=wp.media.view.settings.nonce.sendToEditor,e.attributes.attachment=i,e.attributes.html=o,e.attributes.post_id=wp.media.view.settings.post.id,t!==!1?wp.media.view.settings.captions&&l?wa_fronted.shortcode_to_html(e.attributes.html,!0,function(e){wa_fronted.replace_html(t,e),n.replace_this=!1}):(wa_fronted.replace_html(t,e.attributes.html),n.replace_this=!1):wa_fronted.insertHtmlAtCaret(e.attributes.html),wa_fronted.trigger(n.instance,"editableInput"),n.enable_resizing(n.instance,jQuery(n.instance.elements))):(wa_fronted.show_loading_spinner(),jQuery.post(global_vars.ajax_url,{action:"wa_set_thumbnail",attachment_id:i.id,image_size:n.editor_options.image_size,post_id:n.editor_options.post_id},function(e){e.hasOwnProperty("html")&&t!==!1&&(wa_fronted.replace_html(t,e.html),n.replace_this=!1),wa_fronted.hide_loading_spinner()}))})},Wa_image_upload.prototype.WPMedia=function(e){e=e||!1;var t=this.frame;t.once("open",function(){var n=t.state().get("selection");e!==!1?(attachment=wp.media.attachment(e),attachment.fetch(),n.add(attachment)):n.reset()}),t.open()},Wa_image_upload.prototype.getButton=function(){return this.button},Wa_image_upload.prototype.positionImageToolbar=function(e){this.button.style.left="0";var t=this.base.options.contentWindow.innerWidth,n=this.button.offsetWidth,a=n/2,i=50,o=a,r=wa_fronted.getCaretPositionPx();r.y<i?(this.button.classList.add("medium-toolbar-arrow-over"),this.button.classList.remove("medium-toolbar-arrow-under"),this.button.style.top=r.y+(i-5)+"px"):(this.button.classList.add("medium-toolbar-arrow-under"),this.button.classList.remove("medium-toolbar-arrow-over"),this.button.style.top=r.y-(i-5)+"px"),r.x<a?this.button.style.left=o+a+"px":t-r.x<a?this.button.style.left=t+o-a+"px":this.button.style.left=r.x-a+"px"};
function escape_regexp(e){return e.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")}var wa_fronted={options:jQuery.parseJSON(global_vars.options),data:{editable_areas:[],timers:{},current_selection:!1,current_range:!1,current_editor_options:!1,has_changes:!1,acf_temp:{field_key:!1,post_id:!1}},initialize:function(){var e=this;if(void 0!==typeof e.options.editable_areas&&0!==e.options.editable_areas.length){for(var t=0;t<e.options.editable_areas.length;t++){var n=jQuery(e.options.editable_areas[t].container);0!==n.length&&jQuery.each(n,function(n,a){a=jQuery(a),a.addClass("wa-fronted-editor"),e.setup_editor(a,e.options.editable_areas[t],e.options),e.data.editable_areas.push({editor:a,options:e.options.editable_areas[t]})})}e.bind()}},bind:function(){var e=this;jQuery("#acf-dialog #close-acf-dialog").click(function(t){t.preventDefault(),t.stopPropagation(),e.hide_acf_form()}),jQuery("#wa-fronted-save").click(function(){e.save()}),"undefined"!=typeof acf&&acf.add_action("submit",function(t){e.refresh_acf_field(e.data.acf_temp.field_key,e.data.acf_temp.post_id,e.data.current_editor_options,e.data.current_editor)}),jQuery("#wa-fronted-settings").click(function(){jQuery("#wa-fronted-settings-modal").fadeIn("fast")}),jQuery(".close-wa-fronted-modal").click(function(){jQuery("#wa-fronted-settings-modal").fadeOut("fast")});var t=jQuery(".wa_fronted_datepicker");t.datetimepicker({dateFormat:"yy-mm-dd",timeFormat:"HH:mm:ss"}),t.datetimepicker("setDate",t.val()),jQuery("#wa-fronted-settings-modal select").selectmenu(),window.onbeforeunload=function(){return e.data.has_changes?"The changes you have made will be lost if you navigate away from this page.":void 0}},setup_editor:function(e,t,n){var a=this,i={buttons:["bold","italic","underline","anchor","header1","header2","quote","unorderedlist","orderedlist","justifyLeft","justifyCenter","justifyRight"],buttonLabels:"fontawesome",imageDragging:!1,autoLink:!0,anchorPreview:!1,anchor:{linkValidation:!0}};void 0===t.toolbar&&(t.toolbar="full"),"false"===t.toolbar||t.toolbar===!1?i.disableToolbar=!0:"full"!==t.toolbar&&(i.buttons=t.toolbar.replace(/\s+/g,"").split(",")),e.click(function(){var e=window.getSelection();e&&(a.data.current_selection=jQuery.extend({},e),e.rangeCount&&(a.data.current_range=e.getRangeAt(0)))});var o=!1;"only"!==t.media_upload?(t.media_upload===!0&&(i.extensions={image_upload:new Wa_image_upload(t)}),o=new MediumEditor(e,i),o.subscribe("editablePaste",function(t,n){t.preventDefault();var i=t.clipboardData.getData("text/plain");!i||-1===i.indexOf("http://")&&-1===i.indexOf("https://")||(a.show_loading_spinner(),jQuery.post(global_vars.ajax_url,{action:"wa_get_oembed",link:i},function(t){if(t.oembed!==!1){var n=e.html(),o=escape_regexp(i),r=new RegExp(o,"m"),s=n.replace(r,t.oembed);console.log(r,s),e.html(s)}a.hide_loading_spinner()}))})):a.get_acf_field_object(t.field_type,function(n){if(n.hasOwnProperty("error"))n.hasOwnProperty("error")&&(i.toolbar=!1,i.spellcheck=!1,i.extensions={image_upload:new Wa_image_upload(t)},o=new MediumEditor(e,i));else{switch(n.type){case"file":case"image":null!==n.value&&e.attr("data-db-value",n.value.ID)}var r=e.children(),s=jQuery(r[0]),l=s.width(),c=s.position();e.prepend('<button title="Edit '+n.type+'" class="edit-acf-field" style="left: '+(c.left+(l/2-13))+'px;"><i class="fa fa-edit"></i></button>'),e.hover(function(){var t=s.position();e.find(".edit-acf-field").css({top:t.top+"px"}).addClass("show")},function(){e.find(".edit-acf-field").removeClass("show")}),e.find(".edit-acf-field").click(function(i){i.preventDefault(),i.stopPropagation(),a.show_acf_form(n.key,t.post_id,t,e)})}}),o!==!1&&o.subscribe("editableInput",function(n,i){clearTimeout(a.data.timers[o.id]),a.data.timers[o.id]=setTimeout(function(){a.data.has_changes=!0,a.auto_save(e,t),a.show_save_button()},1e3)})},trigger:function(e,t){e.events.customEvents[t][0]()},auto_save:function(e,t){console.log("auto save",e,t)},save:function(){var e=this,t=e.data.editable_areas,n=[];e.show_loading_spinner();for(var a=0;a<t.length;a++){var i=t[a].editor.attr("data-db-value"),o="";o="undefined"!=typeof i&&i!==!1?i:t[a].editor.html(),n.push({content:o,options:t[a].options})}jQuery.post(global_vars.ajax_url,{action:"wa_fronted_save",data:n,wa_fronted_save_nonce:e.options.nonce},function(t){t.success&&location.reload(),e.hide_loading_spinner()})},show_save_button:function(){jQuery("#wa-fronted-save").fadeIn("fast")},show_loading_spinner:function(){jQuery("#wa-fronted-spinner").fadeIn("fast")},hide_loading_spinner:function(){jQuery("#wa-fronted-spinner").fadeOut("fast")},shortcode_from_attr:function(e){return decodeURIComponent(e.attr("data-shortcode"))},shortcode_to_html:function(e,t,n){jQuery.post(global_vars.ajax_url,{action:"wa_render_shortcode",shortcode:e,comments:t},function(e){n(e)})},get_acf_field_object:function(e,t){jQuery.post(global_vars.ajax_url,{action:"wa_get_acf_field_object",field_key:e},function(e){t(e)})},get_acf_field_contents:function(e,t,n){jQuery.post(global_vars.ajax_url,{action:"wa_get_acf_field_contents",field_key:e,post_id:t},function(e){n(e)})},get_acf_form:function(e,t,n){jQuery.post(global_vars.ajax_url,{action:"wa_get_acf_form",field_key:e,post_id:t,redirect:window.location.pathname},function(e){n(e)})},show_acf_form:function(e,t,n,a){var i=this;i.data.acf_temp.field_key=e,i.data.acf_temp.post_id=t,i.data.current_editor_options=n,i.data.current_editor=a,i.get_acf_form(e,t,function(e){jQuery("#acf-dialog #acf-dialog-inner").html(e.output),jQuery("#acf-dialog #acf-dialog-inner form").submit(function(e){e.preventDefault()}),jQuery("#acf-dialog").fadeIn().addClass("active")})},hide_acf_form:function(){jQuery("#acf-dialog").fadeOut().removeClass("active")},refresh_acf_field:function(e,t,n,a){var i=this;i.get_acf_field_contents(e,t,function(e){var t="";if(n.hasOwnProperty("output")){var o=n.output.split(".");t=e.value;for(var r=0;r<o.length;r++)t=t[o[r]]}else t=e.value;i.specific_output_to(a,n,e.value.ID,t)||a.html(t),i.hide_acf_form()})},getCaretPositionPx:function(){var e=0,t=0,n=window.getSelection();if(n.rangeCount){var a=n.getRangeAt(0),i="p"==a.startContainer.nodeName.toLowerCase()&&0==a.startOffset;if(i)e=a.startContainer.offsetLeft,t=a.startContainer.offsetTop;else if(a.getClientRects){var o=a.getClientRects();o.length>0&&(e=o[0].left,t=o[0].top)}}return{x:e,y:t}},getSelectionText:function(){var e="";return window.getSelection?e=window.getSelection().toString():document.selection&&"Control"!=document.selection.type&&(e=document.selection.createRange().text),e},specific_output_to:function(e,t,n,a){if(!t.hasOwnProperty("output_to")||!t.output_to.hasOwnProperty("selector"))return!1;var i=jQuery(t.output_to.selector);return 0===i.length?!1:(t.output_to.hasOwnProperty("attr")?i.attr(t.output_to.attr,a):i.html(a),e.attr("data-db-value",n),!0)},insertHtmlAtCaret:function(e){var t,n,a=this;if(window.getSelection){void 0===typeof a.data.current_selection||"undefined"==typeof a.data.current_selection||a.data.current_selection===!1?(t=window.getSelection(),n=t.getRangeAt(0)):(t=a.data.current_selection,n=a.data.current_range),"undefined"!=typeof n&&n!==!1&&n.deleteContents();var i=document.createElement("div");i.innerHTML=e;for(var o,r,s=document.createDocumentFragment();o=i.firstChild;)r=s.appendChild(o);n.insertNode(s),a.current_selection=!1}else document.selection&&"Control"!=document.selection.type&&document.selection.createRange().pasteHTML(e)},replace_html:function(e,t){el=jQuery(e),el.replaceWith(t)}};jQuery(document).ready(function(){"undefined"!=typeof global_vars.options&&Modernizr.contenteditable&&wa_fronted.initialize()});
