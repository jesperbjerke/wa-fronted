window.Modernizr=function(e,t,n){function a(e){v.cssText=e}function i(e,t){return a(w.join(e+";")+(t||""))}function o(e,t){return typeof e===t}function r(e,t){return!!~(""+e).indexOf(t)}function s(e,t){for(var a in e){var i=e[a];if(!r(i,"-")&&v[i]!==n)return"pfx"==t?i:!0}return!1}function l(e,t,a){for(var i in e){var r=t[e[i]];if(r!==n)return a===!1?e[i]:o(r,"function")?r.bind(a||t):r}return!1}function c(e,t,n){var a=e.charAt(0).toUpperCase()+e.slice(1),i=(e+" "+x.join(a+" ")+a).split(" ");return o(t,"string")||o(t,"undefined")?s(i,t):(i=(e+" "+C.join(a+" ")+a).split(" "),l(i,t,n))}var u,d,p,f="2.8.3",m={},h=!0,g=t.documentElement,_="modernizr",y=t.createElement(_),v=y.style,w=({}.toString," -webkit- -moz- -o- -ms- ".split(" ")),b="Webkit Moz O ms",x=b.split(" "),C=b.toLowerCase().split(" "),E={},j=[],k=j.slice,S=function(e,n,a,i){var o,r,s,l,c=t.createElement("div"),u=t.body,d=u||t.createElement("body");if(parseInt(a,10))for(;a--;)s=t.createElement("div"),s.id=i?i[a]:_+(a+1),c.appendChild(s);return o=["&#173;",'<style id="s',_,'">',e,"</style>"].join(""),c.id=_,(u?c:d).innerHTML+=o,d.appendChild(c),u||(d.style.background="",d.style.overflow="hidden",l=g.style.overflow,g.style.overflow="hidden",g.appendChild(d)),r=n(c,e),u?c.parentNode.removeChild(c):(d.parentNode.removeChild(d),g.style.overflow=l),!!r},z={}.hasOwnProperty;p=o(z,"undefined")||o(z.call,"undefined")?function(e,t){return t in e&&o(e.constructor.prototype[t],"undefined")}:function(e,t){return z.call(e,t)},Function.prototype.bind||(Function.prototype.bind=function(e){var t=this;if("function"!=typeof t)throw new TypeError;var n=k.call(arguments,1),a=function(){if(this instanceof a){var i=function(){};i.prototype=t.prototype;var o=new i,r=t.apply(o,n.concat(k.call(arguments)));return Object(r)===r?r:o}return t.apply(e,n.concat(k.call(arguments)))};return a}),E.opacity=function(){return i("opacity:.55"),/^0.55$/.test(v.opacity)},E.cssanimations=function(){return c("animationName")},E.csstransforms=function(){return!!c("transform")},E.csstransforms3d=function(){var e=!!c("perspective");return e&&"webkitPerspective"in g.style&&S("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}",function(t,n){e=9===t.offsetLeft&&3===t.offsetHeight}),e},E.csstransitions=function(){return c("transition")};for(var T in E)p(E,T)&&(d=T.toLowerCase(),m[d]=E[T](),j.push((m[d]?"":"no-")+d));return m.addTest=function(e,t){if("object"==typeof e)for(var a in e)p(e,a)&&m.addTest(a,e[a]);else{if(e=e.toLowerCase(),m[e]!==n)return m;t="function"==typeof t?t():t,"undefined"!=typeof h&&h&&(g.className+=" "+(t?"":"no-")+e),m[e]=t}return m},a(""),y=u=null,function(e,t){function n(e,t){var n=e.createElement("p"),a=e.getElementsByTagName("head")[0]||e.documentElement;return n.innerHTML="x<style>"+t+"</style>",a.insertBefore(n.lastChild,a.firstChild)}function a(){var e=y.elements;return"string"==typeof e?e.split(" "):e}function i(e){var t=_[e[h]];return t||(t={},g++,e[h]=g,_[g]=t),t}function o(e,n,a){if(n||(n=t),u)return n.createElement(e);a||(a=i(n));var o;return o=a.cache[e]?a.cache[e].cloneNode():m.test(e)?(a.cache[e]=a.createElem(e)).cloneNode():a.createElem(e),!o.canHaveChildren||f.test(e)||o.tagUrn?o:a.frag.appendChild(o)}function r(e,n){if(e||(e=t),u)return e.createDocumentFragment();n=n||i(e);for(var o=n.frag.cloneNode(),r=0,s=a(),l=s.length;l>r;r++)o.createElement(s[r]);return o}function s(e,t){t.cache||(t.cache={},t.createElem=e.createElement,t.createFrag=e.createDocumentFragment,t.frag=t.createFrag()),e.createElement=function(n){return y.shivMethods?o(n,e,t):t.createElem(n)},e.createDocumentFragment=Function("h,f","return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&("+a().join().replace(/[\w\-]+/g,function(e){return t.createElem(e),t.frag.createElement(e),'c("'+e+'")'})+");return n}")(y,t.frag)}function l(e){e||(e=t);var a=i(e);return y.shivCSS&&!c&&!a.hasCSS&&(a.hasCSS=!!n(e,"article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")),u||s(e,a),e}var c,u,d="3.7.0",p=e.html5||{},f=/^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i,m=/^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i,h="_html5shiv",g=0,_={};!function(){try{var e=t.createElement("a");e.innerHTML="<xyz></xyz>",c="hidden"in e,u=1==e.childNodes.length||function(){t.createElement("a");var e=t.createDocumentFragment();return"undefined"==typeof e.cloneNode||"undefined"==typeof e.createDocumentFragment||"undefined"==typeof e.createElement}()}catch(n){c=!0,u=!0}}();var y={elements:p.elements||"abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output progress section summary template time video",version:d,shivCSS:p.shivCSS!==!1,supportsUnknownElements:u,shivMethods:p.shivMethods!==!1,type:"default",shivDocument:l,createElement:o,createDocumentFragment:r};e.html5=y,l(t)}(this,t),m._version=f,m._prefixes=w,m._domPrefixes=C,m._cssomPrefixes=x,m.testProp=function(e){return s([e])},m.testAllProps=c,m.testStyles=S,g.className=g.className.replace(/(^|\s)no-js(\s|$)/,"$1$2")+(h?" js "+j.join(" "):""),m}(this,this.document),function(e,t,n){function a(e){return"[object Function]"==g.call(e)}function i(e){return"string"==typeof e}function o(){}function r(e){return!e||"loaded"==e||"complete"==e||"uninitialized"==e}function s(){var e=_.shift();y=1,e?e.t?m(function(){("c"==e.t?p.injectCss:p.injectJs)(e.s,0,e.a,e.x,e.e,1)},0):(e(),s()):y=0}function l(e,n,a,i,o,l,c){function u(t){if(!f&&r(d.readyState)&&(v.r=f=1,!y&&s(),d.onload=d.onreadystatechange=null,t)){"img"!=e&&m(function(){b.removeChild(d)},50);for(var a in k[n])k[n].hasOwnProperty(a)&&k[n][a].onload()}}var c=c||p.errorTimeout,d=t.createElement(e),f=0,g=0,v={t:a,s:n,e:o,a:l,x:c};1===k[n]&&(g=1,k[n]=[]),"object"==e?d.data=n:(d.src=n,d.type=e),d.width=d.height="0",d.onerror=d.onload=d.onreadystatechange=function(){u.call(this,g)},_.splice(i,0,v),"img"!=e&&(g||2===k[n]?(b.insertBefore(d,w?null:h),m(u,c)):k[n].push(d))}function c(e,t,n,a,o){return y=0,t=t||"j",i(e)?l("c"==t?C:x,e,t,this.i++,n,a,o):(_.splice(this.i++,0,e),1==_.length&&s()),this}function u(){var e=p;return e.loader={load:c,i:0},e}var d,p,f=t.documentElement,m=e.setTimeout,h=t.getElementsByTagName("script")[0],g={}.toString,_=[],y=0,v="MozAppearance"in f.style,w=v&&!!t.createRange().compareNode,b=w?f:h.parentNode,f=e.opera&&"[object Opera]"==g.call(e.opera),f=!!t.attachEvent&&!f,x=v?"object":f?"script":"img",C=f?"script":x,E=Array.isArray||function(e){return"[object Array]"==g.call(e)},j=[],k={},S={timeout:function(e,t){return t.length&&(e.timeout=t[0]),e}};p=function(e){function t(e){var t,n,a,e=e.split("!"),i=j.length,o=e.pop(),r=e.length,o={url:o,origUrl:o,prefixes:e};for(n=0;r>n;n++)a=e[n].split("="),(t=S[a.shift()])&&(o=t(o,a));for(n=0;i>n;n++)o=j[n](o);return o}function r(e,i,o,r,s){var l=t(e),c=l.autoCallback;l.url.split(".").pop().split("?").shift(),l.bypass||(i&&(i=a(i)?i:i[e]||i[r]||i[e.split("/").pop().split("?")[0]]),l.instead?l.instead(e,i,o,r,s):(k[l.url]?l.noexec=!0:k[l.url]=1,o.load(l.url,l.forceCSS||!l.forceJS&&"css"==l.url.split(".").pop().split("?").shift()?"c":n,l.noexec,l.attrs,l.timeout),(a(i)||a(c))&&o.load(function(){u(),i&&i(l.origUrl,s,r),c&&c(l.origUrl,s,r),k[l.url]=2})))}function s(e,t){function n(e,n){if(e){if(i(e))n||(d=function(){var e=[].slice.call(arguments);p.apply(this,e),f()}),r(e,d,t,0,c);else if(Object(e)===e)for(l in s=function(){var t,n=0;for(t in e)e.hasOwnProperty(t)&&n++;return n}(),e)e.hasOwnProperty(l)&&(!n&&!--s&&(a(d)?d=function(){var e=[].slice.call(arguments);p.apply(this,e),f()}:d[l]=function(e){return function(){var t=[].slice.call(arguments);e&&e.apply(this,t),f()}}(p[l])),r(e[l],d,t,l,c))}else!n&&f()}var s,l,c=!!e.test,u=e.load||e.both,d=e.callback||o,p=d,f=e.complete||o;n(c?e.yep:e.nope,!!u),u&&n(u)}var l,c,d=this.yepnope.loader;if(i(e))r(e,0,d,0);else if(E(e))for(l=0;l<e.length;l++)c=e[l],i(c)?r(c,0,d,0):E(c)?p(c):Object(c)===c&&s(c,d);else Object(e)===e&&s(e,d)},p.addPrefix=function(e,t){S[e]=t},p.addFilter=function(e){j.push(e)},p.errorTimeout=1e4,null==t.readyState&&t.addEventListener&&(t.readyState="loading",t.addEventListener("DOMContentLoaded",d=function(){t.removeEventListener("DOMContentLoaded",d,0),t.readyState="complete"},0)),e.yepnope=u(),e.yepnope.executeStack=s,e.yepnope.injectJs=function(e,n,a,i,l,c){var u,d,f=t.createElement("script"),i=i||p.errorTimeout;f.src=e;for(d in a)f.setAttribute(d,a[d]);n=c?s:n||o,f.onreadystatechange=f.onload=function(){!u&&r(f.readyState)&&(u=1,n(),f.onload=f.onreadystatechange=null)},m(function(){u||(u=1,n(1))},i),l?f.onload():h.parentNode.insertBefore(f,h)},e.yepnope.injectCss=function(e,n,a,i,r,l){var c,i=t.createElement("link"),n=l?s:n||o;i.href=e,i.rel="stylesheet",i.type="text/css";for(c in a)i.setAttribute(c,a[c]);r||(h.parentNode.insertBefore(i,h),m(n,0))}}(this,document),Modernizr.load=function(){yepnope.apply(window,[].slice.call(arguments,0))},Modernizr.addTest("contenteditable","contentEditable"in document.documentElement);
...
var EventManager=function(){function e(e,t,n,i){return"string"==typeof e&&"function"==typeof t&&(n=parseInt(n||10,10),s("actions",e,t,n,i)),u}function t(){var e=Array.prototype.slice.call(arguments),t=e.shift();return"string"==typeof t&&c("actions",t,e),u}function n(e,t){return"string"==typeof e&&r("actions",e,t),u}function i(e,t,n,i){return"string"==typeof e&&"function"==typeof t&&(n=parseInt(n||10,10),s("filters",e,t,n,i)),u}function a(){var e=Array.prototype.slice.call(arguments),t=e.shift();return"string"==typeof t?c("filters",t,e):u}function o(e,t){return"string"==typeof e&&r("filters",e,t),u}function r(e,t,n,i){if(d[e][t])if(n){var a,o=d[e][t];if(i)for(a=o.length;a--;){var r=o[a];r.callback===n&&r.context===i&&o.splice(a,1)}else for(a=o.length;a--;)o[a].callback===n&&o.splice(a,1)}else d[e][t]=[]}function s(e,t,n,i,a){var o={callback:n,priority:i,context:a},r=d[e][t];r?(r.push(o),r=l(r)):r=[o],d[e][t]=r}function l(e){for(var t,n,i,a=1,o=e.length;o>a;a++){for(t=e[a],n=a;(i=e[n-1])&&i.priority>t.priority;)e[n]=e[n-1],--n;e[n]=t}return e}function c(e,t,n){var i=d[e][t];if(!i)return"filters"===e?n[0]:!1;var a=0,o=i.length;if("filters"===e)for(;o>a;a++)n[0]=i[a].callback.apply(i[a].context,n);else for(;o>a;a++)i[a].callback.apply(i[a].context,n);return"filters"===e?n[0]:!0}var u={removeFilter:o,applyFilters:a,addFilter:i,removeAction:n,doAction:t,addAction:e},d={actions:{},filters:{}};return u};
function Wa_image_upload(e){this.editor_options=e,this.button=document.createElement("button"),this.button.className="medium-wa-image-upload-action",this.button.icon=document.createElement("i"),this.button.icon.className="fa fa-picture-o",this.button.appendChild(this.button.icon),this.button.onclick=this.onClick.bind(this),this.get_image_src_timeout=!1,document.body.appendChild(this.button)}Wa_image_upload.prototype.setup_wp_media=function(e,t,n){t=t||!1,n=n||!1;var i=this;if(this.frame){if(this.frame.options.state===e)return;this.frame.dispose()}if("insert"===e)this.frame=wp.media({frame:"post",editing:!0,multiple:!1});else if("gallery-edit"===e&&t!==!1){var a=this.select(t);a!==!1?this.frame=wp.media({frame:"post",state:"gallery-edit",title:wp.media.view.l10n.editGalleryTitle,editing:!0,multiple:!0,selection:a}):this.frame=wp.media({frame:"post",state:"gallery-edit",title:wp.media.view.l10n.editGalleryTitle,editing:!0,multiple:!0})}else"featured-image"===e&&(this.frame=wp.media({frame:"post",state:"featured-image",states:[new wp.media.controller.FeaturedImage,new wp.media.controller.EditImage]}));this.frame.on("insert",function(){var e=i.frame.state().get("selection");0===e.length?i.insertGallery(i.frame):"undefined"!=typeof i.replace_this&&i.replace_this!==!1?i.insertImage(i.frame,i.replace_this):i.insertImage(i.frame)}),this.frame.on("update",function(){i.insertGallery(i.frame,n)}),this.frame.state("featured-image").on("select",function(){i.frame.state().get("selection").single();"undefined"!=typeof i.replace_this&&i.replace_this!==!1?i.insertImage(i.frame,i.replace_this):i.insertImage(i.frame)})},Wa_image_upload.prototype.init=function(){this.setup_wp_media("insert"),this.instance=this.base,this.bindings(this.instance,jQuery(this.instance.elements))},Wa_image_upload.prototype.aspect_ratio=function(e,t){return e/t},Wa_image_upload.prototype.round=function(e,t){return Number(Math.round(e+"e"+t)+"e-"+t)},Wa_image_upload.prototype.get_closest_image_size=function(e,t,n,i){clearTimeout(this.get_image_src_timeout);var a=this,t=Math.round(t),n=Math.round(n),o=!1,r={diff:null,size_name:null,height:null,width:null,crop:null},s=this.round(this.aspect_ratio(n,t),2);o=t===n?"square":"original";for(size in global_vars.image_sizes){var l=global_vars.image_sizes[size],c=parseInt(l.height),u=parseInt(l.width),d=a.round(a.aspect_ratio(u,c),2),p=!1;if(p=c===u&&l.crop===!0?"square":"original",Math.abs(s-d)<3&&o===p){var f=Math.abs(t-c);(null===r.diff||f<r.diff)&&(r.diff=f,r.size_name=size,r.height=c,r.width=u,r.crop=l.crop)}}clearTimeout(this.get_image_src_timeout),this.get_image_src_timeout=setTimeout(function(){null!==r.size_name&&jQuery.post(global_vars.ajax_url,{action:"wa_get_image_src",attachment_id:e,size:r.size_name},function(e){i(e)})},1e3)},Wa_image_upload.prototype.bindings=function(e,t){var n=this;jQuery("body").click(function(e){jQuery(n.button).removeClass("show")}),t.on("resizecreate",function(e,t){var n=e.target.firstChild.className,i=n.match(/([align]\S+)/)[1];jQuery(e.target).css({overflow:"visible",margin:""}).addClass(i)}),n.enable_resizing(e,t),t.click(function(i){if(0!==jQuery(i.target).parents(".wa-shortcode-wrap").length){i.preventDefault();var a=jQuery(i.target).parents(".wa-shortcode-wrap");"gallery"===a.attr("data-shortcode-base")&&(n.setup_wp_media("gallery-edit",wa_fronted.shortcode_from_attr(a),a),n.frame.open())}else if(""===wa_fronted.getSelectionText()&&"IMG"!==i.target.tagName){i.preventDefault(),n.setup_wp_media("insert"),clearTimeout(o);var o=setTimeout(function(){n.showToolbar(i,t)},e.options.delay)}else if("IMG"===i.target.tagName){i.preventDefault();var r=jQuery(i.target),s=r.parents("a"),l=r;0!==s.length&&(l=s),n.replace_this=l;var c=i.target.className.match(/wp-image-\d+/);null!==c?(n.setup_wp_media("insert"),n.WPMedia(parseInt(c[0].match(/\d+/)[0]))):(n.setup_wp_media("featured-image"),wa_fronted.show_loading_spinner(),jQuery.post(global_vars.ajax_url,{action:"wa_get_thumbnail_id",post_id:n.editor_options.post_id},function(e){""!==e.attachment_id&&e.attachment_id!==!1&&(wp.media.view.settings.post.featuredImageId=parseInt(e.attachment_id),n.WPMedia(parseInt(e.attachment_id))),wa_fronted.hide_loading_spinner()}))}}),e.subscribe("editableDrag",function(e,t){console.log(t)}),e.subscribe("editableDrop",function(e,t){console.log(t)})},Wa_image_upload.prototype.enable_resizing=function(e,t){var n=this;t.find('img[class*="wp-image-"]').resizable({autoHide:!0,aspectRatio:!0,ghost:!0,handles:"nw, ne, sw, se",resize:function(t,i){var a=i.element.context.className.match(/wp-image-\d+/);if(null!==a){var o=a[0].match(/\d+/)[0];n.get_closest_image_size(o,i.size.height,i.size.width,function(e){if(e[3]===!0){var t=i.element.context.className.match(/size-\S+/),n=jQuery(i.element.context);null!==t&&n.removeClass(t[0]).addClass("size-"+e[4]),n.attr("src",e[0])}})}wa_fronted.trigger(e,"editableInput")}})},Wa_image_upload.prototype.select=function(e){var t,n,i=wp.shortcode.next("gallery",e),a=wp.media.gallery.defaults.id;return i?(i=i.shortcode,_.isUndefined(i.get("id"))&&!_.isUndefined(a)&&i.set("id",a),t=wp.media.gallery.attachments(i),n=new wp.media.model.Selection(t.models,{props:t.props.toJSON(),multiple:!0}),n.gallery=t.gallery,n.more().done(function(){n.props.set({query:!1}),n.unmirror(),n.props.unset("orderby")}),n):!1},Wa_image_upload.prototype.showToolbar=function(e,t){var n=this;n.positionImageToolbar(e),jQuery(n.button).addClass("show"),jQuery(window).scroll(function(){n.positionImageToolbar(e)})},Wa_image_upload.prototype.onClick=function(){this.WPMedia()},Wa_image_upload.prototype.insertGallery=function(e,t){t=t||!1;var n=e.states.get("gallery-edit");if(library=n.get("library"),self=this,0!==library.length){var i=wp.media.gallery.shortcode(library).string();wa_fronted.shortcode_to_html(i,t===!1?!0:!1,function(e){t!==!1?wa_fronted.replace_html(t,e):wa_fronted.insertHtmlAtCaret(e),wa_fronted.trigger(self.instance,"editableInput")})}},Wa_image_upload.prototype.insertImage=function(e,t){var n=this,i=e.state(),a=i.get("selection"),t=t||!1;a&&a.each(function(e){var a,o,r=i.display(e).toJSON(),s=e.toJSON(),l=s.caption;wp.media.view.settings.captions||delete s.caption,r=wp.media.string.props(r,s),a={id:s.id,post_content:s.description,post_excerpt:l},"featured-image"!==i.id?(r.linkUrl&&(a.url=r.linkUrl),"image"===s.type?(r.url=r.src,o=wp.media.string.image(r),_.each({align:"align",size:"image-size",alt:"image_alt"},function(e,t){r[t]&&(a[e]=r[t])})):"video"===s.type?o=wp.media.string.video(r,s):"audio"===s.type?o=wp.media.string.audio(r,s):(o=wp.media.string.link(r),a.post_title=r.title),e.attributes.nonce=wp.media.view.settings.nonce.sendToEditor,e.attributes.attachment=a,e.attributes.html=o,e.attributes.post_id=wp.media.view.settings.post.id,t!==!1?wp.media.view.settings.captions&&l?wa_fronted.shortcode_to_html(e.attributes.html,!0,function(e){wa_fronted.replace_html(t,e),n.replace_this=!1}):(wa_fronted.replace_html(t,e.attributes.html),n.replace_this=!1):wa_fronted.insertHtmlAtCaret(e.attributes.html),wa_fronted.trigger(n.instance,"editableInput"),n.enable_resizing(n.instance,jQuery(n.instance.elements))):(wa_fronted.show_loading_spinner(),jQuery.post(global_vars.ajax_url,{action:"wa_set_thumbnail",attachment_id:a.id,image_size:n.editor_options.image_size,post_id:n.editor_options.post_id},function(e){e.hasOwnProperty("html")&&t!==!1&&(wa_fronted.replace_html(t,e.html),n.replace_this=!1),wa_fronted.hide_loading_spinner()}))})},Wa_image_upload.prototype.WPMedia=function(e){e=e||!1;var t=this.frame;t.once("open",function(){var n=t.state().get("selection");e!==!1?(attachment=wp.media.attachment(e),attachment.fetch(),n.add(attachment)):n.reset()}),t.open()},Wa_image_upload.prototype.getButton=function(){return this.button},Wa_image_upload.prototype.positionImageToolbar=function(e){this.button.style.left="0";var t=this.base.options.contentWindow.innerWidth,n=this.button.offsetWidth,i=n/2,a=50,o=i,r=wa_fronted.getCaretPositionPx();r.y<a?(this.button.classList.add("medium-toolbar-arrow-over"),this.button.classList.remove("medium-toolbar-arrow-under"),this.button.style.top=r.y+(a-5)+"px"):(this.button.classList.add("medium-toolbar-arrow-under"),this.button.classList.remove("medium-toolbar-arrow-over"),this.button.style.top=r.y-(a-5)+"px"),r.x<i?this.button.style.left=o+i+"px":t-r.x<i?this.button.style.left=t+o-i+"px":this.button.style.left=r.x-i+"px"};
function escape_regexp(e){return e.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")}var wa_fronted;!function(e){wa_fronted={options:e.parseJSON(global_vars.options),data:{editable_areas:[],timers:{},current_selection:!1,current_range:!1,current_editor_options:!1,has_changes:!1},add_action:function(){var e=arguments[0].split(" ");for(k in e)arguments[0]="wa_fronted."+e[k],wp.hooks.addAction.apply(this,arguments);return this},remove_action:function(){return arguments[0]="wa_fronted."+arguments[0],wp.hooks.removeAction.apply(this,arguments),this},do_action:function(){return arguments[0]="wa_fronted."+arguments[0],wp.hooks.doAction.apply(this,arguments),this},add_filter:function(){return arguments[0]="wa_fronted."+arguments[0],wp.hooks.addFilter.apply(this,arguments),this},remove_filter:function(){return arguments[0]="wa_fronted."+arguments[0],wp.hooks.removeFilter.apply(this,arguments),this},apply_filters:function(){return arguments[0]="wa_fronted."+arguments[0],wp.hooks.applyFilters.apply(this,arguments)},initialize:function(){var t=this;if(void 0!==typeof t.options.editable_areas&&0!==t.options.editable_areas.length){for(var n=0;n<t.options.editable_areas.length;n++){var a=e(t.options.editable_areas[n].container);0!==a.length&&e.each(a,function(a,i){i=e(i),i.addClass("wa-fronted-editor"),t.setup_editor(i,t.options.editable_areas[n],t.options),t.data.editable_areas.push({editor:i,options:t.options.editable_areas[n]})})}t.do_action("on_init"),t.bind()}},bind:function(){var t=this;e("#wa-fronted-save").click(function(){t.save()}),e("#wa-fronted-settings").click(function(){e("#wa-fronted-settings-modal").fadeIn("fast")}),e(".close-wa-fronted-modal").click(function(){e("#wa-fronted-settings-modal").fadeOut("fast")});var n=e(".wa_fronted_datepicker");n.datetimepicker({dateFormat:"yy-mm-dd",timeFormat:"HH:mm:ss"}),n.datetimepicker("setDate",n.val()),e("#wa-fronted-settings-modal select").selectmenu(),t.do_action("on_bind"),window.onbeforeunload=function(){return t.data.has_changes?"The changes you have made will be lost if you navigate away from this page.":void 0}},setup_editor:function(t,n,a){var i=this,o={buttons:["bold","italic","underline","anchor","header1","header2","quote","unorderedlist","orderedlist","justifyLeft","justifyCenter","justifyRight"],buttonLabels:"fontawesome",imageDragging:!1,autoLink:!0,anchorPreview:!1,anchor:{linkValidation:!0}};void 0===n.toolbar&&(n.toolbar="full"),"false"===n.toolbar||n.toolbar===!1?o.toolbar=!1:"full"!==n.toolbar&&(o.buttons=n.toolbar.replace(/\s+/g,"").split(",")),o.buttons=i.apply_filters("toolbar_buttons",o.buttons,n),t.click(function(){var t=window.getSelection();t&&(i.data.current_selection=e.extend({},t),t.rangeCount&&(i.data.current_range=t.getRangeAt(0)))});var r=!1;"only"!==n.media_upload&&n["native"]?(n.media_upload===!0&&(o.extensions={image_upload:new Wa_image_upload(n)}),o.extensions=i.apply_filters("medium_extensions",o.extensions,n),r=new MediumEditor(t,o),r.subscribe("editablePaste",function(n,a){n.preventDefault();var o=n.clipboardData.getData("text/plain");!o||-1===o.indexOf("http://")&&-1===o.indexOf("https://")||(i.show_loading_spinner(),e.post(global_vars.ajax_url,{action:"wa_get_oembed",link:o},function(e){if(e.oembed!==!1){var n=t.html(),a=escape_regexp(o),r=new RegExp(a,"m"),s=n.replace(r,e.oembed);t.html(s)}i.hide_loading_spinner()}))})):"only"===n.media_upload&&n["native"]?(o.toolbar=!1,o.spellcheck=!1,o.extensions={image_upload:new Wa_image_upload(n)},o.extensions=i.apply_filters("medium_extensions",o.extensions,n),r=new MediumEditor(t,o)):i.do_action("on_setup_editor",t,n,a),r!==!1&&r.subscribe("editableInput",function(e,a){clearTimeout(i.data.timers[r.id]),i.data.timers[r.id]=setTimeout(function(){i.data.has_changes=!0,i.auto_save(t,n),i.show_save_button()},1e3)})},trigger:function(e,t){e.events.customEvents[t][0]()},auto_save:function(e,t){console.log("auto save",e,t)},save:function(){var t=this,n=t.data.editable_areas,a=[];t.show_loading_spinner();for(var i=0;i<n.length;i++){var o=n[i].editor.attr("data-db-value"),r="";r="undefined"!=typeof o&&o!==!1?o:n[i].editor.html(),a.push({content:r,options:n[i].options})}e.post(global_vars.ajax_url,{action:"wa_fronted_save",data:a,wa_fronted_save_nonce:global_vars.nonce},function(e){e.success&&location.reload(),t.hide_loading_spinner()})},show_save_button:function(){e("#wa-fronted-save").fadeIn("fast")},show_loading_spinner:function(){e("#wa-fronted-spinner").fadeIn("fast")},hide_loading_spinner:function(){e("#wa-fronted-spinner").fadeOut("fast")},shortcode_from_attr:function(e){return decodeURIComponent(e.attr("data-shortcode"))},shortcode_to_html:function(t,n,a){e.post(global_vars.ajax_url,{action:"wa_render_shortcode",shortcode:t,comments:n},function(e){a(e)})},getCaretPositionPx:function(){var e=0,t=0,n=window.getSelection();if(n.rangeCount){var a=n.getRangeAt(0),i="p"==a.startContainer.nodeName.toLowerCase()&&0==a.startOffset;if(i)e=a.startContainer.offsetLeft,t=a.startContainer.offsetTop;else if(a.getClientRects){var o=a.getClientRects();o.length>0&&(e=o[0].left,t=o[0].top)}}return{x:e,y:t}},getSelectionText:function(){var e="";return window.getSelection?e=window.getSelection().toString():document.selection&&"Control"!=document.selection.type&&(e=document.selection.createRange().text),e},specific_output_to:function(e,t,n,a){if(!t.hasOwnProperty("output_to")||!t.output_to.hasOwnProperty("selector"))return!1;var i=e.find(t.output_to.selector);return 0===i.length?!1:(t.output_to.hasOwnProperty("attr")?i.attr(t.output_to.attr,a):i.html(a),e.attr("data-db-value",n),!0)},insertHtmlAtCaret:function(e){var t,n,a=this;if(window.getSelection){void 0===typeof a.data.current_selection||"undefined"==typeof a.data.current_selection||a.data.current_selection===!1?(t=window.getSelection(),n=t.getRangeAt(0)):(t=a.data.current_selection,n=a.data.current_range),"undefined"!=typeof n&&n!==!1&&n.deleteContents();var i=document.createElement("div");i.innerHTML=e;for(var o,r,s=document.createDocumentFragment();o=i.firstChild;)r=s.appendChild(o);n.insertNode(s),a.current_selection=!1}else document.selection&&"Control"!=document.selection.type&&document.selection.createRange().pasteHTML(e)},replace_html:function(t,n){el=e(t),el.replaceWith(n)}},e(document).ready(function(){"undefined"!=typeof global_vars.options&&Modernizr.contenteditable&&(window.wp=window.wp||{},"undefined"==typeof window.wp.hooks&&(window.wp.hooks=new EventManager),wa_fronted.initialize())})}(jQuery);
