window.wp=window.wp||{},tinymce.PluginManager.add("fronted_shortcode",function(e){var t=(window.tinymce,e);e.shortcode_edit={bind_shortcode_edit:function(e){var t=this;e=jQuery(e),e.find(".wa-shortcode-wrap").off("hover").hover(function(){t.show_shortcode_button(jQuery(this),e)},function(){t.hide_shortcode_button()})},show_shortcode_button:function(e,n){var a=this,o=e.children(),i=0!==o.length?jQuery(o[0]):e,r=i.offset(),s=jQuery(window).scrollTop(),u=r.top-s,d=r.top,l=jQuery("#wa-fronted-edit-shortcode");l.removeClass("arrow-over arrow-under"),42>=u?(d=r.top+i.height()+42,l.addClass("arrow-over")):l.addClass("arrow-under"),l.css({left:r.left+(i.width()/2-l.width()/2),top:d}).addClass("show").hover(function(){jQuery(this).addClass("show")},function(){a.hide_shortcode_button()});var c=l.find("#wa-fronted-edit-shortcode-button"),p=l.find("#wa-fronted-remove-shortcode-button");c.addClass("show"),c.off(),c.one("click",function(t){t.preventDefault(),a.show_shortcode_edit(e,n)}),p.addClass("show"),p.off(),p.one("click",function(n){n.preventDefault(),e.remove(),a.hide_shortcode_button(),t.fire("change")})},hide_shortcode_button:function(){jQuery("#wa-fronted-edit-shortcode").removeClass("show"),jQuery("#wa-fronted-edit-shortcode-button").addClass("show"),jQuery("#wa-fronted-remove-shortcode-button").addClass("show"),jQuery("#wa-fronted-edit-shortcode .shortcode-input-wrapper").removeClass("show")},show_shortcode_edit:function(e,t){var n=this,a=wa_fronted.shortcode_from_attr(e),o=e.attr("data-shortcode-base"),i=wa_fronted.apply_filters("shortcode_actions",["gallery"]);if(-1!==i.indexOf(o))wa_fronted.is_editing_shortcode=e,wa_fronted.do_action("shortcode_action_"+o,a,e);else{var r=e.children(),s=0!==r.length?jQuery(r[0]):e,u=s.offset(),d=jQuery("#wa-fronted-edit-shortcode");jQuery("#wa-fronted-edit-shortcode-button").removeClass("show"),jQuery("#wa-fronted-remove-shortcode-button").removeClass("show"),d.find(".shortcode-input-wrapper").addClass("show"),d.find("#submit-shortcode").off().one("click",function(a){a.preventDefault(),wa_fronted.show_loading_spinner();var o=d.find("#wa_fronted_shortcode_input").val();wa_fronted.shortcode_to_html(o,!1,function(a){""!==a?(wa_fronted.replace_html(e,a),n.bind_shortcode_edit(t)):toastr.error(wa_fronted.i18n("Render unsuccessful"),wa_fronted.i18n("Sent code is not a valid shortcode")),wa_fronted.hide_loading_spinner()})}),d.css({left:u.left+(s.width()/2-d.width()/2)}).find("input").val(a).focus()}}},e.addButton("render_shortcode",{tooltip:wa_fronted.i18n("Render as shortcode"),text:"[ ]",context:"insert",onclick:function(){wa_fronted.show_loading_spinner();var t=e.selection.getContent({format:"text"});wa_fronted.shortcode_to_html(t,!0,function(t){""!==t?e.selection.setContent(t):toastr.error(wa_fronted.i18n("Render unsuccessful"),wa_fronted.i18n("Selected text is not a valid shortcode")),e.shortcode_edit.bind_shortcode_edit(e.targetElm),wa_fronted.hide_loading_spinner()})}}),e.settings.toolbar.push("render_shortcode"),jQuery(window).load(function(){e.shortcode_edit.bind_shortcode_edit(e.targetElm)})});
window.wp=window.wp||{},tinymce.PluginManager.add("fronted_image",function(e){function t(e){return e=e.replace(/(?:<p>)?\[(?:wp_)?caption([^\]]+)\]([\s\S]+?)\[\/(?:wp_)?caption\](?:<\/p>)?/g,function(e,t,n){var a,o,i,r,s,d,u=l.trim;return a=t.match(/id=['"]([^'"]*)['"] ?/),a&&(t=t.replace(a[0],"")),o=t.match(/align=['"]([^'"]*)['"] ?/),o&&(t=t.replace(o[0],"")),i=t.match(/class=['"]([^'"]*)['"] ?/),i&&(t=t.replace(i[0],"")),d=t.match(/width=['"]([0-9]*)['"] ?/),d&&(t=t.replace(d[0],"")),n=u(n),s=n.match(/((?:<a [^>]+>)?<img [^>]+>(?:<\/a>)?)([\s\S]*)/i),s&&s[2]?(r=u(s[2]),s=u(s[1])):(r=u(t).replace(/caption=['"]/,"").replace(/['"]$/,""),s=n),a=a&&a[1]?a[1].replace(/[<>&]+/g,""):"",o=o&&o[1]?o[1]:"alignnone",i=i&&i[1]?" "+i[1].replace(/[<>&]+/g,""):"",!d&&s&&(d=s.match(/width=['"]([0-9]*)['"]/)),d&&d[1]&&(d=d[1]),d&&r?(d=parseInt(d,10),c||(d+=10),'<div class="mceTemp"><'+p+' id="'+a+'" class="wp-caption '+o+i+'" style="width: '+d+'px"><'+f+' class="wp-caption-dt">'+s+"</"+f+"><"+m+' class="wp-caption-dd wp-caption-text">'+r+"</"+m+"></"+p+"></div>"):n})}function n(e){return e.replace(/<div (?:id="attachment_|class="mceTemp)[^>]*>([\s\S]+?)<\/div>/g,function(e,t){var n="";return-1===t.indexOf("<img ")?(n=t.match(new RegExp("<"+m+" [^>]+>([\\s\\S]+?)<\\/"+m+">","i")),n&&n[1]?"<p>"+n[1]+"</p>":""):(n=t.replace(new RegExp("<"+p+" ([^>]+)>\\s*<"+f+" [^>]+>([\\s\\S]+?)<\\/"+f+">\\s*<"+m+" [^>]+>([\\s\\S]*?)<\\/"+m+">\\s*<\\/"+p+">","gi"),function(e,t,n,a){var o,i,r,s;return s=n.match(/width="([0-9]*)"/),s=s&&s[1]?s[1]:"",s&&a?(o=t.match(/id="([^"]*)"/),o=o&&o[1]?o[1]:"",i=t.match(/class="([^"]*)"/),i=i&&i[1]?i[1]:"",r=i.match(/align[a-z]+/i)||"alignnone",i=i.replace(/wp-caption ?|align[a-z]+ ?/gi,""),i&&(i=' class="'+i+'"'),a=a.replace(/\r\n|\r/g,"\n").replace(/<[a-zA-Z0-9]+( [^<>]+)?>/g,function(e){return e.replace(/[\r\n\t]+/," ")}),a=a.replace(/\s*\n\s*/g,"<br />"),'[caption id="'+o+'" align="'+r+'" width="'+s+'"'+i+"]"+n+" "+a+"[/caption]"):n}),n=l.trim(n),0!==n.indexOf("[caption")&&(n=t.replace(/[\s\S]*?((?:<a [^>]+>)?<img [^>]+>(?:<\/a>)?)(<p>[\s\S]*<\/p>)?[\s\S]*/gi,"<p>$1</p>$2")),n)})}function a(t){var n,a,o,i,r,s,d,u,c=[],p=e.dom,f=/^\d+$/;return o={attachment_id:!1,size:"custom",caption:"",align:"none",extraClasses:"",link:!1,linkUrl:"",linkClassName:"",linkTargetBlank:!1,linkRel:"",title:""},o.url=p.getAttrib(t,"src"),o.alt=p.getAttrib(t,"alt"),o.title=p.getAttrib(t,"title"),d=p.getAttrib(t,"width"),u=p.getAttrib(t,"height"),(!f.test(d)||parseInt(d,10)<1)&&(d=t.naturalWidth||t.width),(!f.test(u)||parseInt(u,10)<1)&&(u=t.naturalHeight||t.height),o.customWidth=o.width=d,o.customHeight=o.height=u,n=l.explode(t.className," "),a=[],l.each(n,function(e){/^wp-image/.test(e)?o.attachment_id=parseInt(e.replace("wp-image-",""),10):/^align/.test(e)?o.align=e.replace("align",""):/^size/.test(e)?o.size=e.replace("size-",""):a.push(e)}),o.extraClasses=a.join(" "),i=p.getParents(t,".wp-caption"),i.length&&(i=i[0],n=i.className.split(" "),l.each(n,function(e){/^align/.test(e)?o.align=e.replace("align",""):e&&"wp-caption"!==e&&c.push(e)}),o.captionClassName=c.join(" "),r=p.select(".wp-caption-dd",i),r.length&&(r=r[0],o.caption=e.serializer.serialize(r).replace(/<br[^>]*>/g,"$&\n").replace(/^<p>/,"").replace(/<\/p>$/,""))),t.parentNode&&"A"===t.parentNode.nodeName&&(s=t.parentNode,o.linkUrl=p.getAttrib(s,"href"),o.linkTargetBlank="_blank"===p.getAttrib(s,"target")?!0:!1,o.linkRel=p.getAttrib(s,"rel"),o.linkClassName=s.className),o}function o(e){return e&&!(!e.textContent&&!e.innerText)}function i(t,n){var a,i,r,s,d,u,h,g,_,w,v,D,F,b,y,C,E=e.dom;a=l.explode(n.extraClasses," "),a||(a=[]),n.caption||a.push("align"+n.align),n.attachment_id&&(a.push("wp-image-"+n.attachment_id),n.size&&"custom"!==n.size&&a.push("size-"+n.size)),b=n.width,y=n.height,"custom"===n.size&&(b=n.customWidth,y=n.customHeight),D={src:n.url,width:b||null,height:y||null,alt:n.alt,title:n.title||null,"class":a.join(" ")||null},E.setAttribs(t,D),F={href:n.linkUrl,rel:n.linkRel||null,target:n.linkTargetBlank?"_blank":null,"class":n.linkClassName||null},t.parentNode&&"A"===t.parentNode.nodeName&&!o(t.parentNode)?n.linkUrl?E.setAttribs(t.parentNode,F):E.remove(t.parentNode,!0):n.linkUrl&&((h=E.getParent(t,"a"))&&E.insertAfter(t,h),h=E.create("a",F),t.parentNode.insertBefore(h,t),h.appendChild(t)),g=e.dom.getParent(t,".mceTemp"),r=t.parentNode&&"A"===t.parentNode.nodeName&&!o(t.parentNode)?t.parentNode:t,n.caption?(v=n.attachment_id?"attachment_"+n.attachment_id:null,C="align"+(n.align||"none"),i="wp-caption "+C,n.captionClassName&&(i+=" "+n.captionClassName.replace(/[<>&]+/g,"")),c||(b=parseInt(b,10),b+=10),g?(w=E.select(".wp-caption",g),w.length&&E.setAttribs(w,{id:v,"class":i,style:"width: "+b+"px"}),_=E.select(".wp-caption-dd",g),_.length&&E.setHTML(_[0],n.caption)):(v=v?'id="'+v+'" ':"",s="<"+p+" "+v+'class="'+i+'" style="width: '+b+'px"><'+f+' class="wp-caption-dt">'+E.getOuterHTML(r)+"</"+f+"><"+m+' class="wp-caption-dd wp-caption-text">'+n.caption+"</"+m+"></"+p+">",(d=E.getParent(r,"p"))?(u=E.create("div",{"class":"mceTemp"},s),d.parentNode.insertBefore(u,d),E.remove(r),E.isEmpty(d)&&E.remove(d)):E.setOuterHTML(r,'<div class="mceTemp">'+s+"</div>"))):g&&(d=E.create("p"),g.parentNode.insertBefore(d,g),d.appendChild(r),E.remove(g)),wp.media.events&&wp.media.events.trigger("editor:image-update",{editor:e,metadata:n,image:t}),e.nodeChanged()}function r(t){var n,o,r;return"undefined"!=typeof wp&&wp.media?(r=a(t),wp.media.events.trigger("editor:image-edit",{editor:e,metadata:r,image:t}),n=wp.media({frame:"image",state:"image-details",metadata:r}),wp.media.events.trigger("editor:frame-create",{frame:n}),o=function(a){e.focus(),e.undoManager.transact(function(){i(t,a)}),n.detach()},n.state("image-details").on("update",o),n.state("replace-image").on("replace",o),n.on("close",function(){e.focus(),n.detach()}),void n.open()):void e.execCommand("mceImage")}function s(t){var n;"DIV"===t.nodeName&&e.dom.hasClass(t,"mceTemp")?n=t:("IMG"===t.nodeName||"DT"===t.nodeName||"A"===t.nodeName)&&(n=e.dom.getParent(t,"div.mceTemp")),null===n&&null!==e.dom.getParent(t,"a")&&(n=e.dom.getParent(t,"a")),n?(e.selection.select(n.nextSibling?n.nextSibling:n.previousSibling?n.previousSibling:n.parentNode),e.selection.collapse(!0),e.nodeChanged(),e.dom.remove(n)):e.dom.remove(t),jQuery(e.targetElm).find("p:empty").remove(),e.theme.panel.hide(),e.focus()}function d(t,n){n=n||!1;var a=t.states.get("gallery-edit");if(library=a.get("library"),0!==library.length){var o=wp.media.gallery.shortcode(library).string();wa_fronted.shortcode_to_html(o,n===!1?!0:!1,function(t){n!==!1?wa_fronted.replace_html(n,t):e.selection.setContent(t),e.hasOwnProperty("shortcode_edit")&&e.shortcode_edit.bind_shortcode_edit(e.targetElm)})}}function u(e){var t,n,a=wp.shortcode.next("gallery",e),o=wp.media.gallery.defaults.id;return a?(a=a.shortcode,_.isUndefined(a.get("id"))&&!_.isUndefined(o)&&a.set("id",o),t=wp.media.gallery.attachments(a),n=new wp.media.model.Selection(t.models,{props:t.props.toJSON(),multiple:!0}),n.gallery=t.gallery,n.more().done(function(){n.props.set({query:!1}),n.unmirror(),n.props.unset("orderby")}),n):!1}var l=window.tinymce,c=e.getParam("wpeditimage_html5_captions"),p=c?"figure":"dl",f=c?"section":"dt",m=c?"figcaption":"dd",h=!1,g={aspect_ratio:function(e,t){return e/t},round:function(e,t){return Number(Math.round(e+"e"+t)+"e-"+t)},get_closest_image_size:function(e,t,n,a){var o=this,t=Math.round(t),n=Math.round(n),i={diff:null,size_name:null,height:null,width:null,crop:null},r=o.round(o.aspect_ratio(n,t),2);for(size in global_vars.image_sizes){var s=global_vars.image_sizes[size],d=parseInt(s.height),u=parseInt(s.width),l=o.round(o.aspect_ratio(u,d),2);if(r===l||s.crop!==!0&&1!==s.crop){var c=Math.abs(t-d);(c<i.diff||null===i.diff)&&(i.diff=c,i.size_name=size,i.height=d,i.width=u,i.crop=s.crop)}}null!==i.size_name&&jQuery.post(global_vars.ajax_url,{action:"wa_get_image_src",attachment_id:e,size:i.size_name},function(e){a(e)})}};return e.on("init",function(){var t=e.dom;e.on("wpLoadImageForm",function(t){if(!e.getParam("wpeditimage_disable_captions")){var n={type:"textbox",flex:1,name:"caption",minHeight:60,multiline:!0,scroll:!0,label:"Image caption"};t.data.splice(t.data.length-1,0,n)}}),e.on("wpNewImageRefresh",function(e){var n,a;(n=t.getParent(e.node,".wp-caption"))&&(n.style.width||(a=parseInt(e.node.clientWidth,10)+10,a=a?a+"px":"50%",t.setStyle(n,"width",a)))}),e.on("wpImageFormSubmit",function(n){var a,o,i,r,s,d=n.imgData.data,u=n.imgData.node,l=n.imgData.caption,h="",g="",_="";return d.id="__wp-temp-img-id",n.imgData.cancel=!0,d.style||(d.style=null),d.src?(l&&(l=l.replace(/\r\n|\r/g,"\n").replace(/<\/?[a-zA-Z0-9]+( [^<>]+)?>/g,function(e){return e.replace(/[\r\n\t]+/," ")}),l=l.replace(/(<br[^>]*>)\s*\n\s*/g,"$1").replace(/\s*\n\s*/g,"<br />")),u?(s=u.id||null,t.setAttribs(u,d),a=t.getParent(u,".wp-caption"),l?a?(o=t.select(".wp-caption-dd",a)[0])&&(o.innerHTML=l):(u.className&&(h=u.className.match(/wp-image-([0-9]+)/),g=u.className.match(/align(left|right|center|none)/)),g?(g=g[0],u.className=u.className.replace(/align(left|right|center|none)/g,"")):g="alignnone",g=' class="wp-caption '+g+'"',h&&(h=' id="attachment_'+h[1]+'"'),_=d.width||u.clientWidth,_&&(_=parseInt(_,10),c||(_+=10),_=' style="width: '+_+'px"'),u.parentNode&&"A"===u.parentNode.nodeName?(r=t.getOuterHTML(u.parentNode),i=u.parentNode):(r=t.getOuterHTML(u),i=u),r="<"+p+" "+h+g+_+"><"+f+' class="wp-caption-dt">'+r+"</"+f+"><"+m+' class="wp-caption-dd wp-caption-text">'+l+"</"+m+"></"+p+">",(o=t.getParent(u,"p"))?(a=t.create("div",{"class":"mceTemp"},r),t.insertAfter(a,o),e.selection.select(a),e.nodeChanged(),t.remove(i),t.isEmpty(o)&&t.remove(o)):e.selection.setContent('<div class="mceTemp">'+r+"</div>")):a&&(r=t.getOuterHTML("A"===u.parentNode.nodeName?u.parentNode:u),o=t.create("p",{},r),t.insertAfter(o,a.parentNode),e.selection.select(o),e.nodeChanged(),t.remove(a.parentNode))):(r=t.createHTML("img",d),l?(i=e.selection.getNode(),d.width&&(_=parseInt(d.width,10),c||(_+=10),_=' style="width: '+_+'px"'),r="<"+p+' class="wp-caption alignnone"'+_+"><"+f+' class="wp-caption-dt">'+r+"</"+f+"><"+m+' class="wp-caption-dd wp-caption-text">'+l+"</"+m+"></"+p+">",o="P"===i.nodeName?i:t.getParent(i,"p"),o&&"P"===o.nodeName?(a=t.create("div",{"class":"mceTemp"},r),o.parentNode.insertBefore(a,o),e.selection.select(a),e.nodeChanged(),t.isEmpty(o)&&t.remove(o)):e.selection.setContent('<div class="mceTemp">'+r+"</div>")):e.selection.setContent(r)),u=t.get("__wp-temp-img-id"),t.setAttrib(u,"id",s),void(n.imgData.node=u)):void(u&&(t.remove((a=t.getParent(u,"div.mceTemp"))?a:"A"===u.parentNode.nodeName?u.parentNode:u),e.nodeChanged()))}),e.on("wpLoadImageData",function(n){var a,o=n.imgData.data,i=n.imgData.node;(a=t.getParent(i,".wp-caption"))&&(a=t.select(".wp-caption-dd",a)[0],a&&(o.caption=e.serializer.serialize(a).replace(/<br[^>]*>/g,"$&\n").replace(/^<p>/,"").replace(/<\/p>$/,"")))});var n=["image/jpeg","image/png","image/gif"];e.on("drop",function(t){if(!h&&Modernizr.filereader&&e.settings.fronted_options.media_upload===!0&&(t.preventDefault(),t.stopPropagation(),0!==t.dataTransfer.files.length)){wa_fronted.show_loading_spinner();var a=t.dataTransfer.files[0];if(-1!==jQuery.inArray(a.type,n)){var o=new FileReader;o.onload=function(t){jQuery.post(global_vars.ajax_url,{action:"wa_create_image",post_id:e.settings.fronted_options.post_id,file_data:encodeURIComponent(t.target.result),file_name:a.name,file_type:a.type,wa_fronted_save_nonce:global_vars.nonce},function(t){var n=t.attachment_obj,a=n.sizes.medium,o='<img src="'+a.url+'" width="'+a.width+'" height="'+a.height+'" alt="'+n.title+'" class="wp-image-'+n.id+' alignleft size-medium" style="height:'+a.height+"; width:"+a.width+';">';e.insertContent(o),wa_fronted.hide_loading_spinner()})},o.readAsDataURL(a)}else wa_fronted.show_loading_spinner()}}),t.bind(e.getDoc(),"dragend",function(e){h=!1}),t.bind(e.getDoc(),"dragstart",function(n){var a=e.selection.getNode();h=!0,"IMG"===a.nodeName&&(t.getParent(a,".wp-caption")||t.getParent(a,".gallery-icon"))&&n.preventDefault()}),l.Env.ie&&l.Env.ie>10&&(t.bind(e.getBody(),"mscontrolselect",function(n){"IMG"===n.target.nodeName&&t.getParent(n.target,".wp-caption")?e.getBody().focus():"DL"===n.target.nodeName&&t.hasClass(n.target,"wp-caption")&&n.target.focus()}),e.on("click",function(n){"IMG"===n.target.nodeName&&t.getAttrib(n.target,"data-wp-imgselect")&&t.getParent(n.target,".wp-caption")&&e.getBody().focus()}))}),e.on("ObjectResized",function(t){var n=t.target;if("IMG"===n.nodeName){var a=n.className.match(/wp-image-\d+/);if(null!==a){var o=a[0].match(/\d+/)[0];g.get_closest_image_size(o,n.height,n.width,function(e){e[3]===!0&&(n.className=n.className.replace(/size-\S+/,"size-"+e[4]),n.src=e[0])})}e.undoManager.transact(function(){var a,o,i=e.dom;n.className=n.className.replace(/\bsize-[^ ]+/,""),(a=i.getParent(n,".wp-caption"))&&(o=t.width||i.getAttrib(n,"width"),o&&(o=parseInt(o,10),c||(o+=10),i.setStyle(a,"width",o+"px")))})}}),e.on("BeforeExecCommand",function(t){var n,a,o,i,r=t.command,s=e.dom;if("mceInsertContent"===r)(n=s.getParent(e.selection.getNode(),"div.mceTemp"))?(a=s.create("p"),s.insertAfter(a,n),e.selection.setCursorLocation(a,0),e.nodeChanged()):-1!==t.value.indexOf("[gallery ")&&(t.preventDefault(),wa_fronted.show_loading_spinner(),wa_fronted.shortcode_to_html(t.value,!0,function(t){e.insertContent(t),e.hasOwnProperty("shortcode_edit")&&e.shortcode_edit.bind_shortcode_edit(e.targetElm),wa_fronted.hide_loading_spinner()}));else if("JustifyLeft"===r||"JustifyRight"===r||"JustifyCenter"===r||"alignnone"===r){if(n=e.selection.getNode(),i="align"+r.slice(7).toLowerCase(),o=e.dom.getParent(n,".wp-caption"),"IMG"!==n.nodeName&&!o)return;n=o||n,"alignleft"!==i&&e.dom.removeClass(n,"alignleft"),"aligncenter"!==i&&e.dom.removeClass(n,"aligncenter"),"alignright"!==i&&e.dom.removeClass(n,"alignright"),"alignnone"!==i&&e.dom.toggleClass(n,i),e.nodeChanged(),t.preventDefault()}}),e.on("keydown",function(t){var n,a,o,i,r=e.selection,d=t.keyCode,u=e.dom;if(d===l.util.VK.ENTER)n=r.getNode(),a=u.getParent(n,"div.mceTemp"),a&&(u.events.cancel(t),l.each(u.select(".wp-caption-dt, .wp-caption-dd",a),function(e){u.isEmpty(e)&&u.remove(e)}),i=l.Env.ie&&l.Env.ie<11?"":'<br data-mce-bogus="1" />',o=u.create("p",null,i),"DD"===n.nodeName?u.insertAfter(o,a):a.parentNode.insertBefore(o,a),e.nodeChanged(),r.setCursorLocation(o,0));else if((d===l.util.VK.DELETE||d===l.util.VK.BACKSPACE)&&(n=r.getNode(),"DIV"===n.nodeName&&u.hasClass(n,"mceTemp")?a=n:("IMG"===n.nodeName||"DT"===n.nodeName||"A"===n.nodeName)&&(a=u.getParent(n,"div.mceTemp")),a))return u.events.cancel(t),s(n),!1}),e.wpSetImgCaption=function(e){return t(e)},e.wpGetImgCaption=function(e){return n(e)},e.on("BeforeSetContent",function(t){"raw"!==t.format&&(t.content=e.wpSetImgCaption(t.content))}),e.on("PostProcess",function(t){t.get&&(t.content=e.wpGetImgCaption(t.content),t.content=t.content.replace(/ data-wp-imgselect="1"/g,""))}),e.addButton("remove",{tooltip:"Remove",icon:"dashicons-no",onclick:function(){s(e.selection.getNode())}}),e.addButton("edit",{tooltip:"Edit",icon:"dashicons-edit",onclick:function(){r(e.selection.getNode())}}),l.each({alignleft:"Align Left",aligncenter:"Align Center",alignright:"Align Right",alignnone:"Don’t Align"},function(t,n){var a=n.slice(5);e.addButton("img"+n,{tooltip:t,icon:"dashicons-align-"+a,cmd:"alignnone"===n?n:"Justify"+a.slice(0,1).toUpperCase()+a.slice(1),onPostRender:function(){var t=this;e.on("NodeChange",function(a){var o=e.dom.getParent(a.element,".wp-caption")||a.element;t.active("alignnone"===n?!e.dom.hasClass(o,"alignleft")&&!e.dom.hasClass(o,"aligncenter")&&!e.dom.hasClass(o,"alignright"):e.dom.hasClass(o,n))})}})}),e.addButton("wp_media",{tooltip:"Media",icon:"dashicons-admin-media",onclick:function(){wp.media.editor.open(e.id)}}),wa_fronted.add_action("shortcode_action_gallery",function(t,n){if(0!==n.parents("#"+e.id).length){var a=wp.media({frame:"post",state:"gallery-edit",title:wp.media.view.l10n.editGalleryTitle,editing:!0,multiple:!0,selection:u(t)});a.state("gallery-edit").on("update",function(){d(a,n)}),a.on("close",function(){e.focus(),a.detach()}),a.open()}}),{_do_shcode:t,_get_shcode:n}});
window.wp=window.wp||{},window.send_to_editor=window.send_to_editor||function(e){if(-1!==e.indexOf("[")){wa_fronted.show_loading_spinner();var t="undefined"!=typeof wa_fronted.is_editing_shortcode&&wa_fronted.is_editing_shortcode!==!1;wa_fronted.shortcode_to_html(e,t!==!0,function(n){""!==n?t?wa_fronted.replace_html(wa_fronted.is_editing_shortcode,n):tinymce.activeEditor.selection.setContent(n):tinymce.activeEditor.selection.setContent(e),tinymce.activeEditor.hasOwnProperty("shortcode_edit")&&tinymce.activeEditor.shortcode_edit.bind_shortcode_edit(tinymce.activeEditor.targetElm),wa_fronted.is_editing_shortcode=!1,wa_fronted.hide_loading_spinner()})}else tinymce.activeEditor.selection.setContent(e)},tinymce.ThemeManager.add("fronted",function(e){function t(e,t){for(;e;){if(e.nodeName===t)return e;e=e.parentNode}return!1}function n(n,a){var o,i=[];if(n)return u(n,function(n){function r(){var t=e.selection;"bullist"===u&&t.selectorChanged("ul > li",function(e,t){for(var a,o=t.parents.length;o--&&(a=t.parents[o].nodeName,"OL"!==a&&"UL"!==a););n.active(e&&"UL"===a)}),"numlist"===u&&t.selectorChanged("ol > li",function(e,t){for(var a,o=t.parents.length;o--&&(a=t.parents[o].nodeName,"OL"!==a&&"UL"!==a););n.active(e&&"OL"===a)}),n.settings.stateSelector&&t.selectorChanged(n.settings.stateSelector,function(e){n.active(e)},!0),n.settings.disabledStateSelector&&t.selectorChanged(n.settings.disabledStateSelector,function(e){n.disabled(e)})}var u;"|"===n?o=null:d.has(n)?(n={type:n},s.toolbar_items_size&&(n.size=s.toolbar_items_size),i.push(n),o=null):((!o||a)&&(o={type:"buttongroup",items:[]},i.push(o)),e.buttons[n]&&(u=n,n=e.buttons[u],"function"==typeof n&&(n=n()),n.icon&&-1!==n.icon.indexOf("dashicons")&&(n.icon="dashicon "+n.icon),a&&(n.text=n.tooltip,n.tooltip=!1),n.type=n.type||"button",s.toolbar_items_size&&(n.size=s.toolbar_items_size),"link"===u?n.onPostRender=function(){var n=this;e.on("NodeChange",function(e){n.active(t(e.element,"A"))})}:"unlink"===u&&(n.onPostRender=function(){var t=this;e.on("NodeChange",function(n){var a="A"!==n.element.nodeName&&-1===e.selection.getContent().indexOf("<a");t.disabled(a),l.setAttrib(t.getEl(),"tabindex",a?"0":"-1")})},n.onclick=function(){-1===e.selection.getContent().indexOf("<a")&&e.selection.select(e.selection.getNode()),e.execCommand("unlink")}),n=d.create(n),o.items.push(n),e.initialized?r():e.on("init",r)))}),i}function a(e){return d.create({type:"panel",layout:"stack",classes:"toolbar-grp",ariaRoot:!0,ariaRemember:!0,items:[{type:"toolbar",layout:"flow",items:n(e)}]})}var o,i=window.tinymce,r=this,s=e.settings,d=i.ui.Factory,u=i.each,l=i.DOM,c=32;u({H1:"Heading 1",H2:"Heading 2",H3:"Heading 3",H4:"Heading 4",H5:"Heading 5",H6:"Heading 6",Pre:"Preformatted"},function(t,n){var a=n.toLowerCase();e.addButton(a,{tooltip:t,text:n,onclick:function(){e.formatter.toggle(a)},onPostRender:function(){var t=this;e.on("nodeChange",function(n){u(n.parents,function(n){t.active(!!e.formatter.matchNode(n,a))})})}})}),e.toolbarItems=n,r.renderUI=function(){function t(){return""===e.getContent({format:"raw"}).replace(/(?:<p[^>]*>)?(?:<br[^>]*>)?(?:<\/p>)?/,"")}var n,i,p={},f=0;return s.content_editable=!0,e.on("activate focus",function(){o=!0,l.addClass(e.getBody(),"mce-edit-focus")}),e.on("deactivate blur hide",function(){o=!1,l.removeClass(e.getBody(),"mce-edit-focus")}),e.on("remove",function(){n&&n.remove(),n=null}),s.placeholder&&(e.on("blur LoadContent deactivate",function(){t()&&(e.setContent(s.placeholder),i=!0,l.addClass(e.getBody(),"mce-placeholder"))}),e.on("focus activate",function(){i&&e.setContent("")}),e.on("SetContent",function(t){i&&!t.load&&(i=!1,l.removeClass(e.getBody(),"mce-placeholder"))}),e.on("PostProcess",function(e){i&&e.content&&(e.content="")}),e.on("BeforeAddUndo",function(e){i&&e.preventDefault()})),s.toolbar&&s.toolbar.length&&!n?("relative"===l.getStyle(document.body,"position",!0)&&(f=parseInt(l.getStyle(document.body,"margin-top",!0),10)+parseInt(l.getStyle(document.documentElement,"padding-top",!0),10)+parseInt(l.getStyle(document.documentElement,"margin-top",!0),10)),p.normal=a(s.toolbar),p.img=a(wa_fronted.apply_filters("image_edit_toolbar",["imgalignleft","imgaligncenter","imgalignright","imgalignnone","edit","remove"],s.fronted_options)),p.view=a(["editview","removeview"]),p.media=a(wa_fronted.apply_filters("image_upload_toolbar",["wp_media"],s.fronted_options)),n=r.panel=d.create({type:"floatpanel",role:"application",classes:"tinymce tinymce-inline",layout:"stack",autohide:!0,items:[p.normal,p.img,p.view,p.media]}),n.reposition=function(t,n){var a,o,i,r,s,d=this.getEl(),m=n||e.selection.getRng(),h=m.getBoundingClientRect(),g=(h.left+h.right)/2,_=window.innerWidth,w=parseInt(l.getStyle(d,"margin-bottom",!0),10)+f;if(m.collapsed||0===g){var v=wa_fronted.getCaretPositionPx();h={top:v.y,bottom:v.y+d.offsetHeight/2,left:v.x,right:v.x},g=v.x}return d.className=(" "+d.className+" ").replace(/\smce-arrow-\S+\s/g," ").slice(1,-1),t=t||"normal",p[t]._visible||(u(p,function(e){e.hide()}),p[t].show()),a=d.offsetWidth,o=a/2,h.top<d.offsetHeight+c?(s=" mce-arrow-up",i=h.bottom+w):(s=" mce-arrow-down",i=h.top-d.offsetHeight-w),r=g-o,a>=_?(s+=" mce-arrow-full",r=0):0>r&&h.left+a>_||r+a>_&&h.right-a<0?r=(_-a)/2:0>r?(s+=" mce-arrow-left",r=h.left):r+a>_&&(s+=" mce-arrow-right",r=h.right-a),d.className+=s,l.setStyles(d,{left:r,top:i+window.pageYOffset}),this},n.on("show",function(){var e=this;setTimeout(function(){e._visible&&l.addClass(e.getEl(),"mce-inline-toolbar-active")},100)}),n.on("hide",function(){l.removeClass(this.getEl(),"mce-inline-toolbar-active")}),n.on("cancel",function(){e.focus()}),l.bind(window,"resize",function(){n.hide()}),e.on("selectionchange nodechange",function(t){var a=t.element||e.selection.getNode(),i=e.plugins.wpview.getView(),r=jQuery(a),d=r.hasClass("wa-shortcode-wrap")?r:r.parents(".wa-shortcode-wrap");0!==d.length&&(t.preventDefault(),e.selection.select(d[0]),e.selection.collapse(),n.hide()),e.selection.isCollapsed()&&!i&&n.hide(),setTimeout(function(){var t,r;o&&(!e.selection.isCollapsed()&&(t=e.selection.getContent())&&(t.replace(/<[^>]+>/g,"").trim()||0===t.indexOf("<"))&&"HR"!==a.nodeName||i?(r=i?"view":"IMG"===a.nodeName?"img":"normal",n.show().reposition(r,i)):e.selection.isCollapsed()&&"IMG"!==a.nodeName&&!i&&s.fronted_options.media_upload?n.show().reposition("media",i):n.hide())},100)}),e.shortcuts.add("Alt+F10","",function(){var e=n.find("toolbar")[0];e&&e.focus(!0)}),n.renderTo(document.body).reflow().hide(),u(p,function(e){e.hide()}),{}):{}}});
window.Modernizr=function(e,t,n){function a(e){v.cssText=e}function o(e,t){return a(D.join(e+";")+(t||""))}function i(e,t){return typeof e===t}function r(e,t){return!!~(""+e).indexOf(t)}function s(e,t){for(var a in e){var o=e[a];if(!r(o,"-")&&v[o]!==n)return"pfx"==t?o:!0}return!1}function d(e,t,a){for(var o in e){var r=t[e[o]];if(r!==n)return a===!1?e[o]:i(r,"function")?r.bind(a||t):r}return!1}function u(e,t,n){var a=e.charAt(0).toUpperCase()+e.slice(1),o=(e+" "+b.join(a+" ")+a).split(" ");return i(t,"string")||i(t,"undefined")?s(o,t):(o=(e+" "+y.join(a+" ")+a).split(" "),d(o,t,n))}var l,c,p,f="2.8.3",m={},h=!0,g=t.documentElement,_="modernizr",w=t.createElement(_),v=w.style,D=({}.toString," -webkit- -moz- -o- -ms- ".split(" ")),F="Webkit Moz O ms",b=F.split(" "),y=F.toLowerCase().split(" "),C={},E=[],A=E.slice,B=function(e,n,a,o){var i,r,s,d,u=t.createElement("div"),l=t.body,c=l||t.createElement("body");if(parseInt(a,10))for(;a--;)s=t.createElement("div"),s.id=o?o[a]:_+(a+1),u.appendChild(s);return i=["&#173;",'<style id="s',_,'">',e,"</style>"].join(""),u.id=_,(l?u:c).innerHTML+=i,c.appendChild(u),l||(c.style.background="",c.style.overflow="hidden",d=g.style.overflow,g.style.overflow="hidden",g.appendChild(c)),r=n(u,e),l?u.parentNode.removeChild(u):(c.parentNode.removeChild(c),g.style.overflow=d),!!r},x=function(){function e(e,o){o=o||t.createElement(a[e]||"div"),e="on"+e;var r=e in o;return r||(o.setAttribute||(o=t.createElement("div")),o.setAttribute&&o.removeAttribute&&(o.setAttribute(e,""),r=i(o[e],"function"),i(o[e],"undefined")||(o[e]=n),o.removeAttribute(e))),o=null,r}var a={select:"input",change:"input",submit:"form",reset:"form",error:"img",load:"img",abort:"img"};return e}(),N={}.hasOwnProperty;p=i(N,"undefined")||i(N.call,"undefined")?function(e,t){return t in e&&i(e.constructor.prototype[t],"undefined")}:function(e,t){return N.call(e,t)},Function.prototype.bind||(Function.prototype.bind=function(e){var t=this;if("function"!=typeof t)throw new TypeError;var n=A.call(arguments,1),a=function(){if(this instanceof a){var o=function(){};o.prototype=t.prototype;var i=new o,r=t.apply(i,n.concat(A.call(arguments)));return Object(r)===r?r:i}return t.apply(e,n.concat(A.call(arguments)))};return a}),C.draganddrop=function(){var e=t.createElement("div");return"draggable"in e||"ondragstart"in e&&"ondrop"in e},C.opacity=function(){return o("opacity:.55"),/^0.55$/.test(v.opacity)},C.cssanimations=function(){return u("animationName")},C.csstransforms=function(){return!!u("transform")},C.csstransforms3d=function(){var e=!!u("perspective");return e&&"webkitPerspective"in g.style&&B("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}",function(t,n){e=9===t.offsetLeft&&3===t.offsetHeight}),e},C.csstransitions=function(){return u("transition")};for(var k in C)p(C,k)&&(c=k.toLowerCase(),m[c]=C[k](),E.push((m[c]?"":"no-")+c));return m.addTest=function(e,t){if("object"==typeof e)for(var a in e)p(e,a)&&m.addTest(a,e[a]);else{if(e=e.toLowerCase(),m[e]!==n)return m;t="function"==typeof t?t():t,"undefined"!=typeof h&&h&&(g.className+=" "+(t?"":"no-")+e),m[e]=t}return m},a(""),w=l=null,function(e,t){function n(e,t){var n=e.createElement("p"),a=e.getElementsByTagName("head")[0]||e.documentElement;return n.innerHTML="x<style>"+t+"</style>",a.insertBefore(n.lastChild,a.firstChild)}function a(){var e=w.elements;return"string"==typeof e?e.split(" "):e}function o(e){var t=_[e[h]];return t||(t={},g++,e[h]=g,_[g]=t),t}function i(e,n,a){if(n||(n=t),l)return n.createElement(e);a||(a=o(n));var i;return i=a.cache[e]?a.cache[e].cloneNode():m.test(e)?(a.cache[e]=a.createElem(e)).cloneNode():a.createElem(e),!i.canHaveChildren||f.test(e)||i.tagUrn?i:a.frag.appendChild(i)}function r(e,n){if(e||(e=t),l)return e.createDocumentFragment();n=n||o(e);for(var i=n.frag.cloneNode(),r=0,s=a(),d=s.length;d>r;r++)i.createElement(s[r]);return i}function s(e,t){t.cache||(t.cache={},t.createElem=e.createElement,t.createFrag=e.createDocumentFragment,t.frag=t.createFrag()),e.createElement=function(n){return w.shivMethods?i(n,e,t):t.createElem(n)},e.createDocumentFragment=Function("h,f","return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&("+a().join().replace(/[\w\-]+/g,function(e){return t.createElem(e),t.frag.createElement(e),'c("'+e+'")'})+");return n}")(w,t.frag)}function d(e){e||(e=t);var a=o(e);return w.shivCSS&&!u&&!a.hasCSS&&(a.hasCSS=!!n(e,"article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")),l||s(e,a),e}var u,l,c="3.7.0",p=e.html5||{},f=/^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i,m=/^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i,h="_html5shiv",g=0,_={};!function(){try{var e=t.createElement("a");e.innerHTML="<xyz></xyz>",u="hidden"in e,l=1==e.childNodes.length||function(){t.createElement("a");var e=t.createDocumentFragment();return"undefined"==typeof e.cloneNode||"undefined"==typeof e.createDocumentFragment||"undefined"==typeof e.createElement}()}catch(n){u=!0,l=!0}}();var w={elements:p.elements||"abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output progress section summary template time video",version:c,shivCSS:p.shivCSS!==!1,supportsUnknownElements:l,shivMethods:p.shivMethods!==!1,type:"default",shivDocument:d,createElement:i,createDocumentFragment:r};e.html5=w,d(t)}(this,t),m._version=f,m._prefixes=D,m._domPrefixes=y,m._cssomPrefixes=b,m.hasEvent=x,m.testProp=function(e){return s([e])},m.testAllProps=u,m.testStyles=B,g.className=g.className.replace(/(^|\s)no-js(\s|$)/,"$1$2")+(h?" js "+E.join(" "):""),m}(this,this.document),function(e,t,n){function a(e){return"[object Function]"==g.call(e)}function o(e){return"string"==typeof e}function i(){}function r(e){return!e||"loaded"==e||"complete"==e||"uninitialized"==e}function s(){var e=_.shift();w=1,e?e.t?m(function(){("c"==e.t?p.injectCss:p.injectJs)(e.s,0,e.a,e.x,e.e,1)},0):(e(),s()):w=0}function d(e,n,a,o,i,d,u){function l(t){if(!f&&r(c.readyState)&&(v.r=f=1,!w&&s(),c.onload=c.onreadystatechange=null,t)){"img"!=e&&m(function(){F.removeChild(c)},50);for(var a in A[n])A[n].hasOwnProperty(a)&&A[n][a].onload()}}var u=u||p.errorTimeout,c=t.createElement(e),f=0,g=0,v={t:a,s:n,e:i,a:d,x:u};1===A[n]&&(g=1,A[n]=[]),"object"==e?c.data=n:(c.src=n,c.type=e),c.width=c.height="0",c.onerror=c.onload=c.onreadystatechange=function(){l.call(this,g)},_.splice(o,0,v),"img"!=e&&(g||2===A[n]?(F.insertBefore(c,D?null:h),m(l,u)):A[n].push(c))}function u(e,t,n,a,i){return w=0,t=t||"j",o(e)?d("c"==t?y:b,e,t,this.i++,n,a,i):(_.splice(this.i++,0,e),1==_.length&&s()),this}function l(){var e=p;return e.loader={load:u,i:0},e}var c,p,f=t.documentElement,m=e.setTimeout,h=t.getElementsByTagName("script")[0],g={}.toString,_=[],w=0,v="MozAppearance"in f.style,D=v&&!!t.createRange().compareNode,F=D?f:h.parentNode,f=e.opera&&"[object Opera]"==g.call(e.opera),f=!!t.attachEvent&&!f,b=v?"object":f?"script":"img",y=f?"script":b,C=Array.isArray||function(e){return"[object Array]"==g.call(e)},E=[],A={},B={timeout:function(e,t){return t.length&&(e.timeout=t[0]),e}};p=function(e){function t(e){var t,n,a,e=e.split("!"),o=E.length,i=e.pop(),r=e.length,i={url:i,origUrl:i,prefixes:e};for(n=0;r>n;n++)a=e[n].split("="),(t=B[a.shift()])&&(i=t(i,a));for(n=0;o>n;n++)i=E[n](i);return i}function r(e,o,i,r,s){var d=t(e),u=d.autoCallback;d.url.split(".").pop().split("?").shift(),d.bypass||(o&&(o=a(o)?o:o[e]||o[r]||o[e.split("/").pop().split("?")[0]]),d.instead?d.instead(e,o,i,r,s):(A[d.url]?d.noexec=!0:A[d.url]=1,i.load(d.url,d.forceCSS||!d.forceJS&&"css"==d.url.split(".").pop().split("?").shift()?"c":n,d.noexec,d.attrs,d.timeout),(a(o)||a(u))&&i.load(function(){l(),o&&o(d.origUrl,s,r),u&&u(d.origUrl,s,r),A[d.url]=2})))}function s(e,t){function n(e,n){if(e){if(o(e))n||(c=function(){var e=[].slice.call(arguments);p.apply(this,e),f()}),r(e,c,t,0,u);else if(Object(e)===e)for(d in s=function(){var t,n=0;for(t in e)e.hasOwnProperty(t)&&n++;return n}(),e)e.hasOwnProperty(d)&&(!n&&!--s&&(a(c)?c=function(){var e=[].slice.call(arguments);p.apply(this,e),f()}:c[d]=function(e){return function(){var t=[].slice.call(arguments);e&&e.apply(this,t),f()}}(p[d])),r(e[d],c,t,d,u))}else!n&&f()}var s,d,u=!!e.test,l=e.load||e.both,c=e.callback||i,p=c,f=e.complete||i;n(u?e.yep:e.nope,!!l),l&&n(l)}var d,u,c=this.yepnope.loader;if(o(e))r(e,0,c,0);else if(C(e))for(d=0;d<e.length;d++)u=e[d],o(u)?r(u,0,c,0):C(u)?p(u):Object(u)===u&&s(u,c);else Object(e)===e&&s(e,c)},p.addPrefix=function(e,t){B[e]=t},p.addFilter=function(e){E.push(e)},p.errorTimeout=1e4,null==t.readyState&&t.addEventListener&&(t.readyState="loading",t.addEventListener("DOMContentLoaded",c=function(){t.removeEventListener("DOMContentLoaded",c,0),t.readyState="complete"},0)),e.yepnope=l(),e.yepnope.executeStack=s,e.yepnope.injectJs=function(e,n,a,o,d,u){var l,c,f=t.createElement("script"),o=o||p.errorTimeout;f.src=e;for(c in a)f.setAttribute(c,a[c]);n=u?s:n||i,f.onreadystatechange=f.onload=function(){!l&&r(f.readyState)&&(l=1,n(),f.onload=f.onreadystatechange=null)},m(function(){l||(l=1,n(1))},o),d?f.onload():h.parentNode.insertBefore(f,h)},e.yepnope.injectCss=function(e,n,a,o,r,d){var u,o=t.createElement("link"),n=d?s:n||i;o.href=e,o.rel="stylesheet",o.type="text/css";for(u in a)o.setAttribute(u,a[u]);r||(h.parentNode.insertBefore(o,h),m(n,0))}}(this,document),Modernizr.load=function(){yepnope.apply(window,[].slice.call(arguments,0))},Modernizr.addTest("contenteditable","contentEditable"in document.documentElement),Modernizr.addTest("filereader",function(){return!!(window.File&&window.FileList&&window.FileReader)});
